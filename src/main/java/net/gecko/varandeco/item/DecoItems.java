...
public class DecoItems {
    ...
    public static final Item CACTUS_SIGN = registerItem("cactus_sign",
            new SignItem(DecoBlocks.STANDING_CACTUS_SIGN, DecoBlocks.WALL_CACTUS_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item WOODEN_SIGN = registerItem("wooden_sign",
            new SignItem(DecoBlocks.STANDING_WOODEN_SIGN, DecoBlocks.WALL_WOODEN_SIGN,
                    new Item.Settings().maxCount(16)));

    public static final Item STRIPPED_OAK_SIGN = registerItem("stripped_oak_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_OAK_SIGN, DecoBlocks.WALL_STRIPPED_OAK_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_SPRUCE_SIGN = registerItem("stripped_spruce_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_SPRUCE_SIGN, DecoBlocks.WALL_STRIPPED_SPRUCE_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_BIRCH_SIGN = registerItem("stripped_birch_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_BIRCH_SIGN, DecoBlocks.WALL_STRIPPED_BIRCH_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_JUNGLE_SIGN = registerItem("stripped_jungle_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_JUNGLE_SIGN, DecoBlocks.WALL_STRIPPED_JUNGLE_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_ACACIA_SIGN = registerItem("stripped_acacia_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_ACACIA_SIGN, DecoBlocks.WALL_STRIPPED_ACACIA_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_DARK_OAK_SIGN = registerItem("stripped_dark_oak_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_DARK_OAK_SIGN, DecoBlocks.WALL_STRIPPED_DARK_OAK_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_MANGROVE_SIGN = registerItem("stripped_mangrove_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_MANGROVE_SIGN, DecoBlocks.WALL_STRIPPED_MANGROVE_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_CHERRY_SIGN = registerItem("stripped_cherry_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_CHERRY_SIGN, DecoBlocks.WALL_STRIPPED_CHERRY_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_CRIMSON_SIGN = registerItem("stripped_crimson_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_CRIMSON_SIGN, DecoBlocks.WALL_STRIPPED_CRIMSON_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_WARPED_SIGN = registerItem("stripped_warped_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_WARPED_SIGN, DecoBlocks.WALL_STRIPPED_WARPED_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item STRIPPED_WOODEN_SIGN = registerItem("stripped_wooden_sign",
            new SignItem(DecoBlocks.STANDING_STRIPPED_WOODEN_SIGN, DecoBlocks.WALL_STRIPPED_WOODEN_SIGN,
                    new Item.Settings().maxCount(16)));

    public static final Item OAK_MOSAIC_SIGN = registerItem("oak_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_OAK_MOSAIC_SIGN, DecoBlocks.WALL_OAK_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item SPRUCE_MOSAIC_SIGN = registerItem("spruce_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_SPRUCE_MOSAIC_SIGN, DecoBlocks.WALL_SPRUCE_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item BIRCH_MOSAIC_SIGN = registerItem("birch_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_BIRCH_MOSAIC_SIGN, DecoBlocks.WALL_BIRCH_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item JUNGLE_MOSAIC_SIGN = registerItem("jungle_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_JUNGLE_MOSAIC_SIGN, DecoBlocks.WALL_JUNGLE_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item ACACIA_MOSAIC_SIGN = registerItem("acacia_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_ACACIA_MOSAIC_SIGN, DecoBlocks.WALL_ACACIA_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item DARK_OAK_MOSAIC_SIGN = registerItem("dark_oak_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_DARK_OAK_MOSAIC_SIGN, DecoBlocks.WALL_DARK_OAK_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item MANGROVE_MOSAIC_SIGN = registerItem("mangrove_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_MANGROVE_MOSAIC_SIGN, DecoBlocks.WALL_MANGROVE_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item CHERRY_MOSAIC_SIGN = registerItem("cherry_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_CHERRY_MOSAIC_SIGN, DecoBlocks.WALL_CHERRY_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item BAMBOO_MOSAIC_SIGN = registerItem("bamboo_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_BAMBOO_MOSAIC_SIGN, DecoBlocks.WALL_BAMBOO_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item CRIMSON_MOSAIC_SIGN = registerItem("crimson_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_CRIMSON_MOSAIC_SIGN, DecoBlocks.WALL_CRIMSON_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item WARPED_MOSAIC_SIGN = registerItem("warped_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_WARPED_MOSAIC_SIGN, DecoBlocks.WALL_WARPED_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item CACTUS_MOSAIC_SIGN = registerItem("cactus_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_CACTUS_MOSAIC_SIGN, DecoBlocks.WALL_CACTUS_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    public static final Item WOODEN_MOSAIC_SIGN = registerItem("wooden_mosaic_sign",
            new SignItem(DecoBlocks.STANDING_WOODEN_MOSAIC_SIGN, DecoBlocks.WALL_WOODEN_MOSAIC_SIGN,
                    new Item.Settings().maxCount(16)));
    ...
    public static final Item SNOW_BRICK = registerItem("snow_brick",
            new SnowBrickItem(new Item.Settings().maxCount(16).useCooldown(15)));
    ...
    public static final Item WARPED_WART = registerItem("warped_wart",
            (Item) createBlockItemWithUniqueName(DecoBlocks.WARPED_WART_PLANT));

    public static final Item ANCIENT_ROSE_SEEDS = registerItem("ancient_rose_seeds",
            (Item) createBlockItemWithUniqueName(DecoBlocks.ANCIENT_ROSE_CROP));

    public static final Item MIGHTY_LAVENDER_FLOWER = registerItem("mighty_lavender_flower",
            (Item) createBlockItemWithUniqueName(DecoBlocks.MIGHTY_LAVENDER_CROP));
