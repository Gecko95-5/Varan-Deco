...
public class DecoItems {
    ...
    public static final Item LILAC_STEW = registerItem("lilac_stew",
            new Item(new Item.Settings().maxCount(1).food(DecoFoodComponents.LILAC_STEW)));

    public static final Item MIGHTY_LAVENDER_STEW = registerItem("mighty_lavender_stew",
            new Item(new Item.Settings().maxCount(1).food(DecoFoodComponents.MIGHTY_LAVENDER_STEW)));

    public static final Item PINK_PETALS_STEW = registerItem("pink_petals_stew",
            new Item(new Item.Settings().maxCount(1).food(DecoFoodComponents.PINK_PETALS_STEW)));
