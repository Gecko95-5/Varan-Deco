...
import net.gecko.varandeco.screen.stone.EndstoneGrindstoneScreenHandler;
import net.gecko.varandeco.screen.stone.EndstoneGrindstoneScreenHandler;
...
public class EndstoneGrindstoneBlock extends WallMountedBlock {
    public static final MapCodec<EndstoneGrindstoneBlock> CODEC = createCodec(EndstoneGrindstoneBlock::new);
    ...
    public EndstoneGrindstoneBlock(AbstractBlock.Settings settings) {
        super(settings);
        this.setDefaultState(this.stateManager.getDefaultState().with(FACING, Direction.NORTH).with(FACE, BlockFace.WALL));
    }

    @Override
    public MapCodec<EndstoneGrindstoneBlock> getCodec() {
        return CODEC;
    }
    ...
    public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
        return new SimpleNamedScreenHandlerFactory(
                (syncId, inventory, player) -> new EndstoneGrindstoneScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), TITLE
        );
    }
