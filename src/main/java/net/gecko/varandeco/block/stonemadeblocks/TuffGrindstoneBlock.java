...
public class TuffGrindstoneBlock extends WallMountedBlock {
	public static final MapCodec<TuffGrindstoneBlock> CODEC = createCodec(TuffGrindstoneBlock::new);
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory(
			(syncId, inventory, player) -> new TuffGrindstoneScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), TITLE
		);
	}
