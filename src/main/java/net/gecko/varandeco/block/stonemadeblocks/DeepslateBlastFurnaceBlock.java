...
public class DeepslateBlastFurnaceBlock extends AbstractFurnaceBlock {
	...
	@Override
	public MapCodec<DeepslateBlastFurnaceBlock> getCodec() {
		return CODEC;
	}
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return validateTicker(type, DecoBlockEntities.DEEPSLATE_BLAST_FURNACE_BE, DeepslateBlastFurnaceBlockEntity::tick);
	}
