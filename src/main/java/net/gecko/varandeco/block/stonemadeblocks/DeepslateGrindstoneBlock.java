...
public class DeepslateGrindstoneBlock extends WallMountedBlock {
	...
	public DeepslateGrindstoneBlock(AbstractBlock.Settings settings) {
		super(settings);
	...
	protected NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory(
				(syncId, inventory, player) -> new DeepslateGrindstoneScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), TITLE
		);
	}
