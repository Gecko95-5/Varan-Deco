...
public class EndstoneBlastFurnaceBlock extends AbstractFurnaceBlock {
    ...
    public static final MapCodec<EndstoneBlastFurnaceBlock> CODEC = createCodec(EndstoneBlastFurnaceBlock::new);

    @Override
    public MapCodec<EndstoneBlastFurnaceBlock> getCodec() {
        return CODEC;
    }
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return validateTicker(type, DecoBlockEntities.END_STONE_BLAST_FURNACE_BE, EndstoneBlastFurnaceBlockEntity::tick);
	}
