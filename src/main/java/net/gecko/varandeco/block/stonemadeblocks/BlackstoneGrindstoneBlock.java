...
public class BlackstoneGrindstoneBlock extends WallMountedBlock {
	...
	public BlackstoneGrindstoneBlock(Settings settings) {
		super(settings);
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory(
			(syncId, inventory, player) -> new BlackstoneGrindstoneScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), TITLE
		);
	}
