...
import net.gecko.varandeco.screen.CactusSmithingScreenHandler;
...
public class CactusSmithingTableBlock extends CraftingTableBlock {
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory(
			(syncId, inventory, player) -> new CactusSmithingScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), SCREEN_TITLE
		);
	}
