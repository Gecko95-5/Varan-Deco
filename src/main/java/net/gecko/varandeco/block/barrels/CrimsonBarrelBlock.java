...
public class CrimsonBarrelBlock extends BlockWithEntity {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (world instanceof ServerWorld serverWorld && world.getBlockEntity(pos) instanceof CrimsonBarrelBlockEntity barrelBlockEntity) {
    ...
    protected void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (blockEntity instanceof CrimsonBarrelBlockEntity) {
            ((CrimsonBarrelBlockEntity)blockEntity).tick();
        }
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new CrimsonBarrelBlockEntity(pos, state);
    }
