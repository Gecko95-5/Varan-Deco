...
public class CherryBarrelBlock extends BlockWithEntity {
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (world instanceof ServerWorld serverWorld && world.getBlockEntity(pos) instanceof CherryBarrelBlockEntity barrelBlockEntity) {
    ...
    protected void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (blockEntity instanceof CherryBarrelBlockEntity) {
            ((CherryBarrelBlockEntity)blockEntity).tick();
        }
    }
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new CherryBarrelBlockEntity(pos, state);
    }
