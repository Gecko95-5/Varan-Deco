...
public class OakBarrelBlock extends BlockWithEntity {
    public static final MapCodec<OakBarrelBlock> CODEC = createCodec(OakBarrelBlock::new);
    public static final EnumProperty<Direction> FACING = Properties.FACING;
    public static final BooleanProperty OPEN = Properties.OPEN;

    @Override
    public MapCodec<OakBarrelBlock> getCodec() {
        return CODEC;
    }
    ...
    protected ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, BlockHitResult hit) {
        if (world instanceof ServerWorld serverWorld && world.getBlockEntity(pos) instanceof OakBarrelBlockEntity barrelBlockEntity) {
    ...
    protected void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        ...
        if (blockEntity instanceof OakBarrelBlockEntity) {
            ((OakBarrelBlockEntity)blockEntity).tick();
        }
    }
