...
import net.gecko.varandeco.block.nature.DriedLeafBlock;
...
public class DecoBlocks {
    public static final Block CUT_GRANITE = registerBlock("cut_granite",
            AbstractBlock.Settings.copy(Blocks.POLISHED_GRANITE), Block::new);
    public static final Block GRANITE_BRICKS = registerBlock("granite_bricks",
            AbstractBlock.Settings.copy(Blocks.POLISHED_GRANITE), Block::new);
    public static final Block CUT_DIORITE = registerBlock("cut_diorite",
            AbstractBlock.Settings.copy(Blocks.POLISHED_DIORITE), Block::new);
    ...
    public static final Block CUT_ANDESITE = registerBlock("cut_andesite",
            AbstractBlock.Settings.copy(Blocks.POLISHED_ANDESITE), Block::new);
    public static final Block ANDESITE_BRICKS = registerBlock("andesite_bricks",
            AbstractBlock.Settings.copy(Blocks.POLISHED_ANDESITE), Block::new);
    public static final Block POLISHED_CALCITE = registerBlock("polished_calcite",
            AbstractBlock.Settings.copy(Blocks.CALCITE).strength(1.0F), Block::new);
    public static final Block CUT_CALCITE = registerBlock("cut_calcite",
            AbstractBlock.Settings.copy(DecoBlocks.POLISHED_CALCITE), Block::new);
    public static final Block CALCITE_BRICKS = registerBlock("calcite_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.POLISHED_CALCITE), Block::new);
    public static final Block DRIPSTONE_BRICKS = registerBlock("dripstone_bricks",
            AbstractBlock.Settings.copy(Blocks.DRIPSTONE_BLOCK).strength(2.0F, 1.0F), Block::new);
    public static final Block DRIPSTONE_BRICK_PILLAR = registerBlock("dripstone_brick_pillar",
            AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICKS), PillarBlock::new);
    public static final Block CHISELED_DRIPSTONE = registerBlock("chiseled_dripstone",
            AbstractBlock.Settings.copy(Blocks.DRIPSTONE_BLOCK), Block::new);
    public static final Block DRY_GRASS_BLOCK = registerBlock("dry_grass_block",
            AbstractBlock.Settings.copy(Blocks.GRASS_BLOCK).mapColor(MapColor.YELLOW), SnowyBlock::new);
    public static final Block PACKED_GRASS = registerBlock("packed_grass",
            AbstractBlock.Settings.copy(Blocks.GRASS_BLOCK), PackedGrassBlock::new);
    public static final Block PACKED_DRY_GRASS = registerBlock("packed_dry_grass",
            AbstractBlock.Settings.copy(DecoBlocks.DRY_GRASS_BLOCK), Block::new);
    public static final Block PACKED_PODZOL = registerBlock("packed_podzol",
            AbstractBlock.Settings.copy(Blocks.PODZOL), Block::new);
    public static final Block PACKED_CRIMSON_NYLIUM = registerPackedNylium("packed_crimson_nylium",
            NetherConfiguredFeatures.CRIMSON_FOREST_VEGETATION_BONEMEAL, Blocks.CRIMSON_NYLIUM);
    public static final Block PACKED_WARPED_NYLIUM = registerPackedNylium("packed_warped_nylium",
            NetherConfiguredFeatures.WARPED_FOREST_VEGETATION_BONEMEAL, Blocks.WARPED_NYLIUM);
    public static final Block CACTUS_PLANKS = registerBlock("cactus_planks",
            AbstractBlock.Settings.create().strength(1.0f,1.5f)
    ...
    public static final Block MUSHROOM_PLANKS = registerBlock("mushroom_planks",
            AbstractBlock.Settings.create().mapColor(MapColor.RAW_IRON_PINK).strength(1.0f,1.5f)
                    .sounds(BlockSoundGroup.WOOD), Block::new);
    public static final Block IRON_CAP_PLANKS = registerBlock("iron_cap_planks",
            AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(2.0f,3.0f)
                    .sounds(BlockSoundGroup.NETHER_WOOD).requiresTool().instrument(NoteBlockInstrument.IRON_XYLOPHONE), Block::new);
    ...
    public static final Block WHITE_SAND = registerFallingBlock("white_sand",
            new ColorCode(0xc0c0c0),Blocks.SAND,MapColor.OFF_WHITE);
    public static final Block BLACK_SAND = registerFallingBlock("black_sand",
            new ColorCode(0x404040), Blocks.SAND, MapColor.DEEPSLATE_GRAY);
    public static final Block COAL_BRICKS = registerBlock("coal_bricks",
            AbstractBlock.Settings.copy(Blocks.BRICKS).mapColor(MapColor.BLACK), Block::new);
    public static final Block CHISELED_COAL_BRICKS = registerBlock("chiseled_coal_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.COAL_BRICKS), Block::new);
    ...
    public static final Block SHINED_AMETHYST = registerBlock("shined_amethyst",
            AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.PALE_PURPLE), Block::new);
    public static final Block AMETHYST_BRICKS = registerBlock("amethyst_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST).strength(2.0F), Block::new);
    public static final Block SCATTERED_AMETHYST = registerBlock("scattered_amethyst",
            AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST), GlazedTerracottaBlock::new);
    public static final Block AMETHYST_PILLAR = registerBlock("amethyst_pillar",
            AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST), PillarBlock::new);
    ...
    public static final Block SHINED_ECHO = registerBlock("shined_echo",
            AbstractBlock.Settings.copy(DecoBlocks.ECHO_BLOCK).luminance(state -> 3), Block::new);
    public static final Block ECHO_BRICKS = registerBlock("echo_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO).strength(2.5F), Block::new);
    public static final Block SCATTERED_ECHO = registerBlock("scattered_echo",
            AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO), GlazedTerracottaBlock::new);
    public static final Block ECHO_PILLAR = registerBlock("echo_pillar",
            AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO), PillarBlock::new);
    ...
    public static final Block CASTED_IRON = registerBlock("casted_iron",
            AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(10.0F, 6.0F)
                    .mapColor(MapColor.DEEPSLATE_GRAY), Block::new);
    ...
    public static final Block CASTED_IRON_SLAB = registerBlock("casted_iron_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CASTED_IRON), SlabBlock::new);
    public static final Block CUT_GOLD = registerBlock("cut_gold",
            AbstractBlock.Settings.copy(Blocks.GOLD_BLOCK), Block::new);
    ...
    public static final Block CUT_GOLD_SLAB = registerBlock("cut_gold_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_GOLD), SlabBlock::new);
    ...
    public static final Block GOLD_GRATE = registerBlock("gold_grate",
            AbstractBlock.Settings.copy(Blocks.GOLD_BLOCK).nonOpaque(), GrateBlock::new);
    ...
    public static final Block IRON_CAP_STEM = registerBlock("iron_cap_stem",
            AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).strength(2.0f,2.0f)
                    .sounds(BlockSoundGroup.NETHER_WOOD).requiresTool().instrument(NoteBlockInstrument.IRON_XYLOPHONE),PillarBlock::new);
    public static final Block STRIPPED_IRON_CAP_STEM = registerBlock("stripped_iron_cap_stem",
            AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(2.0f,2.0f)
                    .sounds(BlockSoundGroup.NETHER_WOOD).requiresTool().instrument(NoteBlockInstrument.IRON_XYLOPHONE),PillarBlock::new);
    ...
    public static final Block GLOWING_GLASS = registerBlock("glowing_glass",
            AbstractBlock.Settings.copy(Blocks.GLASS).nonOpaque().luminance(state -> 15),TransparentBlock::new);
    ...
    public static final Block HARDENED_GLOWING_GLASS = registerBlock("hardened_glowing_glass",
            AbstractBlock.Settings.copy(DecoBlocks.HARDENED_GLASS).nonOpaque().luminance(state -> 15),TransparentBlock::new);
    public static final Block CHISELED_LAPIS = registerBlock("chiseled_lapis",
            AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK), Block::new);
    public static final Block LAPIS_BRICKS = registerBlock("lapis_bricks",
            AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK).strength(4), Block::new);
    ...
    public static final Block LAPIS_PILLAR = registerBlock("lapis_pillar",
            AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK), PillarBlock::new);
    ...
    public static final Block SMOOTH_OBSIDIAN = registerBlock("smooth_obsidian",
            AbstractBlock.Settings.copy(Blocks.OBSIDIAN).strength(60.0F, 1200.0F), Block::new);
    public static final Block SMOOTH_LAPIS = registerBlock("smooth_lapis",
            AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK).mapColor(MapColor.BLUE),Block::new);
    ...
    public static final Block SMOOTH_END_STONE = registerBlock("smooth_end_stone",
            AbstractBlock.Settings.copy(Blocks.END_STONE).strength(3.5F, 9.0F), Block::new);
    ...
    public static final Block SANDED_OBSIDIAN = registerBlock("sanded_obsidian",
            AbstractBlock.Settings.copy(Blocks.OBSIDIAN).mapColor(MapColor.PURPLE).strength(25.0F, 1200.0F), Block::new);
    public static final Block OBSIDIAN_BRICKS = registerBlock("obsidian_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.SANDED_OBSIDIAN), Block::new);
    ...
    public static final Block NETHERRACK_BRICKS = registerBlock("netherrack_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_NETHERRACK), Block::new);
    public static final Block CHISELED_NETHERRACK_BRICKS = registerBlock("chiseled_netherrack_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.NETHERRACK_BRICKS), Block::new);
    public static final Block BASALT_BRICKS = registerBlock("basalt_bricks",
            AbstractBlock.Settings.copy(Blocks.POLISHED_BASALT), PillarBlock::new);
    public static final Block SMOOTH_GLOWSTONE = registerBlock("smooth_glowstone",
            AbstractBlock.Settings.copy(Blocks.GLOWSTONE).strength(0.6f), Block::new);

    public static final Block WHITE_LAMP = registerBlock("white_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor. WHITE), Block::new);
    public static final Block ORANGE_LAMP = registerBlock("orange_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.ORANGE), Block::new);
    public static final Block MAGENTA_LAMP = registerBlock("magenta_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.MAGENTA), Block::new);
    public static final Block LIGHT_BLUE_LAMP = registerBlock("light_blue_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIGHT_BLUE), Block::new);
    public static final Block YELLOW_LAMP = registerBlock("yellow_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.YELLOW), Block::new);
    public static final Block LIME_LAMP = registerBlock("lime_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIME), Block::new);
    public static final Block PINK_LAMP = registerBlock("pink_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.PINK), Block::new);
    public static final Block GRAY_LAMP = registerBlock("gray_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.GRAY), Block::new);
    public static final Block LIGHT_GRAY_LAMP = registerBlock("light_gray_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIGHT_GRAY), Block::new);
    public static final Block CYAN_LAMP = registerBlock("cyan_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.CYAN), Block::new);
    public static final Block PURPLE_LAMP = registerBlock("purple_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.PURPLE), Block::new);
    public static final Block BLUE_LAMP = registerBlock("blue_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BLUE), Block::new);
    public static final Block BROWN_LAMP = registerBlock("brown_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BROWN), Block::new);
    public static final Block GREEN_LAMP = registerBlock("green_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.GREEN), Block::new);
    public static final Block RED_LAMP = registerBlock("red_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.RED), Block::new);
    public static final Block BLACK_LAMP = registerBlock("black_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BLACK), Block::new);
    ...
    public static final Block CHISELED_MUD_BRICKS = registerBlock("chiseled_mud_bricks",
            AbstractBlock.Settings.copy(Blocks.MUD_BRICKS), Block::new);
    ...
    public static final Block PACKED_MYCELIUM = registerBlock("packed_mycelium",
            AbstractBlock.Settings.copy(Blocks.MYCELIUM), PackedMyceliumBlock::new);
    public static final Block NETHER_BRICK_PILLAR = registerBlock("nether_brick_pillar",
            AbstractBlock.Settings.copy(Blocks.NETHER_BRICKS), PillarBlock::new);
    ...
    public static final Block POLISHED_END_STONE = registerBlock("polished_end_stone",
            AbstractBlock.Settings.copy(Blocks.END_STONE).strength(4.0F, 9.0F), Block::new);
    public static final Block CHISELED_END_STONE_BRICKS = registerBlock("chiseled_end_stone_bricks",
            AbstractBlock.Settings.copy(Blocks.END_STONE_BRICKS), Block::new);
    ...
    public static final Block CRACKED_END_STONE_TILES = registerBlock("cracked_end_stone_tiles",
            AbstractBlock.Settings.copy(DecoBlocks.END_STONE_TILES), Block::new);
    ...
    public static final Block VOID_STONE_BRICKS = registerBlock("void_stone_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE).strength(5.5F, 12.0F), Block::new);
    public static final Block VOID_STONE_BRICK_PILLAR = registerBlock("void_stone_brick_pillar",
            AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE_BRICKS), PillarBlock::new);
    ...
    public static final Block WHITE_SANDSTONE = registerBlock("white_sandstone",
            AbstractBlock.Settings.copy(Blocks.SANDSTONE).requiresTool().mapColor(MapColor.OFF_WHITE), Block::new);
    public static final Block CHISELED_WHITE_SANDSTONE = registerBlock("chiseled_white_sandstone",
            AbstractBlock.Settings.copy(DecoBlocks.WHITE_SANDSTONE), Block::new);
    ...
    public static final Block CUT_WHITE_SANDSTONE_BRICKS = registerBlock("cut_white_sandstone_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE).strength(1.6f), Block::new);
    ...
    public static final Block CHISELED_POLISHED_WHITE_SANDSTONE = registerBlock("chiseled_polished_white_sandstone",
            AbstractBlock.Settings.copy(DecoBlocks.CHISELED_WHITE_SANDSTONE), Block::new);
    public static final Block POLISHED_WHITE_SANDSTONE = registerBlock("polished_white_sandstone",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE), Block::new);
    public static final Block WHITE_SANDSTONE_BRICKS = registerBlock("white_sandstone_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS), Block::new);
    public static final Block BLACK_SANDSTONE = registerBlock("black_sandstone",
            AbstractBlock.Settings.copy(Blocks.SANDSTONE).requiresTool().mapColor(MapColor.DEEPSLATE_GRAY), Block::new);
    public static final Block CHISELED_BLACK_SANDSTONE = registerBlock("chiseled_black_sandstone",
            AbstractBlock.Settings.copy(DecoBlocks.BLACK_SANDSTONE), Block::new);
    ...
    public static final Block CUT_BLACK_SANDSTONE_BRICKS = registerBlock("cut_black_sandstone_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE).strength(1.6f), Block::new);
    ...
    public static final Block CHISELED_POLISHED_BLACK_SANDSTONE = registerBlock("chiseled_polished_black_sandstone",
            AbstractBlock.Settings.copy(DecoBlocks.CHISELED_BLACK_SANDSTONE), Block::new);
    public static final Block POLISHED_BLACK_SANDSTONE = registerBlock("polished_black_sandstone",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE), Block::new);
    public static final Block BLACK_SANDSTONE_BRICKS = registerBlock("black_sandstone_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS), Block::new);
    ...
    public static final Block CHISELED_ICE_BRICKS = registerBlock("chiseled_ice_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.ICE_BRICKS), Block::new);
    ...
    public static final Block CHISELED_MAGMA_BLOCK = registerBlock("chiseled_magma_block",
            AbstractBlock.Settings.copy(Blocks.MAGMA_BLOCK), MagmaBlock::new);
    ...
    public static final Block CHISELED_BUBBLE_BLOCK = registerBlock("chiseled_bubble_block",
            AbstractBlock.Settings.copy(DecoBlocks.BUBBLE_BLOCK), BubbleBlock::new);
    ...
    public static final Block WIND_BLOCK = registerBlock("wind_block",
            AbstractBlock.Settings.copy(Blocks.TUFF).mapColor(MapColor.LIGHT_BLUE)
                    .luminance(state -> 1).velocityMultiplier(1.25F).jumpVelocityMultiplier(1.5f)
                    .strength(0.25F), Block::new);
    public static final Block CHISELED_WIND_BLOCK = registerBlock("chiseled_wind_block",
            AbstractBlock.Settings.copy(DecoBlocks.WIND_BLOCK), Block::new);
    public static final Block WIND_BRICKS = registerBlock("wind_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.WIND_BLOCK).strength(1.25F)
                    .mapColor(MapColor.TERRACOTTA_GRAY).velocityMultiplier(1.0F), Block::new);
    public static final Block CHISELED_WIND_BRICKS = registerBlock("chiseled_wind_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.WIND_BRICKS), Block::new);
    public static final Block EARTH_BLOCK = registerBlock("earth_block",
            AbstractBlock.Settings.copy(Blocks.COBBLED_DEEPSLATE).mapColor(MapColor.BROWN)
                    .luminance(state -> 1).velocityMultiplier(0.25F).jumpVelocityMultiplier(0F)
                    .strength(2.0F), Block::new);
    public static final Block CHISELED_EARTH_BLOCK = registerBlock("chiseled_earth_block",
            AbstractBlock.Settings.copy(DecoBlocks.EARTH_BLOCK), Block::new);
    public static final Block EARTH_BRICKS = registerBlock("earth_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.EARTH_BLOCK).strength(3.0F)
                    .mapColor(MapColor.DEEPSLATE_GRAY).velocityMultiplier(1.0F), Block::new);
    public static final Block CHISELED_EARTH_BRICKS = registerBlock("chiseled_earth_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.EARTH_BRICKS), Block::new);
    ...
    public static final Block RED_NETHER_BRICK_PILLAR = registerBlock("red_nether_brick_pillar",
            AbstractBlock.Settings.copy(Blocks.RED_NETHER_BRICKS), PillarBlock::new);
    ...
    public static final Block BLUE_NETHER_BRICK_PILLAR = registerBlock("blue_nether_brick_pillar",
            AbstractBlock.Settings.copy(DecoBlocks.BLUE_NETHER_BRICKS), PillarBlock::new);
    ...
    public static final Block CLOUD_BLOCK = registerCouldBlock("cloud_block",
            AbstractBlock.Settings.create().mapColor(MapColor.CLEAR).strength(0.4f,0.2f)
                    .sounds(BlockSoundGroup.WOOL).nonOpaque().allowsSpawning(DecoBlocks::never).noCollision(),CloudBlock::new);
    public static final Block SOLID_CLOUD = registerBlock("solid_cloud",
            AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).strength(0.8f,0.4f)
                    .allowsSpawning(DecoBlocks::never).nonOpaque(),TransparentBlock::new);
    public static final Block CLOUD_BRICKS = registerBlock("cloud_bricks",
            AbstractBlock.Settings.copy(DecoBlocks.SOLID_CLOUD).strength(1.2f,0.6f),TransparentBlock::new);
    ...
    public static final Block MUSHROOM_MOSAIC = registerBlock("mushroom_mosaic",
            AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS), Block::new);
    ...
    public static final Block IRON_CAP_MOSAIC = registerBlock("iron_cap_mosaic",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS), Block::new);

    public static final Block SMOOTH_RESIN = registerBlock("smooth_resin",
            AbstractBlock.Settings.copy(Blocks.RESIN_BLOCK).strength(1.5F, 6.0F)
                    .requiresTool(), Block::new);
    ...
    public static final Block SMOOTH_RESIN_SLAB = registerBlock("smooth_resin_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_RESIN),SlabBlock::new);
    public static final Block SMOOTH_RESIN_WALL = registerBlock("smooth_resin_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_RESIN),WallBlock::new);
    ...
    public static final Block RESIN_SLAB = registerBlock("resin_slab",
            AbstractBlock.Settings.copy(Blocks.RESIN_BLOCK),SlabBlock::new);
    public static final Block RESIN_WALL = registerBlock("resin_wall",
            AbstractBlock.Settings.copy(Blocks.RESIN_BLOCK),WallBlock::new);
    ...
    public static final Block MUSHROOM_MOSAIC_SLAB = registerBlock("mushroom_mosaic_slab",
            AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_MOSAIC), SlabBlock::new);
    ...
    public static final Block IRON_CAP_MOSAIC_SLAB = registerBlock("iron_cap_mosaic_slab",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_MOSAIC), SlabBlock::new);

    public static final Block PASTEL_ORANGE_BLOCK = registerBlock("pastel_orange_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.ORANGE).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_MAGENTA_BLOCK = registerBlock("pastel_magenta_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.MAGENTA).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_LIGHT_BLUE_BLOCK = registerBlock("pastel_light_blue_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.LIGHT_BLUE).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_YELLOW_BLOCK = registerBlock("pastel_yellow_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.YELLOW).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_LIME_BLOCK = registerBlock("pastel_lime_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.LIME).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_PINK_BLOCK = registerBlock("pastel_pink_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.PINK).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_GRAY_BLOCK = registerBlock("pastel_gray_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.GRAY).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_LIGHT_GRAY_BLOCK = registerBlock("pastel_light_gray_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.LIGHT_GRAY).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_CYAN_BLOCK = registerBlock("pastel_cyan_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.CYAN).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_PURPLE_BLOCK = registerBlock("pastel_purple_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.PURPLE).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_BLUE_BLOCK = registerBlock("pastel_blue_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.BLUE).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_BROWN_BLOCK = registerBlock("pastel_brown_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.BROWN).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_GREEN_BLOCK = registerBlock("pastel_green_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.GREEN).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    public static final Block PASTEL_RED_BLOCK = registerBlock("pastel_red_block",
            AbstractBlock.Settings.create().mapColor(DyeColor.RED).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE), Block::new);
    ...
    public static final Block GRASS_SLAB = registerBlock("grass_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_GRASS), SlabBlock::new);
    public static final Block DRY_GRASS_SLAB = registerBlock("dry_grass_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_DRY_GRASS), SlabBlock::new);
    public static final Block DIRT_SLAB = registerBlock("dirt_slab",
            AbstractBlock.Settings.copy(Blocks.DIRT), SlabBlock::new);
    public static final Block COARSE_DIRT_SLAB = registerBlock("coarse_dirt_slab",
            AbstractBlock.Settings.copy(Blocks.COARSE_DIRT), SlabBlock::new);
    public static final Block PODZOL_SLAB = registerBlock("podzol_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_PODZOL), SlabBlock::new);
    public static final Block ROOTED_DIRT_SLAB = registerBlock("rooted_dirt_slab",
            AbstractBlock.Settings.copy(Blocks.ROOTED_DIRT), SlabBlock::new);
    public static final Block MUD_SLAB = registerBlock("mud_slab",
            AbstractBlock.Settings.copy(Blocks.MUD), SlabBlock::new);
    public static final Block CRIMSON_NYLIUM_SLAB = registerBlock("crimson_nylium_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_CRIMSON_NYLIUM), SlabBlock::new);
    public static final Block WARPED_NYLIUM_SLAB = registerBlock("warped_nylium_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_WARPED_NYLIUM), SlabBlock::new);

    public static final Block BEDROCK_SLAB = registerBlock("bedrock_slab",
            AbstractBlock.Settings.copy(Blocks.BEDROCK), SlabBlock::new);
    ...
    public static final Block COAL_SLAB = registerBlock("coal_slab",
            AbstractBlock.Settings.copy(Blocks.COAL_BLOCK), SlabBlock::new);

    public static final Block RAW_IRON_SLAB = registerBlock("raw_iron_slab",
            AbstractBlock.Settings.copy(Blocks.RAW_IRON_BLOCK), SlabBlock::new);
    public static final Block RAW_COPPER_SLAB = registerBlock("raw_copper_slab",
            AbstractBlock.Settings.copy(Blocks.RAW_COPPER_BLOCK), SlabBlock::new);
    public static final Block RAW_GOLD_SLAB = registerBlock("raw_gold_slab",
            AbstractBlock.Settings.copy(Blocks.RAW_GOLD_BLOCK), SlabBlock::new);

    public static final Block AMETHYST_SLAB = registerBlock("amethyst_slab",
            AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK), SlabBlock::new);

    public static final Block IRON_SLAB = registerBlock("iron_slab",
            AbstractBlock.Settings.copy(Blocks.IRON_BLOCK), SlabBlock::new);
    public static final Block COPPER_SLAB = registerOxidSlab("copper_slab",
            Oxidizable.OxidationLevel.UNAFFECTED, Blocks.COPPER_BLOCK);
    public static final Block EXPOSED_COPPER_SLAB = registerOxidSlab("exposed_copper_slab",
            Oxidizable.OxidationLevel.EXPOSED, Blocks.EXPOSED_COPPER);
    public static final Block WEATHERED_COPPER_SLAB = registerOxidSlab("weathered_copper_slab",
            Oxidizable.OxidationLevel.WEATHERED, Blocks.WEATHERED_COPPER);
    public static final Block OXIDIZED_COPPER_SLAB = registerOxidSlab("oxidized_copper_slab",
            Oxidizable.OxidationLevel.OXIDIZED, Blocks.OXIDIZED_COPPER);
    public static final Block WAXED_COPPER_SLAB = registerBlock("waxed_copper_slab",
            AbstractBlock.Settings.copy(Blocks.WAXED_COPPER_BLOCK), SlabBlock::new);
    public static final Block WAXED_EXPOSED_COPPER_SLAB = registerBlock("waxed_exposed_copper_slab",
            AbstractBlock.Settings.copy(Blocks.WAXED_EXPOSED_COPPER), SlabBlock::new);
    public static final Block WAXED_WEATHERED_COPPER_SLAB = registerBlock("waxed_weathered_copper_slab",
            AbstractBlock.Settings.copy(Blocks.WAXED_WEATHERED_COPPER), SlabBlock::new);
    public static final Block WAXED_OXIDIZED_COPPER_SLAB = registerBlock("waxed_oxidized_copper_slab",
            AbstractBlock.Settings.copy(Blocks.WAXED_OXIDIZED_COPPER), SlabBlock::new);
    public static final Block GOLD_SLAB = registerBlock("gold_slab",
            AbstractBlock.Settings.copy(Blocks.GOLD_BLOCK), SlabBlock::new);

    public static final Block OAK_WOOD_SLAB = registerBlock("oak_wood_slab",
            AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).mapColor(MapColor.DIRT_BROWN), SlabBlock::new);
    public static final Block SPRUCE_WOOD_SLAB = registerBlock("spruce_wood_slab",
            AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS).mapColor(MapColor.BROWN), SlabBlock::new);
    public static final Block BIRCH_WOOD_SLAB = registerBlock("birch_wood_slab",
            AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS).mapColor(MapColor.OFF_WHITE), SlabBlock::new);
    public static final Block JUNGLE_WOOD_SLAB = registerBlock("jungle_wood_slab",
            AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS).mapColor(MapColor.DIRT_BROWN), SlabBlock::new);
    public static final Block ACACIA_WOOD_SLAB = registerBlock("acacia_wood_slab",
            AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS).mapColor(MapColor.STONE_GRAY), SlabBlock::new);
    public static final Block DARK_OAK_WOOD_SLAB = registerBlock("dark_oak_wood_slab",
            AbstractBlock.Settings.copy(Blocks.DARK_OAK_PLANKS), SlabBlock::new);
    public static final Block MANGROVE_WOOD_SLAB = registerBlock("mangrove_wood_slab",
            AbstractBlock.Settings.copy(Blocks.MANGROVE_PLANKS).mapColor(MapColor.DIRT_BROWN), SlabBlock::new);
    public static final Block CHERRY_WOOD_SLAB = registerBlock("cherry_wood_slab",
            AbstractBlock.Settings.copy(Blocks.CHERRY_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY), SlabBlock::new);
    public static final Block CRIMSON_HYPHAE_SLAB = registerBlock("crimson_hyphae_slab",
            AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
                    .mapColor(MapColor.DARK_CRIMSON), SlabBlock::new);
    public static final Block WARPED_HYPHAE_SLAB = registerBlock("warped_hyphae_slab",
            AbstractBlock.Settings.copy(Blocks.WARPED_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
                    .mapColor(MapColor.DARK_DULL_PINK), SlabBlock::new);
    public static final Block WOODEN_WOOD_SLAB = registerBlock("wooden_wood_slab",
            AbstractBlock.Settings.copy(DecoBlocks.WOODEN_PLANKS).mapColor(MapColor.TERRACOTTA_BROWN), SlabBlock::new);
    public static final Block IRON_CAP_HYPHAE_SLAB = registerBlock("iron_cap_hyphae_slab",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM), SlabBlock::new);

    public static final Block BAMBOO_BLOCK_SLAB = registerBlock("bamboo_block_slab",
            AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).mapColor(MapColor.DARK_GREEN), SlabBlock::new);

    public static final Block STRIPPED_OAK_WOOD_SLAB = registerBlock("stripped_oak_wood_slab",
            AbstractBlock.Settings.copy(Blocks.OAK_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_SPRUCE_WOOD_SLAB = registerBlock("stripped_spruce_wood_slab",
            AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_BIRCH_WOOD_SLAB = registerBlock("stripped_birch_wood_slab",
            AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_JUNGLE_WOOD_SLAB = registerBlock("stripped_jungle_wood_slab",
            AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS), SlabBlock::new);
    public static final Block STRIPPED_ACACIA_WOOD_SLAB = registerBlock("stripped_acacia_wood_slab",
            AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS), SlabBlock::new);
    ...
    public static final Block STRIPPED_MANGROVE_WOOD_SLAB = registerBlock("stripped_mangrove_wood_slab",
            AbstractBlock.Settings.copy(Blocks.MANGROVE_PLANKS), SlabBlock::new);
    ...
    public static final Block STRIPPED_CRIMSON_HYPHAE_SLAB = registerBlock("stripped_crimson_hyphae_slab",
            AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).sounds(BlockSoundGroup.NETHER_STEM), SlabBlock::new);
    public static final Block STRIPPED_WARPED_HYPHAE_SLAB = registerBlock("stripped_warped_hyphae_slab",
            AbstractBlock.Settings.copy(Blocks.WARPED_PLANKS).sounds(BlockSoundGroup.NETHER_STEM), SlabBlock::new);
    ...
    public static final Block CLAY_SLAB = registerBlock("clay_slab",
            AbstractBlock.Settings.copy(Blocks.CLAY), SlabBlock::new);
    ...
    public static final Block CRACKED_STONE_BRICK_SLAB = registerBlock("cracked_stone_brick_slab",
            AbstractBlock.Settings.copy(Blocks.CRACKED_STONE_BRICKS), SlabBlock::new);
    ...
    public static final Block CRACKED_DEEPSLATE_BRICK_SLAB = registerBlock("cracked_deepslate_brick_slab",
            AbstractBlock.Settings.copy(Blocks.CRACKED_DEEPSLATE_BRICKS), SlabBlock::new);
    public static final Block CRACKED_DEEPSLATE_TILE_SLAB = registerBlock("cracked_deepslate_tile_slab",
            AbstractBlock.Settings.copy(Blocks.CRACKED_DEEPSLATE_TILES), SlabBlock::new);
    public static final Block MYCELIUM_SLAB = registerBlock("packed_mycelium_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_MYCELIUM), SlabBlock::new);
    public static final Block CRACKED_NETHER_BRICK_SLAB = registerBlock("cracked_nether_brick_slab",
            AbstractBlock.Settings.copy(Blocks.CRACKED_NETHER_BRICKS), SlabBlock::new);
    ...
    public static final Block HAY_SLAB = registerBlock("hay_slab",
            AbstractBlock.Settings.copy(Blocks.HAY_BLOCK), HaySlabBlock::new);
    ...
    public static final Block NETHER_WART_SLAB = registerBlock("nether_wart_slab",
            AbstractBlock.Settings.copy(Blocks.NETHER_WART_BLOCK), SlabBlock::new);
    public static final Block WARPED_WART_SLAB = registerBlock("warped_wart_slab",
            AbstractBlock.Settings.copy(Blocks.WARPED_WART_BLOCK), SlabBlock::new);
    public static final Block BONE_SLAB = registerBlock("bone_slab",
            AbstractBlock.Settings.copy(Blocks.BONE_BLOCK), SlabBlock::new);
    public static final Block DEAD_TUBE_CORAL_SLAB = registerBlock("dead_tube_coral_slab",
            AbstractBlock.Settings.copy(Blocks.DEAD_TUBE_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_BRAIN_CORAL_SLAB = registerBlock("dead_brain_coral_slab",
            AbstractBlock.Settings.copy(Blocks.DEAD_BRAIN_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_BUBBLE_CORAL_SLAB = registerBlock("dead_bubble_coral_slab",
            AbstractBlock.Settings.copy(Blocks.DEAD_BUBBLE_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_FIRE_CORAL_SLAB = registerBlock("dead_fire_coral_slab",
            AbstractBlock.Settings.copy(Blocks.DEAD_FIRE_CORAL_BLOCK), SlabBlock::new);
    public static final Block DEAD_HORN_CORAL_SLAB = registerBlock("dead_horn_coral_slab",
            AbstractBlock.Settings.copy(Blocks.DEAD_HORN_CORAL_BLOCK), SlabBlock::new);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB = registerBlock("cracked_polished_blackstone_brick_slab",
            AbstractBlock.Settings.copy(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS), SlabBlock::new);
    public static final Block MOSS_SLAB = registerBlock("moss_slab",
            AbstractBlock.Settings.copy(Blocks.MOSS_BLOCK), SlabBlock::new);
    public static final Block PALE_MOSS_SLAB = registerBlock("pale_moss_slab",
            AbstractBlock.Settings.copy(Blocks.PALE_MOSS_BLOCK), SlabBlock::new);
    public static final Block SCULK_SLAB = registerBlock("sculk_slab",
            AbstractBlock.Settings.copy(Blocks.SCULK), SlabBlock::new);
    public static final Block HONEYCOMB_SLAB = registerBlock("honeycomb_slab",
            AbstractBlock.Settings.copy(Blocks.HONEYCOMB_BLOCK), SlabBlock::new);

    public static final Block CUT_GRANITE_SLAB = registerBlock("cut_granite_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_GRANITE), SlabBlock::new);
    public static final Block GRANITE_BRICK_SLAB = registerBlock("granite_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.GRANITE_BRICKS), SlabBlock::new);
    public static final Block CUT_DIORITE_SLAB = registerBlock("cut_diorite_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_DIORITE), SlabBlock::new);
    public static final Block DIORITE_BRICK_SLAB = registerBlock("diorite_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.DIORITE_BRICKS), SlabBlock::new);
    public static final Block CUT_ANDESITE_SLAB = registerBlock("cut_andesite_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_ANDESITE), SlabBlock::new);
    public static final Block ANDESITE_BRICK_SLAB = registerBlock("andesite_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.ANDESITE_BRICKS), SlabBlock::new);
    public static final Block POLISHED_CALCITE_SLAB = registerBlock("polished_calcite_slab",
            AbstractBlock.Settings.copy(DecoBlocks.POLISHED_CALCITE), SlabBlock::new);
    public static final Block CUT_CALCITE_SLAB = registerBlock("cut_calcite_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_CALCITE), SlabBlock::new);
    public static final Block CALCITE_BRICK_SLAB = registerBlock("calcite_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CALCITE_BRICKS), SlabBlock::new);
    public static final Block DRIPSTONE_BRICK_SLAB = registerBlock("dripstone_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICKS), SlabBlock::new);
    public static final Block DRIPSTONE_BRICK_PILLAR_SLAB = registerBlock("dripstone_brick_pillar_slab",
            AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICK_PILLAR), SlabBlock::new);
    ...
    public static final Block MUSHROOM_SLAB = registerBlock("mushroom_slab",
            AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS), SlabBlock::new);
    public static final Block IRON_CAP_SLAB = registerBlock("iron_cap_slab",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS), SlabBlock::new);
    ...
    public static final Block SMOOTH_LAPIS_SLAB = registerBlock("smooth_lapis_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_LAPIS), SlabBlock::new);
    public static final Block SMOOTH_OBSIDIAN_SLAB = registerBlock("smooth_obsidian_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_OBSIDIAN), SlabBlock::new);
    ...
    public static final Block SMOOTH_WHITE_SANDSTONE_SLAB = registerBlock("smooth_white_sandstone_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_WHITE_SANDSTONE), SlabBlock::new);
    public static final Block SMOOTH_BLACK_SANDSTONE_SLAB = registerBlock("smooth_black_sandstone_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_BLACK_SANDSTONE), SlabBlock::new);
    ...
    public static final Block SMOOTH_END_STONE_SLAB = registerBlock("smooth_end_stone_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_END_STONE), SlabBlock::new);
    public static final Block SANDED_OBSIDIAN_SLAB = registerBlock("sanded_obsidian_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SANDED_OBSIDIAN), SlabBlock::new);
    ...
    public static final Block CUT_OBSIDIAN_SLAB = registerBlock("cut_obsidian_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_OBSIDIAN), SlabBlock::new);
    ...
    public static final Block CUT_PURPUR_SLAB = registerBlock("cut_purpur_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_PURPUR), SlabBlock::new);
    ...
    public static final Block PACKED_NETHERRACK_SLAB = registerBlock("packed_netherrack_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_NETHERRACK), SlabBlock::new);
    public static final Block NETHERRACK_BRICK_SLAB = registerBlock("netherrack_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.NETHERRACK_BRICKS), SlabBlock::new);
    ...
    public static final Block VOID_STONE_BRICK_PILLAR_SLAB = registerBlock("void_stone_brick_pillar_slab",
            AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE_BRICK_PILLAR), SlabBlock::new);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_SLAB = registerBlock("cracked_red_nether_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_RED_NETHER_BRICKS), SlabBlock::new);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_SLAB = registerBlock("cracked_polished_blackstone_tile_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES), SlabBlock::new);
    public static final Block CLOUD_SLAB = registerBlock("cloud_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SOLID_CLOUD), TransparentSlabBlock::new);
    public static final Block CLOUD_BRICK_SLAB = registerBlock("cloud_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CLOUD_BRICKS), TransparentSlabBlock::new);
    ...
    public static final Block COPPER_STAIRS = registerOxidStairs("copper_stairs",
            Oxidizable.OxidationLevel.UNAFFECTED,Blocks.COPPER_BLOCK, Blocks.COPPER_BLOCK);
    public static final Block EXPOSED_COPPER_STAIRS = registerOxidStairs("exposed_copper_stairs",
            Oxidizable.OxidationLevel.EXPOSED,Blocks.EXPOSED_COPPER, Blocks.EXPOSED_COPPER);
    public static final Block WEATHERED_COPPER_STAIRS = registerOxidStairs("weathered_copper_stairs",
            Oxidizable.OxidationLevel.WEATHERED,Blocks.WEATHERED_COPPER, Blocks.WEATHERED_COPPER);
    public static final Block OXIDIZED_COPPER_STAIRS = registerOxidStairs("oxidized_copper_stairs",
            Oxidizable.OxidationLevel.OXIDIZED,Blocks.OXIDIZED_COPPER, Blocks.OXIDIZED_COPPER);
    ...
    public static final Block MANGROVE_WOOD_STAIRS = registerWoodStairs("mangrove_wood_stairs",
            Blocks.MANGROVE_PLANKS, Blocks.MANGROVE_PLANKS, MapColor.DIRT_BROWN);
    ...
    public static final Block PALE_OAK_WOOD_STAIRS = registerWoodStairs("pale_oak_wood_stairs",
            Blocks.PALE_OAK_PLANKS, Blocks.PALE_OAK_PLANKS, MapColor.STONE_GRAY);
    public static final Block CRIMSON_HYPHAE_STAIRS = registerWoodStairs("crimson_hyphae_stairs",
            Blocks.CRIMSON_PLANKS, Blocks.CRIMSON_PLANKS, MapColor.DARK_CRIMSON);
    public static final Block WARPED_HYPHAE_STAIRS = registerWoodStairs("warped_hyphae_stairs",
            Blocks.WARPED_PLANKS, Blocks.WARPED_PLANKS, MapColor.DARK_DULL_PINK);
    ...
    public static final Block DRIFTWOOD_LOG_STAIRS = registerWoodStairs("driftwood_log_stairs",
            DecoBlocks.DRIFTWOOD_PLANKS, DecoBlocks.DRIFTWOOD_PLANKS, MapColor.LIGHT_BLUE);
    ...
    public static final Block BAMBOO_BLOCK_STAIRS = registerWoodStairs("bamboo_block_stairs",
            Blocks.BAMBOO_PLANKS,Blocks.BAMBOO_PLANKS, MapColor.DARK_GREEN);
    ...
    public static final Block STRIPPED_PALE_OAK_WOOD_SLAB = registerBlock("stripped_pale_oak_wood_slab",
            AbstractBlock.Settings.copy(Blocks.PALE_OAK_PLANKS), SlabBlock::new);
    public static final Block PALE_OAK_WOOD_SLAB = registerBlock("pale_oak_wood_slab",
            AbstractBlock.Settings.copy(Blocks.PALE_OAK_PLANKS).mapColor(MapColor.STONE_GRAY), SlabBlock::new);
    ...
    public static final Block WIND_SLAB = registerBlock("wind_slab",
            AbstractBlock.Settings.copy(DecoBlocks.WIND_BLOCK),SlabBlock::new);
    public static final Block WIND_BRICK_SLAB = registerBlock("wind_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.WIND_BRICKS),SlabBlock::new);
    public static final Block EARTH_SLAB = registerBlock("earth_slab",
            AbstractBlock.Settings.copy(DecoBlocks.EARTH_BLOCK),SlabBlock::new);
    public static final Block EARTH_BRICK_SLAB = registerBlock("earth_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.EARTH_BRICKS),SlabBlock::new);
    ...
    public static final Block CRACKED_TUFF_BRICK_SLAB = registerBlock("cracked_tuff_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_BRICKS),SlabBlock::new);
    public static final Block MOSSY_TUFF_BRICK_SLAB = registerBlock("mossy_tuff_brick_slab",
            AbstractBlock.Settings.copy(DecoBlocks.MOSSY_TUFF_BRICKS),SlabBlock::new);
    public static final Block CRACKED_TUFF_TILE_SLAB = registerBlock("cracked_tuff_tile_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_TILES),SlabBlock::new);
    ...
    public static final Block DRIFTWOOD_LOG_SLAB = registerBlock("driftwood_log_slab",
            AbstractBlock.Settings.copy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.LIGHT_BLUE), SlabBlock::new);
    public static final Block DRIED_DRIFTWOOD_SLAB = registerBlock("dried_driftwood_slab",
            AbstractBlock.Settings.copy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.TERRACOTTA_WHITE), SlabBlock::new);
    ...
    public static final Block ROUGE_WILDFLOWERS = registerBlock("rouge_wildflowers",
            AbstractBlock.Settings.copy(Blocks.WILDFLOWERS), FlowerbedBlock::new);
    ...
    public static final Block IRON_CAP_MUSHROOM_BLOCK = registerBlock("iron_cap_mushroom_block",
            AbstractBlock.Settings.create().strength(4.0F, 6.0F).mapColor(MapColor.IRON_GRAY)
                    .sounds(BlockSoundGroup.CANDLE), Block::new);

    public static final Block SPORE_IRON_ORE = registerBlock("spore_iron_ore",
            AbstractBlock.Settings.create().strength(3.0F, 3.0F).mapColor(MapColor.LICHEN_GREEN)
                    .sounds(BlockSoundGroup.NETHER_GOLD_ORE).requiresTool(), Block::new);
    ...
    public static final Block TAIGA_DANDELION = registerFlower("taiga_dandelion",
            StatusEffects.INSTANT_HEALTH, 1,Blocks.DANDELION);
    ...
    public static final Block ALPINE_POPPY = registerFlower("alpine_poppy",
            StatusEffects.JUMP_BOOST, 5, Blocks.POPPY);
    ...
    public static final Block CYAN_ORCHID = registerFlower("cyan_orchid",
            StatusEffects.GLOWING, 7, Blocks.BLUE_ORCHID);
    ...
    public static final Block DEAD_EYE_DAISY = registerDesertFlower("dead_eye_daisy",
            StatusEffects.STRENGTH, 5,Blocks.OXEYE_DAISY);
    ...
    public static final Block FELICIA_DAISY = registerDesertFlower("felicia_daisy",
            StatusEffects.HUNGER, 11,Blocks.OXEYE_DAISY);
    ...
    public static final Block FERN_LAVENDER = registerFlower("fern_lavender",
            StatusEffects.SPEED,9,Blocks.POPPY);
    ...
    public static final Block CARAMEL_BUTTERCUP = registerFlower("caramel_buttercup",
            StatusEffects.NAUSEA,3,Blocks.POPPY);
    ...
    public static final Block NIGHTSHADE = registerFlower("nightshade",
            StatusEffects.INSTANT_DAMAGE,1,Blocks.POPPY);
    ...
    public static final Block ENDERSHADE = registerEndFlower("endershade",
            StatusEffects.MINING_FATIGUE,9,Blocks.POPPY);
    ...
    public static final Block IRIS = registerFlower("iris",
            StatusEffects.MINING_FATIGUE,7,Blocks.POPPY);
    ...
    public static final Block BLUE_DELPHINIUM = registerFlower("blue_delphinium",
            StatusEffects.REGENERATION,5,Blocks.POPPY);
    ...
    public static final Block ALPINE_SPEEDWELL = registerFlower("alpine_speedwell",
            StatusEffects.SPEED,13,Blocks.POPPY);
    ...
    public static final Block MUSHROOM_CRAFTING_TABLE = registerBlock("mushroom_crafting_table",
            AbstractBlock.Settings.copy(Blocks.CRAFTING_TABLE).mapColor(MapColor.OFF_WHITE), MushroomCraftingTableBlock::new);
    public static final Block IRON_CAP_CRAFTING_TABLE = registerBlock("iron_cap_crafting_table",
            AbstractBlock.Settings.copy(Blocks.CRAFTING_TABLE).mapColor(MapColor.TERRACOTTA_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM), IronCapCraftingTableBlock::new);
    ...
    public static final Block IRON_CAP_LADDER = registerBlock("iron_cap_ladder",
            AbstractBlock.Settings.copy(Blocks.LADDER)
                    .sounds(BlockSoundGroup.NETHER_STEM),LadderBlock::new);
    ...
    public static final Block IRON_LADDER = registerBlock("iron_ladder",
            AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.METAL)
                    .strength(5.0F, 6.0F).requiresTool(),LadderBlock::new);
    ...
    public static final Block COPPER_LADDER = registerOxidLadder("copper_ladder",
            Oxidizable.OxidationLevel.UNAFFECTED, Blocks.LADDER);
    public static final Block EXPOSED_COPPER_LADDER = registerOxidLadder("exposed_copper_ladder",
            Oxidizable.OxidationLevel.EXPOSED, Blocks.LADDER);
    public static final Block WEATHERED_COPPER_LADDER = registerOxidLadder("weathered_copper_ladder",
            Oxidizable.OxidationLevel.WEATHERED,Blocks.LADDER);
    public static final Block OXIDIZED_COPPER_LADDER = registerOxidLadder("oxidized_copper_ladder",
            Oxidizable.OxidationLevel.OXIDIZED, Blocks.LADDER);

    public static final Block WAXED_COPPER_LADDER = registerBlock("waxed_copper_ladder",
            AbstractBlock.Settings.copy(DecoBlocks.COPPER_LADDER),LadderBlock::new);
    public static final Block WAXED_EXPOSED_COPPER_LADDER = registerBlock("waxed_exposed_copper_ladder",
            AbstractBlock.Settings.copy(DecoBlocks.EXPOSED_COPPER_LADDER),LadderBlock::new);
    public static final Block WAXED_WEATHERED_COPPER_LADDER = registerBlock("waxed_weathered_copper_ladder",
            AbstractBlock.Settings.copy(DecoBlocks.WEATHERED_COPPER_LADDER),LadderBlock::new);
    public static final Block WAXED_OXIDIZED_COPPER_LADDER = registerBlock("waxed_oxidized_copper_ladder",
            AbstractBlock.Settings.copy(DecoBlocks.OXIDIZED_COPPER_LADDER),LadderBlock::new);

    public static final Block GRASS_CARPET = registerBlock("grass_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).sounds(BlockSoundGroup.GRASS),CarpetBlock::new);
    public static final Block DRY_GRASS_CARPET = registerBlock("dry_grass_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).sounds(BlockSoundGroup.GRASS)
                    .mapColor(MapColor.YELLOW),CarpetBlock::new);
    public static final Block PODZOL_CARPET = registerBlock("podzol_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.SPRUCE_BROWN)
                    .sounds(BlockSoundGroup.GRAVEL),CarpetBlock::new);
    public static final Block CRIMSON_NYLIUM_CARPET = registerBlock("crimson_nylium_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.DULL_RED)
                    .sounds(BlockSoundGroup.NYLIUM),CarpetBlock::new);
    public static final Block WARPED_NYLIUM_CARPET = registerBlock("warped_nylium_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.TEAL)
                    .sounds(BlockSoundGroup.NYLIUM),CarpetBlock::new);
    public static final Block SAND_CARPET = registerBlock("sand_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.PALE_YELLOW)
                    .sounds(BlockSoundGroup.SAND),CarpetBlock::new);
    public static final Block RED_SAND_CARPET = registerBlock("red_sand_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.ORANGE)
                    .sounds(BlockSoundGroup.SAND),CarpetBlock::new);
    public static final Block GRAVEL_CARPET = registerBlock("gravel_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.STONE_GRAY)
                    .sounds(BlockSoundGroup.GRAVEL),CarpetBlock::new);
    public static final Block MYCELIUM_CARPET = registerBlock("mycelium_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.PURPLE)
                    .sounds(BlockSoundGroup.GRASS),CarpetBlock::new);

    public static final Block HAY_CARPET = registerBlock("hay_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.YELLOW)
                    .sounds(BlockSoundGroup.GRASS),CarpetBlock::new);
    public static final Block SCULK_CARPET = registerBlock("sculk_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.BLACK)
                    .sounds(BlockSoundGroup.SCULK),CarpetBlock::new);

    public static final Block WHITE_SAND_CARPET = registerBlock("white_sand_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.OFF_WHITE)
                    .sounds(BlockSoundGroup.SAND),CarpetBlock::new);
    public static final Block BLACK_SAND_CARPET = registerBlock("black_sand_carpet",
            AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.DEEPSLATE_GRAY)
                    .sounds(BlockSoundGroup.SAND),CarpetBlock::new);

    public static final Block PACKED_CACTUS = registerBlock("packed_cactus",
            AbstractBlock.Settings.copy(Blocks.DARK_OAK_WOOD).strength(0.4F).sounds(BlockSoundGroup.WOOL)
                    .mapColor(MapColor.GREEN),PillarBlock::new);
    public static final Block STRIPPED_CACTUS = registerBlock("stripped_cactus",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_CACTUS).mapColor(MapColor.PALE_GREEN),PillarBlock::new);
    ...
    public static final Block MUSHROOM_FENCE = registerBlock("mushroom_fence",
            AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS),FenceBlock::new);
    public static final Block IRON_CAP_FENCE = registerBlock("iron_cap_fence",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS),FenceBlock::new);
    ...
    public static final Block LIGHT_GOLD_BARS = registerBlock("light_gold_bars",
            AbstractBlock.Settings.copy(DecoBlocks.LIGHT_IRON_BARS).sounds(BlockSoundGroup.METAL),PaneBlock::new);
    ...
    public static final Block GOLD_BARS = registerBlock("gold_bars",
            AbstractBlock.Settings.copy(Blocks.IRON_BARS).sounds(BlockSoundGroup.METAL),PaneBlock::new);
    ...
    public static final Block HEAVY_GOLD_BARS = registerBlock("heavy_gold_bars",
            AbstractBlock.Settings.copy(DecoBlocks.HEAVY_IRON_BARS).sounds(BlockSoundGroup.METAL)
                    .mapColor(MapColor.GOLD),PaneBlock::new);
    ...
    public static final Block DIRT_WALL = registerBlock("dirt_wall",
            AbstractBlock.Settings.copy(Blocks.DIRT), WallBlock::new);
    public static final Block COARSE_DIRT_WALL = registerBlock("coarse_dirt_wall",
            AbstractBlock.Settings.copy(Blocks.COARSE_DIRT), WallBlock::new);
    public static final Block ROOTED_DIRT_WALL = registerBlock("rooted_dirt_wall",
            AbstractBlock.Settings.copy(Blocks.ROOTED_DIRT), WallBlock::new);
    public static final Block MUD_WALL = registerBlock("mud_wall",
            AbstractBlock.Settings.copy(Blocks.MUD), WallBlock::new);
    public static final Block BEDROCK_WALL = registerBlock("bedrock_wall",
            AbstractBlock.Settings.copy(Blocks.BEDROCK), WallBlock::new);

    public static final Block COAL_WALL = registerBlock("coal_wall",
            AbstractBlock.Settings.copy(Blocks.COAL_BLOCK), WallBlock::new);
    public static final Block AMETHYST_WALL = registerBlock("amethyst_wall",
            AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK), WallBlock::new);

    public static final Block OAK_WOOD_WALL = registerBlock("oak_wood_wall",
            AbstractBlock.Settings.copy(Blocks.OAK_PLANKS).mapColor(MapColor.DIRT_BROWN), WallBlock::new);
    public static final Block SPRUCE_WOOD_WALL = registerBlock("spruce_wood_wall",
            AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS).mapColor(MapColor.BROWN), WallBlock::new);
    public static final Block BIRCH_WOOD_WALL = registerBlock("birch_wood_wall",
            AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS).mapColor(MapColor.OFF_WHITE), WallBlock::new);
    public static final Block JUNGLE_WOOD_WALL = registerBlock("jungle_wood_wall",
            AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS).mapColor(MapColor.DIRT_BROWN), WallBlock::new);
    public static final Block ACACIA_WOOD_WALL = registerBlock("acacia_wood_wall",
            AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS).mapColor(MapColor.STONE_GRAY), WallBlock::new);
    public static final Block DARK_OAK_WOOD_WALL = registerBlock("dark_oak_wood_wall",
            AbstractBlock.Settings.copy(Blocks.DARK_OAK_PLANKS), WallBlock::new);
    public static final Block MANGROVE_WOOD_WALL = registerBlock("mangrove_wood_wall",
            AbstractBlock.Settings.copy(Blocks.MANGROVE_PLANKS).mapColor(MapColor.DIRT_BROWN), WallBlock::new);
    public static final Block CHERRY_WOOD_WALL = registerBlock("cherry_wood_wall",
            AbstractBlock.Settings.copy(Blocks.CHERRY_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY), WallBlock::new);
    public static final Block PALE_OAK_WOOD_WALL = registerBlock("pale_oak_wood_wall",
            AbstractBlock.Settings.copy(Blocks.PALE_OAK_PLANKS).mapColor(MapColor.STONE_GRAY), WallBlock::new);
    public static final Block CRIMSON_HYPHAE_WALL = registerBlock("crimson_hyphae_wall",
            AbstractBlock.Settings.copy(Blocks.CRIMSON_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
                    .mapColor(MapColor.DARK_CRIMSON), WallBlock::new);
    public static final Block WARPED_HYPHAE_WALL = registerBlock("warped_hyphae_wall",
            AbstractBlock.Settings.copy(Blocks.WARPED_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
                    .mapColor(MapColor.DARK_DULL_PINK), WallBlock::new);
    public static final Block WOODEN_WOOD_WALL = registerBlock("wooden_wood_wall",
            AbstractBlock.Settings.copy(DecoBlocks.WOODEN_PLANKS).mapColor(MapColor.TERRACOTTA_BROWN), WallBlock::new);
    public static final Block IRON_CAP_HYPHAE_WALL = registerBlock("iron_cap_hyphae_wall",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS).mapColor(MapColor.TERRACOTTA_GRAY), WallBlock::new);
    public static final Block DRIFTWOOD_LOG_WALL = registerBlock("driftwood_log_wall",
            AbstractBlock.Settings.copy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.LIGHT_BLUE), WallBlock::new);
    public static final Block DRIED_DRIFTWOOD_WALL = registerBlock("dried_driftwood_wall",
            AbstractBlock.Settings.copy(DecoBlocks.DRIFTWOOD_PLANKS).mapColor(MapColor.TERRACOTTA_WHITE), WallBlock::new);

    public static final Block BAMBOO_BLOCK_WALL = registerBlock("bamboo_block_wall",
            AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).mapColor(MapColor.DARK_GREEN), WallBlock::new);

    public static final Block STRIPPED_OAK_WOOD_WALL = registerBlock("stripped_oak_wood_wall",
            AbstractBlock.Settings.copy(Blocks.OAK_PLANKS), WallBlock::new);
    public static final Block STRIPPED_SPRUCE_WOOD_WALL = registerBlock("stripped_spruce_wood_wall",
            AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS), WallBlock::new);
    public static final Block STRIPPED_BIRCH_WOOD_WALL = registerBlock("stripped_birch_wood_wall",
            AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS), WallBlock::new);
    public static final Block STRIPPED_JUNGLE_WOOD_WALL = registerBlock("stripped_jungle_wood_wall",
            AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS), WallBlock::new);
    public static final Block STRIPPED_ACACIA_WOOD_WALL = registerBlock("stripped_acacia_wood_wall",
            AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS), WallBlock::new);
    ...
    public static final Block CLAY_WALL = registerBlock("clay_wall",
            AbstractBlock.Settings.copy(Blocks.CLAY), WallBlock::new);
    ...
    public static final Block DARK_PRISMARINE_WALL = registerBlock("dark_prismarine_wall",
            AbstractBlock.Settings.copy(Blocks.DARK_PRISMARINE),WallBlock::new);
    public static final Block CRACKED_STONE_BRICK_WALL = registerBlock("cracked_stone_brick_wall",
            AbstractBlock.Settings.copy(Blocks.CRACKED_STONE_BRICKS),WallBlock::new);
    ...
    public static final Block CRACKED_DEEPSLATE_BRICK_WALL = registerBlock("cracked_deepslate_brick_wall",
            AbstractBlock.Settings.copy(Blocks.CRACKED_DEEPSLATE_BRICKS), WallBlock::new);
    public static final Block CRACKED_DEEPSLATE_TILE_WALL = registerBlock("cracked_deepslate_tile_wall",
            AbstractBlock.Settings.copy(Blocks.CRACKED_DEEPSLATE_TILES), WallBlock::new);
    public static final Block CRACKED_NETHER_BRICK_WALL = registerBlock("cracked_nether_brick_wall",
            AbstractBlock.Settings.copy(Blocks.CRACKED_NETHER_BRICKS), WallBlock::new);
    ...
    public static final Block BONE_WALL = registerBlock("bone_wall",
            AbstractBlock.Settings.copy(Blocks.BONE_BLOCK), WallBlock::new);
    public static final Block DEAD_TUBE_CORAL_WALL = registerBlock("dead_tube_coral_wall",
            AbstractBlock.Settings.copy(Blocks.DEAD_TUBE_CORAL_BLOCK), WallBlock::new);
    public static final Block DEAD_BRAIN_CORAL_WALL = registerBlock("dead_brain_coral_wall",
            AbstractBlock.Settings.copy(Blocks.DEAD_BRAIN_CORAL_BLOCK), WallBlock::new);
    public static final Block DEAD_BUBBLE_CORAL_WALL = registerBlock("dead_bubble_coral_wall",
            AbstractBlock.Settings.copy(Blocks.DEAD_BUBBLE_CORAL_BLOCK), WallBlock::new);
    public static final Block DEAD_FIRE_CORAL_WALL = registerBlock("dead_fire_coral_wall",
            AbstractBlock.Settings.copy(Blocks.DEAD_FIRE_CORAL_BLOCK), WallBlock::new);
    public static final Block DEAD_HORN_CORAL_WALL = registerBlock("dead_horn_coral_wall",
            AbstractBlock.Settings.copy(Blocks.DEAD_HORN_CORAL_BLOCK), WallBlock::new);
    ...
    public static final Block SMOOTH_LAPIS_WALL = registerBlock("smooth_lapis_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_LAPIS), WallBlock::new);
    public static final Block SMOOTH_OBSIDIAN_WALL = registerBlock("smooth_obsidian_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_OBSIDIAN), WallBlock::new);
    ...
    public static final Block SMOOTH_WHITE_SANDSTONE_WALL = registerBlock("smooth_white_sandstone_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_WHITE_SANDSTONE), WallBlock::new);
    public static final Block SMOOTH_BLACK_SANDSTONE_WALL = registerBlock("smooth_black_sandstone_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_BLACK_SANDSTONE), WallBlock::new);
    ...
    public static final Block SMOOTH_END_STONE_WALL = registerBlock("smooth_end_stone_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_END_STONE), WallBlock::new);
    public static final Block SANDED_OBSIDIAN_WALL = registerBlock("sanded_obsidian_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SANDED_OBSIDIAN), WallBlock::new);
    ...
    public static final Block CUT_OBSIDIAN_WALL = registerBlock("cut_obsidian_wall",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_OBSIDIAN), WallBlock::new);
    public static final Block CUT_PURPUR_WALL = registerBlock("cut_purpur_wall",
            AbstractBlock.Settings.copy(DecoBlocks.CUT_PURPUR), WallBlock::new);
    ...
    public static final Block PACKED_NETHERRACK_WALL = registerBlock("packed_netherrack_wall",
            AbstractBlock.Settings.copy(DecoBlocks.PACKED_NETHERRACK), WallBlock::new);
    public static final Block NETHERRACK_BRICK_WALL = registerBlock("netherrack_brick_wall",
            AbstractBlock.Settings.copy(DecoBlocks.NETHERRACK_BRICKS), WallBlock::new);
    ...
    public static final Block VOID_STONE_BRICK_PILLAR_WALL = registerBlock("void_stone_brick_pillar_wall",
            AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE_BRICK_PILLAR), WallBlock::new);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_WALL = registerBlock("cracked_red_nether_brick_wall",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_RED_NETHER_BRICKS), WallBlock::new);
    public static final Block WIND_WALL = registerBlock("wind_wall",
            AbstractBlock.Settings.copy(DecoBlocks.WIND_BLOCK),WallBlock::new);
    public static final Block WIND_BRICK_WALL = registerBlock("wind_brick_wall",
            AbstractBlock.Settings.copy(DecoBlocks.WIND_BRICKS),WallBlock::new);
    public static final Block EARTH_WALL = registerBlock("earth_wall",
            AbstractBlock.Settings.copy(DecoBlocks.EARTH_BLOCK),WallBlock::new);
    public static final Block EARTH_BRICK_WALL = registerBlock("earth_brick_wall",
            AbstractBlock.Settings.copy(DecoBlocks.EARTH_BRICKS),WallBlock::new);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_WALL = registerBlock("cracked_polished_blackstone_tile_wall",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES), WallBlock::new);
    public static final Block CLOUD_WALL = registerBlock("cloud_wall",
            AbstractBlock.Settings.copy(DecoBlocks.SOLID_CLOUD), TransparentWallBlock::new);
    public static final Block CLOUD_BRICK_WALL = registerBlock("cloud_brick_wall",
            AbstractBlock.Settings.copy(DecoBlocks.CLOUD_BRICKS), TransparentWallBlock::new);
    public static final Block CRACKED_TUFF_BRICK_WALL = registerBlock("cracked_tuff_brick_wall",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_BRICKS), WallBlock::new);
    public static final Block MOSSY_TUFF_BRICK_WALL = registerBlock("mossy_tuff_brick_wall",
            AbstractBlock.Settings.copy(DecoBlocks.MOSSY_TUFF_BRICKS), WallBlock::new);
    ...
    public static final Block CRACKED_TUFF_TILE_WALL = registerBlock("cracked_tuff_tile_wall",
            AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_TILES), WallBlock::new);
    ...
    public static final Block MEGA_BROWN_TULIP = registerBlock("mega_brown_tulip",
            AbstractBlock.Settings.copy(Blocks.PEONY),TallFlowerBlock::new);
    ...
    public static final Block GLOWING_GLASS_PANE = registerBlock("glowing_glass_pane",
            AbstractBlock.Settings.copy(Blocks.GLASS_PANE).nonOpaque().luminance(state -> 15),PaneBlock::new);
    ...
    public static final Block HARDENED_GLOWING_GLASS_PANE = registerBlock("hardened_glowing_glass_pane",
            AbstractBlock.Settings.copy(DecoBlocks.HARDENED_GLASS_PANE).luminance(state -> 15)
                    .nonOpaque(),PaneBlock::new);
    ...
    public static final Block HYDRATED_BRAIN_CORAL_WALL_FAN = registerDeadCoralFan("hydrated_brain_coral_wall_fan",
            AbstractBlock.Settings.copy(Blocks.BRAIN_CORAL_WALL_FAN), DeadCoralWallFanBlock::new,
    ...
    public static final Block HYDRATED_BUBBLE_CORAL_WALL_FAN = registerDeadCoralFan("hydrated_bubble_coral_wall_fan",
            AbstractBlock.Settings.copy(Blocks.BUBBLE_CORAL_WALL_FAN), DeadCoralWallFanBlock::new,
    ...
    public static final Block HYDRATED_FIRE_CORAL_WALL_FAN = registerDeadCoralFan("hydrated_fire_coral_wall_fan",
            AbstractBlock.Settings.copy(Blocks.FIRE_CORAL_WALL_FAN), DeadCoralWallFanBlock::new,
    ...
    public static final Block MUSHROOM_BOOKSHELF = registerBlock("mushroom_bookshelf",
            AbstractBlock.Settings.copy(Blocks.BOOKSHELF).mapColor(MapColor.RAW_IRON_PINK), Block::new);
    public static final Block IRON_CAP_BOOKSHELF = registerBlock("iron_cap_bookshelf",
            AbstractBlock.Settings.copy(Blocks.BOOKSHELF).mapColor(MapColor.LIGHT_BLUE_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM), Block::new);
    ...
    public static final Block OAK_BOOKSHELF_SLAB = registerBlock("oak_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.OAK_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block SPRUCE_BOOKSHELF_SLAB = registerBlock("spruce_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.SPRUCE_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block BIRCH_BOOKSHELF_SLAB = registerBlock("birch_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.BIRCH_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block JUNGLE_BOOKSHELF_SLAB = registerBlock("jungle_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.JUNGLE_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block DARK_OAK_BOOKSHELF_SLAB = registerBlock("dark_oak_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.DARK_OAK_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block ACACIA_BOOKSHELF_SLAB = registerBlock("acacia_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.ACACIA_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block MANGROVE_BOOKSHELF_SLAB = registerBlock("mangrove_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.MANGROVE_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block CHERRY_BOOKSHELF_SLAB = registerBlock("cherry_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CHERRY_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block PALE_OAK_BOOKSHELF_SLAB = registerBlock("pale_oak_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.PALE_OAK_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block BAMBOO_BOOKSHELF_SLAB = registerBlock("bamboo_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.BAMBOO_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block CRIMSON_BOOKSHELF_SLAB = registerBlock("crimson_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CRIMSON_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block WARPED_BOOKSHELF_SLAB = registerBlock("warped_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.WARPED_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block CACTUS_BOOKSHELF_SLAB = registerBlock("cactus_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.CACTUS_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block MUSHROOM_BOOKSHELF_SLAB = registerBlock("mushroom_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block IRON_CAP_BOOKSHELF_SLAB = registerBlock("iron_cap_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block DRIFTWOOD_BOOKSHELF_SLAB = registerBlock("driftwood_bookshelf_slab",
            AbstractBlock.Settings.copy(DecoBlocks.DRIFTWOOD_BOOKSHELF), SlabBlock::new);
    ...
    public static final Block WOODEN_BOOKSHELF_SLAB = registerBlock("wooden_bookshelf_slab",
            AbstractBlock.Settings.copy(Blocks.BOOKSHELF), SlabBlock::new);
    ...
    public static final Block GOLD_LANTERN = registerBlock("gold_lantern",
            AbstractBlock.Settings.copy(Blocks.LANTERN),LanternBlock::new);
    ...
    public static final Block GOLD_SOUL_LANTERN = registerBlock("gold_soul_lantern",
            AbstractBlock.Settings.copy(Blocks.SOUL_LANTERN),LanternBlock::new);

    public static final Block HANGING_LAMP = registerBlock("hanging_lamp",
            AbstractBlock.Settings.copy(Blocks.LANTERN),HangingLampBlock::new);

    public static final Block HANGING_WHITE_LAMP = registerBlock("hanging_white_lamp",
            AbstractBlock.Settings.copy(DecoBlocks.HANGING_LAMP),HangingLampBlock::new);
    ...
    public static final Block STONE_LEVER = registerBlock("stone_lever",
            AbstractBlock.Settings.copy(Blocks.LEVER),LeverBlock::new);
    public static final Block DEEPSLATE_LEVER = registerBlock("deepslate_lever",
            AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.DEEPSLATE),LeverBlock::new);
    ...
    public static final Block POLISHED_DEEPSLATE_LEVER = registerBlock("polished_deepslate_lever",
            AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.POLISHED_DEEPSLATE),LeverBlock::new);
    ...
    public static final Block TUFF_LEVER = registerBlock("tuff_lever",
            AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.TUFF),LeverBlock::new);
    public static final Block POLISHED_TUFF_LEVER = registerBlock("polished_tuff_lever",
            AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.POLISHED_TUFF),LeverBlock::new);
    ...
    public static final Block OAK_NOTE_BLOCK = registerBlock("oak_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.OAK_TAN),NoteBlock::new);
    public static final Block SPRUCE_NOTE_BLOCK = registerBlock("spruce_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.SPRUCE_BROWN),NoteBlock::new);
    public static final Block BIRCH_NOTE_BLOCK = registerBlock("birch_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.PALE_YELLOW),NoteBlock::new);
    public static final Block JUNGLE_NOTE_BLOCK = registerBlock("jungle_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.DIRT_BROWN),NoteBlock::new);
    public static final Block ACACIA_NOTE_BLOCK = registerBlock("acacia_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.ORANGE),NoteBlock::new);
    public static final Block DARK_OAK_NOTE_BLOCK = registerBlock("dark_oak_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.BROWN),NoteBlock::new);
    public static final Block MANGROVE_NOTE_BLOCK = registerBlock("mangrove_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.RED),NoteBlock::new);
    public static final Block CHERRY_NOTE_BLOCK = registerBlock("cherry_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.TERRACOTTA_WHITE)
                    .sounds(BlockSoundGroup.CHERRY_WOOD),NoteBlock::new);
    public static final Block PALE_OAK_NOTE_BLOCK = registerBlock("pale_oak_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.WHITE),NoteBlock::new);
    public static final Block BAMBOO_NOTE_BLOCK = registerBlock("bamboo_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.YELLOW)
                    .sounds(BlockSoundGroup.BAMBOO_WOOD),NoteBlock::new);
    public static final Block CRIMSON_NOTE_BLOCK = registerBlock("crimson_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.DULL_PINK)
                    .sounds(BlockSoundGroup.NETHER_WOOD),NoteBlock::new);
    public static final Block WARPED_NOTE_BLOCK = registerBlock("warped_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.DARK_AQUA)
                    .sounds(BlockSoundGroup.NETHER_WOOD),NoteBlock::new);
    public static final Block CACTUS_NOTE_BLOCK = registerBlock("cactus_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.PALE_GREEN),NoteBlock::new);
    public static final Block MUSHROOM_NOTE_BLOCK = registerBlock("mushroom_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.RAW_IRON_PINK),NoteBlock::new);
    public static final Block IRON_CAP_NOTE_BLOCK = registerBlock("iron_cap_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.LIGHT_BLUE_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM),NoteBlock::new);
    public static final Block DRIFTWOOD_NOTE_BLOCK = registerBlock("driftwood_note_block",
            AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.DARK_GREEN)
                    .sounds(BlockSoundGroup.CHERRY_WOOD),NoteBlock::new);
    ...
    public static final Block COPPER_BAR_DOOR = registerOxidDoorBlock("copper_bar_door",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED, Blocks.COPPER_DOOR);
    public static final Block EXPOSED_COPPER_BAR_DOOR = registerOxidDoorBlock("exposed_copper_bar_door",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.EXPOSED, Blocks.EXPOSED_COPPER_DOOR);
    public static final Block WEATHERED_COPPER_BAR_DOOR = registerOxidDoorBlock("weathered_copper_bar_door",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED, Blocks.WEATHERED_COPPER_DOOR);
    public static final Block OXIDIZED_COPPER_BAR_DOOR = registerOxidDoorBlock("oxidized_copper_bar_door",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.OXIDIZED, Blocks.OXIDIZED_COPPER_DOOR);
    ...
    public static final Block COPPER_BAR_TRAPDOOR = registerOxidTrapDoorBlock("copper_bar_trapdoor",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED, Blocks.COPPER_TRAPDOOR);
    public static final Block EXPOSED_COPPER_BAR_TRAPDOOR = registerOxidTrapDoorBlock("exposed_copper_bar_trapdoor",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.EXPOSED, Blocks.EXPOSED_COPPER_TRAPDOOR);
    public static final Block WEATHERED_COPPER_BAR_TRAPDOOR = registerOxidTrapDoorBlock("weathered_copper_bar_trapdoor",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED,Blocks.WEATHERED_COPPER_TRAPDOOR);
    public static final Block OXIDIZED_COPPER_BAR_TRAPDOOR = registerOxidTrapDoorBlock("oxidized_copper_bar_trapdoor",
            BlockSetType.COPPER, Oxidizable.OxidationLevel.OXIDIZED,Blocks.OXIDIZED_COPPER_TRAPDOOR);
    ...
    public static final Identifier CACTUS_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_sign");
    public static final Identifier CACTUS_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_wall_sign");
    public static final Identifier WOODEN_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_sign");
    public static final Identifier WOODEN_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_wall_sign");
    public static final Identifier MUSHROOM_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_sign");
    public static final Identifier MUSHROOM_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_wall_sign");
    public static final Identifier IRON_CAP_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_sign");
    public static final Identifier IRON_CAP_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_wall_sign");
    public static final Identifier DRIFTWOOD_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_sign");
    public static final Identifier DRIFTWOOD_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_wall_sign");

    public static final Identifier WOODEN_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_hanging_sign");
    public static final Identifier WOODEN_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_wall_hanging_sign");
    public static final Identifier CACTUS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_hanging_sign");
    public static final Identifier CACTUS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_wall_hanging_sign");
    public static final Identifier MUSHROOM_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_hanging_sign");
    public static final Identifier MUSHROOM_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_wall_hanging_sign");
    public static final Identifier IRON_CAP_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_hanging_sign");
    public static final Identifier IRON_CAP_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_wall_hanging_sign");
    public static final Identifier DRIFTWOOD_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_hanging_sign");
    public static final Identifier DRIFTWOOD_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_wall_hanging_sign");

    public static final Identifier STRIPPED_OAK_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_oak_sign");
    public static final Identifier STRIPPED_OAK_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_oak_wall_sign");
    public static final Identifier STRIPPED_SPRUCE_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_spruce_sign");
    public static final Identifier STRIPPED_SPRUCE_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_spruce_wall_sign");
    public static final Identifier STRIPPED_BIRCH_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_birch_sign");
    public static final Identifier STRIPPED_BIRCH_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_birch_wall_sign");
    public static final Identifier STRIPPED_JUNGLE_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_jungle_sign");
    public static final Identifier STRIPPED_JUNGLE_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_jungle_wall_sign");
    public static final Identifier STRIPPED_ACACIA_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_acacia_sign");
    public static final Identifier STRIPPED_ACACIA_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_acacia_wall_sign");
    public static final Identifier STRIPPED_DARK_OAK_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_dark_oak_sign");
    public static final Identifier STRIPPED_DARK_OAK_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_dark_oak_wall_sign");
    public static final Identifier STRIPPED_MANGROVE_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_mangrove_sign");
    public static final Identifier STRIPPED_MANGROVE_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_mangrove_wall_sign");
    public static final Identifier STRIPPED_CHERRY_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_cherry_sign");
    public static final Identifier STRIPPED_CHERRY_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_cherry_wall_sign");
    public static final Identifier STRIPPED_PALE_OAK_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_pale_oak_sign");
    public static final Identifier STRIPPED_PALE_OAK_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_pale_oak_wall_sign");
    public static final Identifier STRIPPED_CRIMSON_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_crimson_sign");
    public static final Identifier STRIPPED_CRIMSON_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_crimson_wall_sign");
    public static final Identifier STRIPPED_WARPED_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_warped_sign");
    public static final Identifier STRIPPED_WARPED_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_warped_wall_sign");
    public static final Identifier STRIPPED_WOODEN_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_wooden_sign");
    public static final Identifier STRIPPED_WOODEN_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_wooden_wall_sign");
    public static final Identifier STRIPPED_CACTUS_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_cactus_sign");
    public static final Identifier STRIPPED_CACTUS_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_cactus_wall_sign");
    public static final Identifier MUSHROOM_STEM_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_stem_sign");
    public static final Identifier MUSHROOM_STEM_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_stem_wall_sign");
    public static final Identifier STRIPPED_IRON_CAP_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_iron_cap_sign");
    public static final Identifier STRIPPED_IRON_CAP_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_iron_cap_wall_sign");
    public static final Identifier STRIPPED_DRIFTWOOD_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_driftwood_sign");
    public static final Identifier STRIPPED_DRIFTWOOD_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"stripped_driftwood_wall_sign");

    public static final Identifier OAK_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"oak_mosaic_sign");
    public static final Identifier OAK_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"oak_mosaic_wall_sign");
    public static final Identifier SPRUCE_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"spruce_mosaic_sign");
    public static final Identifier SPRUCE_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"spruce_mosaic_wall_sign");
    public static final Identifier BIRCH_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"birch_mosaic_sign");
    public static final Identifier BIRCH_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"birch_mosaic_wall_sign");
    public static final Identifier JUNGLE_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"jungle_mosaic_sign");
    public static final Identifier JUNGLE_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"jungle_mosaic_wall_sign");
    public static final Identifier ACACIA_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"acacia_mosaic_sign");
    public static final Identifier ACACIA_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"acacia_mosaic_wall_sign");
    public static final Identifier DARK_OAK_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"dark_oak_mosaic_sign");
    public static final Identifier DARK_OAK_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"dark_oak_mosaic_wall_sign");
    public static final Identifier MANGROVE_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mangrove_mosaic_sign");
    public static final Identifier MANGROVE_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mangrove_mosaic_wall_sign");
    public static final Identifier CHERRY_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cherry_mosaic_sign");
    public static final Identifier CHERRY_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cherry_mosaic_wall_sign");
    public static final Identifier PALE_OAK_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"pale_oak_mosaic_sign");
    public static final Identifier PALE_OAK_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"pale_oak_mosaic_wall_sign");
    public static final Identifier BAMBOO_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"bamboo_mosaic_sign");
    public static final Identifier BAMBOO_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"bamboo_mosaic_wall_sign");
    public static final Identifier CRIMSON_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"crimson_mosaic_sign");
    public static final Identifier CRIMSON_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"crimson_mosaic_wall_sign");
    public static final Identifier WARPED_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"warped_mosaic_sign");
    public static final Identifier WARPED_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"warped_mosaic_wall_sign");
    public static final Identifier CACTUS_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_mosaic_sign");
    public static final Identifier CACTUS_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_mosaic_wall_sign");
    public static final Identifier WOODEN_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_mosaic_sign");
    public static final Identifier WOODEN_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_mosaic_wall_sign");
    public static final Identifier MUSHROOM_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_mosaic_sign");
    public static final Identifier MUSHROOM_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_mosaic_wall_sign");
    public static final Identifier IRON_CAP_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_mosaic_sign");
    public static final Identifier IRON_CAP_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_mosaic_wall_sign");
    public static final Identifier DRIFTWOOD_MOSAIC_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_mosaic_sign");
    public static final Identifier DRIFTWOOD_MOSAIC_WALL_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_mosaic_wall_sign");

    public static final Identifier OAK_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"oak_mosaic_hanging_sign");
    public static final Identifier OAK_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"oak_mosaic_wall_hanging_sign");
    public static final Identifier SPRUCE_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"spruce_mosaic_hanging_sign");
    public static final Identifier SPRUCE_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"spruce_mosaic_wall_hanging_sign");
    public static final Identifier BIRCH_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"birch_mosaic_hanging_sign");
    public static final Identifier BIRCH_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"birch_mosaic_wall_hanging_sign");
    public static final Identifier JUNGLE_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"jungle_mosaic_hanging_sign");
    public static final Identifier JUNGLE_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"jungle_mosaic_wall_hanging_sign");
    public static final Identifier ACACIA_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"acacia_mosaic_hanging_sign");
    public static final Identifier ACACIA_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"acacia_mosaic_wall_hanging_sign");
    public static final Identifier DARK_OAK_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"dark_oak_mosaic_hanging_sign");
    public static final Identifier DARK_OAK_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"dark_oak_mosaic_wall_hanging_sign");
    public static final Identifier MANGROVE_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mangrove_mosaic_hanging_sign");
    public static final Identifier MANGROVE_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mangrove_mosaic_wall_hanging_sign");
    public static final Identifier CHERRY_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cherry_mosaic_hanging_sign");
    public static final Identifier CHERRY_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cherry_mosaic_wall_hanging_sign");
    public static final Identifier PALE_OAK_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"pale_oak_mosaic_hanging_sign");
    public static final Identifier PALE_OAK_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"pale_oak_mosaic_wall_hanging_sign");
    public static final Identifier BAMBOO_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"bamboo_mosaic_hanging_sign");
    public static final Identifier BAMBOO_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"bamboo_mosaic_wall_hanging_sign");
    public static final Identifier CRIMSON_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"crimson_mosaic_hanging_sign");
    public static final Identifier CRIMSON_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"crimson_mosaic_wall_hanging_sign");
    public static final Identifier WARPED_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"warped_mosaic_hanging_sign");
    public static final Identifier WARPED_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"warped_mosaic_wall_hanging_sign");
    public static final Identifier CACTUS_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_mosaic_hanging_sign");
    public static final Identifier CACTUS_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_mosaic_wall_hanging_sign");
    public static final Identifier WOODEN_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_mosaic_hanging_sign");
    public static final Identifier WOODEN_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_mosaic_wall_hanging_sign");
    public static final Identifier MUSHROOM_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_mosaic_hanging_sign");
    public static final Identifier MUSHROOM_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_mosaic_wall_hanging_sign");
    public static final Identifier IRON_CAP_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_mosaic_hanging_sign");
    public static final Identifier IRON_CAP_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_mosaic_wall_hanging_sign");
    public static final Identifier DRIFTWOOD_MOSAIC_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_mosaic_hanging_sign");
    public static final Identifier DRIFTWOOD_MOSAIC_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_mosaic_wall_hanging_sign");

    public static final Identifier OAK_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"oak_planks_hanging_sign");
    public static final Identifier OAK_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"oak_planks_wall_hanging_sign");
    public static final Identifier SPRUCE_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"spruce_planks_hanging_sign");
    public static final Identifier SPRUCE_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"spruce_planks_wall_hanging_sign");
    public static final Identifier BIRCH_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"birch_planks_hanging_sign");
    public static final Identifier BIRCH_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"birch_planks_wall_hanging_sign");
    public static final Identifier JUNGLE_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"jungle_planks_hanging_sign");
    public static final Identifier JUNGLE_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"jungle_planks_wall_hanging_sign");
    public static final Identifier ACACIA_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"acacia_planks_hanging_sign");
    public static final Identifier ACACIA_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"acacia_planks_wall_hanging_sign");
    public static final Identifier DARK_OAK_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"dark_oak_planks_hanging_sign");
    public static final Identifier DARK_OAK_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"dark_oak_planks_wall_hanging_sign");
    public static final Identifier MANGROVE_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mangrove_planks_hanging_sign");
    public static final Identifier MANGROVE_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mangrove_planks_wall_hanging_sign");
    public static final Identifier CHERRY_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cherry_planks_hanging_sign");
    public static final Identifier CHERRY_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cherry_planks_wall_hanging_sign");
    public static final Identifier PALE_OAK_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"pale_oak_planks_hanging_sign");
    public static final Identifier PALE_OAK_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"pale_oak_planks_wall_hanging_sign");
    public static final Identifier CRIMSON_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"crimson_planks_hanging_sign");
    public static final Identifier CRIMSON_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"crimson_planks_wall_hanging_sign");
    public static final Identifier WARPED_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"warped_planks_hanging_sign");
    public static final Identifier WARPED_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"warped_planks_wall_hanging_sign");
    public static final Identifier CACTUS_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_planks_hanging_sign");
    public static final Identifier CACTUS_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"cactus_planks_wall_hanging_sign");
    public static final Identifier WOODEN_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_planks_hanging_sign");
    public static final Identifier WOODEN_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"wooden_planks_wall_hanging_sign");
    public static final Identifier MUSHROOM_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_planks_hanging_sign");
    public static final Identifier MUSHROOM_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"mushroom_planks_wall_hanging_sign");
    public static final Identifier IRON_CAP_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_planks_hanging_sign");
    public static final Identifier IRON_CAP_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"iron_cap_planks_wall_hanging_sign");
    public static final Identifier DRIFTWOOD_PLANKS_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_planks_hanging_sign");
    public static final Identifier DRIFTWOOD_PLANKS_WALL_HANGING_SIGN_ID = Identifier.of(VaranDeco.MOD_ID,"driftwood_planks_wall_hanging_sign");

    public static final SignBlock STANDING_CACTUS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.CACTUS_TYPE, settings),
    ...
    public static final WallSignBlock WALL_CACTUS_SIGN  = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CACTUS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_CACTUS_SIGN.getLootTableKey()));

    public static final SignBlock STANDING_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.WOODEN_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final WallSignBlock WALL_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.WOODEN_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_WOODEN_SIGN.getLootTableKey()));

    public static final Block STANDING_MUSHROOM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_SIGN_ID, settings -> new SignBlock(DecoWoodTypes.MUSHROOM_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_MUSHROOM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_WALL_SIGN_ID, settings -> new WallSignBlock(DecoWoodTypes.MUSHROOM_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MUSHROOM_SIGN.getLootTableKey()));

    public static final Block STANDING_IRON_CAP_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_SIGN_ID, settings -> new SignBlock(DecoWoodTypes.IRON_CAP_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    ...
    public static final SignBlock STANDING_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.DRIFTWOOD_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final WallSignBlock WALL_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.DRIFTWOOD_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_DRIFTWOOD_SIGN.getLootTableKey()));

    public static final Block HANGING_CACTUS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CACTUS_TYPE, settings),
    ...
    public static final Block WALL_HANGING_CACTUS_SIGN = TerraformSignBlockHelper.registerSignBlock
            ...
            AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_CACTUS_SIGN.getLootTableKey()));

    public static final Block HANGING_MUSHROOM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.MUSHROOM_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_MUSHROOM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MUSHROOM_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MUSHROOM_SIGN.getLootTableKey()));

    public static final Block HANGING_IRON_CAP_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.IRON_CAP_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_IRON_CAP_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.IRON_CAP_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_IRON_CAP_SIGN.getLootTableKey()));

    public static final HangingSignBlock HANGING_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.WOODEN_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final WallHangingSignBlock WALL_HANGING_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WOODEN_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_WOODEN_SIGN.getLootTableKey()));

    public static final HangingSignBlock HANGING_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.DRIFTWOOD_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final WallHangingSignBlock WALL_HANGING_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DRIFTWOOD_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DRIFTWOOD_SIGN.getLootTableKey()));

    public static final Block STANDING_STRIPPED_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_OAK_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_OAK_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_OAK_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_OAK_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_OAK_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_SPRUCE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_SPRUCE_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_SPRUCE_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_SPRUCE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_SPRUCE_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_SPRUCE_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_SPRUCE_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_BIRCH_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_BIRCH_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_BIRCH_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_BIRCH_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_BIRCH_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_BIRCH_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_BIRCH_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_JUNGLE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_JUNGLE_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_JUNGLE_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_JUNGLE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_JUNGLE_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_JUNGLE_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_JUNGLE_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_ACACIA_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_ACACIA_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_ACACIA_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_ACACIA_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_ACACIA_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_ACACIA_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_ACACIA_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_DARK_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_DARK_OAK_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_DARK_OAK_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_DARK_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_DARK_OAK_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_DARK_OAK_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_DARK_OAK_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_MANGROVE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_MANGROVE_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_MANGROVE_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_MANGROVE_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_MANGROVE_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_MANGROVE_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_MANGROVE_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_CHERRY_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CHERRY_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_CHERRY_TYPE, settings),
    ...
    public static final Block WALL_STRIPPED_CHERRY_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CHERRY_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_CHERRY_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CHERRY_WALL_SIGN).lootTable(STANDING_STRIPPED_CHERRY_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_PALE_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_PALE_OAK_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_PALE_OAK_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_PALE_OAK_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_PALE_OAK_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_PALE_OAK_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_PALE_OAK_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_CRIMSON_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CRIMSON_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_CRIMSON_TYPE, settings),
    ...
    public static final Block WALL_STRIPPED_CRIMSON_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CRIMSON_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_CRIMSON_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CRIMSON_WALL_SIGN).lootTable(STANDING_STRIPPED_CRIMSON_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_WARPED_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_WARPED_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_WARPED_TYPE, settings),
    ...
    public static final Block WALL_STRIPPED_WARPED_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_WARPED_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_WARPED_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.WARPED_WALL_SIGN).lootTable(STANDING_STRIPPED_WARPED_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_WOODEN_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_WOODEN_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_WOODEN_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_WOODEN_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_WOODEN_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_WOODEN_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_DRIFTWOOD_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_DRIFTWOOD_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_DRIFTWOOD_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_DRIFTWOOD_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_DRIFTWOOD_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_DRIFTWOOD_SIGN.getLootTableKey()));

    public static final Block STANDING_STRIPPED_CACTUS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CACTUS_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_CACTUS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_CACTUS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_CACTUS_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_CACTUS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_CACTUS_SIGN.getLootTableKey()));
    public static final Block STANDING_MUSHROOM_STEM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_STEM_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.MUSHROOM_STEM_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_MUSHROOM_STEM_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_STEM_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.MUSHROOM_STEM_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MUSHROOM_STEM_SIGN.getLootTableKey()));
    public static final Block STANDING_STRIPPED_IRON_CAP_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_IRON_CAP_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.STRIPPED_IRON_CAP_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_STRIPPED_IRON_CAP_SIGN = TerraformSignBlockHelper.registerSignBlock
            (STRIPPED_IRON_CAP_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.STRIPPED_IRON_CAP_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_STRIPPED_IRON_CAP_SIGN.getLootTableKey()));

    public static final Block STANDING_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_SPRUCE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.SPRUCE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_SPRUCE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.SPRUCE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_SPRUCE_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_BIRCH_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.BIRCH_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_BIRCH_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.BIRCH_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_BIRCH_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_JUNGLE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.JUNGLE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_JUNGLE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.JUNGLE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_JUNGLE_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_ACACIA_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.ACACIA_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_ACACIA_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.ACACIA_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_ACACIA_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_DARK_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.DARK_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_DARK_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.DARK_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_DARK_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_MANGROVE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.MANGROVE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_MANGROVE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.MANGROVE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MANGROVE_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_CHERRY_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.CHERRY_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CHERRY_SIGN));
    public static final Block WALL_CHERRY_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CHERRY_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CHERRY_WALL_SIGN).lootTable(STANDING_CHERRY_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_PALE_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.PALE_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_PALE_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.PALE_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_PALE_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
    ...
    public static final Block WALL_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.BAMBOO_WALL_SIGN).lootTable(STANDING_BAMBOO_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_CRIMSON_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.CRIMSON_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CRIMSON_SIGN));
    public static final Block WALL_CRIMSON_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CRIMSON_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CRIMSON_WALL_SIGN).lootTable(STANDING_CRIMSON_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_WARPED_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.WARPED_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.WARPED_SIGN));
    public static final Block WALL_WARPED_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.WARPED_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.WARPED_WALL_SIGN).lootTable(STANDING_WARPED_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_CACTUS_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.CACTUS_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_CACTUS_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.CACTUS_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_CACTUS_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_WOODEN_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.WOODEN_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_WOODEN_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.WOODEN_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_WOODEN_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_DRIFTWOOD_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.DRIFTWOOD_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_DRIFTWOOD_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.DRIFTWOOD_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_DRIFTWOOD_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_MUSHROOM_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.MUSHROOM_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_MUSHROOM_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.MUSHROOM_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_MUSHROOM_MOSAIC_SIGN.getLootTableKey()));
    public static final Block STANDING_IRON_CAP_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_MOSAIC_SIGN_ID,settings -> new SignBlock(DecoWoodTypes.IRON_CAP_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_SIGN));
    public static final Block WALL_IRON_CAP_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_MOSAIC_WALL_SIGN_ID,settings -> new WallSignBlock(DecoWoodTypes.IRON_CAP_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN).lootTable(STANDING_IRON_CAP_MOSAIC_SIGN.getLootTableKey()));

    public static final Block HANGING_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_SPRUCE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.SPRUCE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_SPRUCE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.SPRUCE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_SPRUCE_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_BIRCH_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.BIRCH_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_BIRCH_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.BIRCH_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_BIRCH_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_JUNGLE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.JUNGLE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_JUNGLE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.JUNGLE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_JUNGLE_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_ACACIA_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.ACACIA_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_ACACIA_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.ACACIA_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_ACACIA_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_DARK_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.DARK_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_DARK_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DARK_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DARK_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_MANGROVE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.MANGROVE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_MANGROVE_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MANGROVE_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MANGROVE_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_CHERRY_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CHERRY_MOSAIC_TYPE, settings),
    ...
    public static final Block WALL_HANGING_CHERRY_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CHERRY_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CHERRY_WALL_HANGING_SIGN).lootTable(HANGING_CHERRY_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_PALE_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.PALE_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_PALE_OAK_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.PALE_OAK_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_PALE_OAK_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
    ...
    public static final Block WALL_HANGING_BAMBOO_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BAMBOO_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.BAMBOO_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.BAMBOO_WALL_HANGING_SIGN).lootTable(HANGING_BAMBOO_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_CRIMSON_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CRIMSON_MOSAIC_TYPE, settings),
    ...
    public static final Block WALL_HANGING_CRIMSON_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CRIMSON_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CRIMSON_WALL_HANGING_SIGN).lootTable(HANGING_CRIMSON_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_WARPED_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.WARPED_MOSAIC_TYPE, settings),
    ...
    public static final Block WALL_HANGING_WARPED_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WARPED_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.WARPED_WALL_HANGING_SIGN).lootTable(HANGING_WARPED_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_CACTUS_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CACTUS_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_CACTUS_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CACTUS_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_CACTUS_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_WOODEN_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.WOODEN_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_WOODEN_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WOODEN_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_WOODEN_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_DRIFTWOOD_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.DRIFTWOOD_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_DRIFTWOOD_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DRIFTWOOD_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DRIFTWOOD_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_MUSHROOM_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.MUSHROOM_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_MUSHROOM_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MUSHROOM_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MUSHROOM_MOSAIC_SIGN.getLootTableKey()));
    public static final Block HANGING_IRON_CAP_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_MOSAIC_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.IRON_CAP_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_IRON_CAP_MOSAIC_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_MOSAIC_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.IRON_CAP_MOSAIC_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_IRON_CAP_MOSAIC_SIGN.getLootTableKey()));

    public static final Block HANGING_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.OAK_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (OAK_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.OAK_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_OAK_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_SPRUCE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.SPRUCE_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_SPRUCE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (SPRUCE_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.SPRUCE_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_SPRUCE_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_BIRCH_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.BIRCH_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_BIRCH_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (BIRCH_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.BIRCH_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_BIRCH_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_JUNGLE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.JUNGLE_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_JUNGLE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (JUNGLE_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.JUNGLE_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_JUNGLE_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_ACACIA_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.ACACIA_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_ACACIA_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (ACACIA_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.ACACIA_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_ACACIA_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_DARK_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.DARK_OAK_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_DARK_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DARK_OAK_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DARK_OAK_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DARK_OAK_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_MANGROVE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.MANGROVE_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_MANGROVE_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MANGROVE_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MANGROVE_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MANGROVE_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_CHERRY_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CHERRY_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CHERRY_HANGING_SIGN));
    public static final Block WALL_HANGING_CHERRY_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CHERRY_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CHERRY_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CHERRY_WALL_HANGING_SIGN).lootTable(HANGING_CHERRY_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_PALE_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.PALE_OAK_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_PALE_OAK_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (PALE_OAK_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.PALE_OAK_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_PALE_OAK_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_CRIMSON_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CRIMSON_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CRIMSON_HANGING_SIGN));
    public static final Block WALL_HANGING_CRIMSON_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CRIMSON_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CRIMSON_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.CRIMSON_WALL_HANGING_SIGN).lootTable(HANGING_CRIMSON_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_WARPED_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.WARPED_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.WARPED_HANGING_SIGN));
    public static final Block WALL_HANGING_WARPED_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WARPED_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WARPED_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.WARPED_WALL_HANGING_SIGN).lootTable(HANGING_WARPED_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_CACTUS_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.CACTUS_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_CACTUS_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (CACTUS_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.CACTUS_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_CACTUS_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_WOODEN_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.WOODEN_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_WOODEN_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (WOODEN_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.WOODEN_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_WOODEN_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_DRIFTWOOD_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.DRIFTWOOD_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_DRIFTWOOD_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (DRIFTWOOD_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.DRIFTWOOD_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_DRIFTWOOD_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_IRON_CAP_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.IRON_CAP_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_IRON_CAP_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (IRON_CAP_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.IRON_CAP_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_IRON_CAP_PLANKS_SIGN.getLootTableKey()));
    public static final Block HANGING_MUSHROOM_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_PLANKS_HANGING_SIGN_ID,settings -> new HangingSignBlock(DecoWoodTypes.MUSHROOM_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN));
    public static final Block WALL_HANGING_MUSHROOM_PLANKS_SIGN = TerraformSignBlockHelper.registerSignBlock
            (MUSHROOM_PLANKS_WALL_HANGING_SIGN_ID,settings -> new WallHangingSignBlock(DecoWoodTypes.MUSHROOM_PLANKS_TYPE, settings),
                    AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN).lootTable(HANGING_MUSHROOM_PLANKS_SIGN.getLootTableKey()));
    ...
    public static <T extends Block> T registerCouldBlock(String name,AbstractBlock.Settings settings, Function<AbstractBlock.Settings, T> factory){
        T block = factory.apply(settings.registryKey(getBlockKey(name)));
        registerCloudBlockItem(name, block);
        return Registry.register(Registries.BLOCK, getCloudBlockKey(name), block);
    }
    ...
    public static <T extends Block> T registerDeadCoralFan(String name, AbstractBlock.Settings settings, Function<AbstractBlock.Settings, T> factory, AbstractBlock.Settings copyLootTable){
        T block = factory.apply(settings.registryKey(getBlockKey(name)));
        return Registry.register(Registries.BLOCK, getBlockKey(name), block);
    }
    ...
    public static StairsBlock registerWoodStairs(String name, Block block, Block copyBlock, MapColor mapColor){
        return registerSimple(name, new StairsBlock(block.getDefaultState(),
                AbstractBlock.Settings.copy(copyBlock).mapColor(mapColor).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static HayStairsBlock registerHayStairs(String name, Block block, Block copyBlock){
        return registerSimple(name, new HayStairsBlock(block.getDefaultState(),
                AbstractBlock.Settings.copy(copyBlock).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static OxidizableStairsBlock registerOxidStairs(String name, Oxidizable.OxidationLevel oxidationLevel, Block block, Block copyBlock){
        return registerSimple(name, new OxidizableStairsBlock(oxidationLevel, block.getDefaultState(),
                AbstractBlock.Settings.copy(copyBlock).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static FallingStairBlock registerFallingStairs(String name, int colour, Block block, Block copyBlock){
        return registerSimple(name, new FallingStairBlock(colour, block.getDefaultState(),
                AbstractBlock.Settings.copy(copyBlock).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static OxidizableSlabBlock registerOxidSlab(String name, Oxidizable.OxidationLevel oxidationLevel, Block copyBlock){
        return registerSimple(name, new OxidizableSlabBlock(oxidationLevel,
                AbstractBlock.Settings.copy(copyBlock).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static OxidizableLadderBlock registerOxidLadder(String name, Oxidizable.OxidationLevel oxidationLevel, Block copyBlock){
        return registerSimple(name, new OxidizableLadderBlock(oxidationLevel,
                AbstractBlock.Settings.copy(copyBlock).sounds(BlockSoundGroup.COPPER).strength(5.0F, 6.0F)
                        .requiresTool().registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static PackedNyliumBlock registerPackedNylium(String name, RegistryKey<ConfiguredFeature<?, ?>> feature, Block copyBlock){
    ...
    public static SilverRoseBlock registerSilverRose(String name, RegistryEntry<StatusEffect> stewEffect, float effectLengthInSeconds, Block copyBlock){
    ...
    public static EnderFlowerBlock registerEndFlower(String name, RegistryEntry<StatusEffect> stewEffect, float effectLengthInSeconds, Block copyBlock){
        return registerSimple(name, new EnderFlowerBlock( createStewEffectList(stewEffect, effectLengthInSeconds),
                AbstractBlock.Settings.copy(copyBlock).registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static DesertFlowerBlock registerDesertFlower(String name, RegistryEntry<StatusEffect> stewEffect, float effectLengthInSeconds, Block copyBlock){
    ...
    public static IronCapBlock registerIronCap(String name, SaplingGenerator generator, Block copyBlock) {
        return registerSimple(name, new IronCapBlock(generator,
                AbstractBlock.Settings.copy(copyBlock).mapColor(MapColor.IRON_GRAY).registryKey(DecoBlocks.getBlockKey(name))));
    }
    ...
    public static ColoredFallingBlock registerFallingBlock(String name, ColorCode color,  Block copyBlock,MapColor mapColour) {
        return registerSimple(name, new ColoredFallingBlock(color,
                AbstractBlock.Settings.copy(copyBlock).mapColor(mapColour).registryKey(DecoBlocks.getBlockKey(name))));
    }
    ...
    public static OxidizableDoorBlock registerOxidDoorBlock(String name, BlockSetType blockSetType,
                                                            Oxidizable.OxidationLevel oxidationLevel,
                                                            Block copyBlock) {
        return registerSimple(name, new OxidizableDoorBlock(blockSetType, oxidationLevel,
                AbstractBlock.Settings.copy(copyBlock).nonOpaque().registryKey(DecoBlocks.getBlockKey(name))));
    }
    public static OxidizableTrapdoorBlock registerOxidTrapDoorBlock(String name,BlockSetType blockSetType,
                                                                    Oxidizable.OxidationLevel oxidationLevel,
                                                                     Block copyBlock) {
        return registerSimple(name, new OxidizableTrapdoorBlock(blockSetType, oxidationLevel,
                AbstractBlock.Settings.copy(copyBlock).nonOpaque().registryKey(DecoBlocks.getBlockKey(name))));
    }
    ...
    private static void registerCloudBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(name),
                new BlockItem(block, new Item.Settings().useBlockPrefixedTranslationKey()
                        .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(VaranDeco.MOD_ID, name)))));
    }
    ...
    public static RegistryKey<Block> getCloudBlockKey(String name){
        return RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(VaranDeco.MOD_ID,name));
    }
