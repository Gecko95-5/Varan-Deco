...
public class DecoBlocks {
    ...
    public static final Block CHISELED_DRIPSTONE = registerBlock("chiseled_dripstone",
            new Block(FabricBlockSettings.copyOf(Blocks.DRIPSTONE_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block PACKED_PODZOL = registerBlock("packed_podzol",
            new Block(FabricBlockSettings.copyOf(Blocks.PODZOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PACKED_CRIMSON_NYLIUM = registerBlock("packed_crimson_nylium",
            new PackedCrimsonNyliumBlock(FabricBlockSettings.copyOf(Blocks.CRIMSON_NYLIUM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PACKED_WARPED_NYLIUM = registerBlock("packed_warped_nylium",
            new PackedWarpedNyliumBlock(FabricBlockSettings.copyOf(Blocks.WARPED_NYLIUM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block COAL_BRICKS = registerBlock("coal_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.BRICKS).mapColor(MapColor.BLACK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CASTED_IRON_SLAB = registerBlock("casted_iron_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CASTED_IRON)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_GOLD = registerBlock("cut_gold",
            new Block(FabricBlockSettings.copyOf(Blocks.GOLD_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CUT_GOLD_SLAB = registerBlock("cut_gold_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_GOLD)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SANDSTONE_BRICKS = registerBlock("sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CHISELED_OBSIDIAN = registerBlock("chiseled_obsidian",
            new Block(FabricBlockSettings.copyOf(Blocks.OBSIDIAN).mapColor(MapColor.PURPLE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block OBSIDIAN_BRICKS = registerBlock("obsidian_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.SANDED_OBSIDIAN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block OBSIDIAN_PILLAR = registerBlock("obsidian_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.OBSIDIAN).mapColor(MapColor.PURPLE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CHISELED_NETHERRACK_BRICKS = registerBlock("chiseled_netherrack_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.NETHERRACK_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block MOSSY_DEEPSLATE_BRICKS = registerBlock("mossy_deepslate_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PACKED_MYCELIUM = registerBlock("packed_mycelium",
            new PackedMyceliumBlock(FabricBlockSettings.copyOf(Blocks.MYCELIUM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block NETHER_BRICK_PILLAR = registerBlock("nether_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block VOID_STONE_BRICKS = registerBlock("void_stone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE).strength(5.5F, 12.0F)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block VOID_STONE_BRICK_PILLAR = registerBlock("void_stone_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHISELED_VOID_STONE = registerBlock("chiseled_void_stone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE).luminance(state -> 1)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block RED_SANDSTONE_BRICKS = registerBlock("red_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_RED_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);public static final Block WHITE_SANDSTONE = registerBlock("white_sandstone",
    ...
    public static final Block CHISELED_WHITE_SANDSTONE = registerBlock("chiseled_white_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CUT_WHITE_SANDSTONE_BRICKS = registerBlock("cut_white_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE).strength(1.6f)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CHISELED_POLISHED_WHITE_SANDSTONE = registerBlock("chiseled_polished_white_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CHISELED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_WHITE_SANDSTONE = registerBlock("polished_white_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WHITE_SANDSTONE_BRICKS = registerBlock("white_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CHISELED_BLACK_SANDSTONE = registerBlock("chiseled_black_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CUT_BLACK_SANDSTONE_BRICKS = registerBlock("cut_black_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE).strength(1.6f)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CHISELED_POLISHED_BLACK_SANDSTONE = registerBlock("chiseled_polished_black_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CHISELED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_BLACK_SANDSTONE = registerBlock("polished_black_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BLACK_SANDSTONE_BRICKS = registerBlock("black_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block LIGHT_PRISMARINE = registerBlock("light_prismarine",
            new Block(FabricBlockSettings.copyOf(Blocks.PRISMARINE).mapColor(MapColor.OFF_WHITE)
                    .luminance(state -> 10).sounds(BlockSoundGroup.GLASS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CHISELED_ICE_BRICKS = registerBlock("chiseled_ice_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.ICE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SOUL_SOILSTONE_BRICKS = registerBlock("soul_soilstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_SOUL_SOILSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHISELED_MAGMA_BLOCK = registerBlock("chiseled_magma_block",
            new MagmaBlock(FabricBlockSettings.copyOf(Blocks.MAGMA_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CHISELED_BUBBLE_BLOCK = registerBlock("chiseled_bubble_block",
            new BubbleBlock(FabricBlockSettings.copyOf(DecoBlocks.BUBBLE_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block RED_NETHER_BRICK_PILLAR = registerBlock("red_nether_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block BLUE_NETHER_BRICK_PILLAR = registerBlock("blue_nether_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(DecoBlocks.BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block DUEL_CUT_ORANGE_CONCRETE = registerBlock("duel_cut_orange_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_MAGENTA_CONCRETE = registerBlock("duel_cut_magenta_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIGHT_BLUE_CONCRETE = registerBlock("duel_cut_light_blue_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_YELLOW_CONCRETE = registerBlock("duel_cut_yellow_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIME_CONCRETE = registerBlock("duel_cut_lime_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_PINK_CONCRETE = registerBlock("duel_cut_pink_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_GRAY_CONCRETE = registerBlock("duel_cut_gray_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIGHT_GRAY_CONCRETE = registerBlock("duel_cut_light_gray_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_CYAN_CONCRETE = registerBlock("duel_cut_cyan_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_PURPLE_CONCRETE = registerBlock("duel_cut_purple_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BLUE_CONCRETE = registerBlock("duel_cut_blue_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BROWN_CONCRETE = registerBlock("duel_cut_brown_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_GREEN_CONCRETE = registerBlock("duel_cut_green_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_RED_CONCRETE = registerBlock("duel_cut_red_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BLACK_CONCRETE = registerBlock("duel_cut_black_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block MOSSY_POLISHED_BLACKSTONE_BRICKS = registerBlock("mossy_polished_blackstone_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.POLISHED_BLACKSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SOLID_CLOUD = registerBlock("solid_cloud",
            new TransparentBlock(FabricBlockSettings.copyOf(Blocks.WHITE_WOOL).strength(0.8f,0.4f)
                    .allowsSpawning(DecoBlocks::never).nonOpaque()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block FRAGILE_ICE = registerBlock("fragile_ice",
            new FragileIceBlock(FabricBlockSettings.of(Material.ICE).slipperiness(0.98F)
                    ...
                    .allowsSpawning(DecoBlocks::never).resistance(0.1f)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block GRASS_SLAB = registerBlock("grass_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.PACKED_GRASS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DIRT_SLAB = registerBlock("dirt_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DIRT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block COARSE_DIRT_SLAB = registerBlock("coarse_dirt_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.COARSE_DIRT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PODZOL_SLAB = registerBlock("podzol_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.PACKED_PODZOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block ROOTED_DIRT_SLAB = registerBlock("rooted_dirt_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.ROOTED_DIRT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MUD_SLAB = registerBlock("mud_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.MUD)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRIMSON_NYLIUM_SLAB = registerBlock("crimson_nylium_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.PACKED_CRIMSON_NYLIUM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WARPED_NYLIUM_SLAB = registerBlock("warped_nylium_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.PACKED_WARPED_NYLIUM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SAND_SLAB = registerBlock("sand_slab",
            new FallingSlabBlock(14406560,FabricBlockSettings.copyOf(Blocks.SAND)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block RED_SAND_SLAB = registerBlock("red_sand_slab",
            new FallingSlabBlock(11098145,FabricBlockSettings.copyOf(Blocks.RED_SAND)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block GRAVEL_SLAB = registerBlock("gravel_slab",
            new FallingSlabBlock(-8356741,FabricBlockSettings.copyOf(Blocks.GRAVEL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block RAW_COPPER_SLAB = registerBlock("raw_copper_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.RAW_COPPER_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block WAXED_COPPER_SLAB = registerBlock("waxed_copper_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.WAXED_COPPER_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WAXED_EXPOSED_COPPER_SLAB = registerBlock("waxed_exposed_copper_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.WAXED_EXPOSED_COPPER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WAXED_WEATHERED_COPPER_SLAB = registerBlock("waxed_weathered_copper_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.WAXED_WEATHERED_COPPER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WAXED_OXIDIZED_COPPER_SLAB = registerBlock("waxed_oxidized_copper_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.WAXED_OXIDIZED_COPPER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block GOLD_SLAB = registerBlock("gold_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.GOLD_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRIMSON_HYPHAE_SLAB = registerBlock("crimson_hyphae_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRIMSON_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
                    .mapColor(MapColor.DARK_CRIMSON)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WARPED_HYPHAE_SLAB = registerBlock("warped_hyphae_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.WARPED_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)
                    .mapColor(MapColor.DARK_DULL_PINK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block ORANGE_WOOL_SLAB = registerBlock("orange_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.ORANGE_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MAGENTA_WOOL_SLAB = registerBlock("magenta_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.MAGENTA_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block LIGHT_BLUE_WOOL_SLAB = registerBlock("light_blue_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.LIGHT_BLUE_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block YELLOW_WOOL_SLAB = registerBlock("yellow_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.YELLOW_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block LIME_WOOL_SLAB = registerBlock("lime_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.LIME_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PINK_WOOL_SLAB = registerBlock("pink_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.PINK_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block GRAY_WOOL_SLAB = registerBlock("gray_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.GRAY_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block LIGHT_GRAY_WOOL_SLAB = registerBlock("light_gray_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.LIGHT_GRAY_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CYAN_WOOL_SLAB = registerBlock("cyan_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CYAN_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PURPLE_WOOL_SLAB = registerBlock("purple_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.PURPLE_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BLUE_WOOL_SLAB = registerBlock("blue_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.BLUE_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BROWN_WOOL_SLAB = registerBlock("brown_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.BROWN_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block GREEN_WOOL_SLAB = registerBlock("green_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.GREEN_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block RED_WOOL_SLAB = registerBlock("red_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.RED_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BLACK_WOOL_SLAB  = registerBlock("black_wool_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.BLACK_WOOL)), DecoItemGroup.VARAN_DECO_BLOCKS);

    public static final Block OBSIDIAN_SLAB = registerBlock("obsidian_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.OBSIDIAN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CLAY_SLAB = registerBlock("clay_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CLAY)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SMOOTH_BASALT_SLAB = registerBlock("smooth_basalt_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.SMOOTH_BASALT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_STONE_BRICK_SLAB = registerBlock("cracked_stone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_DEEPSLATE_BRICK_SLAB = registerBlock("cracked_deepslate_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_DEEPSLATE_TILE_SLAB = registerBlock("cracked_deepslate_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MYCELIUM_SLAB = registerBlock("packed_mycelium_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.PACKED_MYCELIUM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_NETHER_BRICK_SLAB = registerBlock("cracked_nether_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block END_STONE_SLAB = registerBlock("end_stone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.END_STONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block DEAD_TUBE_CORAL_SLAB = registerBlock("dead_tube_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_BRAIN_CORAL_SLAB = registerBlock("dead_brain_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_BUBBLE_CORAL_SLAB = registerBlock("dead_bubble_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_FIRE_CORAL_SLAB = registerBlock("dead_fire_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_HORN_CORAL_SLAB = registerBlock("dead_horn_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block TUBE_CORAL_SLAB = registerBlock("tube_coral_slab",
            new CoralSlabBlock(DEAD_TUBE_CORAL_SLAB, FabricBlockSettings.copyOf(Blocks.TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BRAIN_CORAL_SLAB = registerBlock("brain_coral_slab",
            new CoralSlabBlock(DEAD_BRAIN_CORAL_SLAB, FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BUBBLE_CORAL_SLAB = registerBlock("bubble_coral_slab",
            new CoralSlabBlock(DEAD_BUBBLE_CORAL_SLAB,FabricBlockSettings.copyOf(Blocks.BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block FIRE_CORAL_SLAB = registerBlock("fire_coral_slab",
            new CoralSlabBlock(DEAD_FIRE_CORAL_SLAB,FabricBlockSettings.copyOf(Blocks.FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block HORN_CORAL_SLAB = registerBlock("horn_coral_slab",
            new CoralSlabBlock(DEAD_HORN_CORAL_SLAB,FabricBlockSettings.copyOf(Blocks.HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block GRANITE_BRICK_SLAB = registerBlock("granite_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.GRANITE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_DIORITE_SLAB = registerBlock("cut_diorite_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_DIORITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DIORITE_BRICK_SLAB = registerBlock("diorite_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DIORITE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_ANDESITE_SLAB = registerBlock("cut_andesite_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_ANDESITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block ANDESITE_BRICK_SLAB = registerBlock("andesite_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.ANDESITE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_CALCITE_SLAB = registerBlock("polished_calcite_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_CALCITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_CALCITE_SLAB = registerBlock("cut_calcite_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_CALCITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CALCITE_BRICK_SLAB = registerBlock("calcite_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CALCITE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DRIPSTONE_BRICK_SLAB = registerBlock("dripstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DRIPSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DRIPSTONE_BRICK_PILLAR_SLAB = registerBlock("dripstone_brick_pillar_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DRIPSTONE_BRICK_PILLAR)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block WHITE_SAND_SLAB = registerBlock("white_sand_slab",
            new FallingSlabBlock(0xc0c0c0,FabricBlockSettings.copyOf(DecoBlocks.WHITE_SAND)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BLACK_SAND_SLAB = registerBlock("black_sand_slab",
            new FallingSlabBlock(0x404040,FabricBlockSettings.copyOf(DecoBlocks.BLACK_SAND)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SMOOTH_PURPUR_SLAB = registerBlock("smooth_purpur_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_PURPUR)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block OBSIDIAN_BRICK_SLAB = registerBlock("obsidian_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.OBSIDIAN_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_OBSIDIAN_SLAB = registerBlock("cut_obsidian_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_OBSIDIAN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PURPUR_BRICK_SLAB = registerBlock("purpur_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.PURPUR_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_PURPUR_SLAB = registerBlock("cut_purpur_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_PURPUR)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_STONE_TILE_SLAB = registerBlock("cracked_stone_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_STONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MOSSY_DEEPSLATE_BRICK_SLAB = registerBlock("mossy_deepslate_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_END_STONE_SLAB = registerBlock("polished_end_stone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_END_STONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MOSSY_END_STONE_BRICK_SLAB = registerBlock("mossy_end_stone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_END_STONE_BRICK_SLAB = registerBlock("cracked_end_stone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block END_STONE_TILE_SLAB = registerBlock("end_stone_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.END_STONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_END_STONE_TILE_SLAB = registerBlock("cracked_end_stone_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block VOID_STONE_BRICK_SLAB = registerBlock("void_stone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block VOID_STONE_BRICK_PILLAR_SLAB = registerBlock("void_stone_brick_pillar_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICK_PILLAR)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block DUEL_CUT_ORANGE_CONCRETE_SLAB = registerBlock("duel_cut_orange_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_MAGENTA_CONCRETE_SLAB = registerBlock("duel_cut_magenta_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIGHT_BLUE_CONCRETE_SLAB = registerBlock("duel_cut_light_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_YELLOW_CONCRETE_SLAB = registerBlock("duel_cut_yellow_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIME_CONCRETE_SLAB = registerBlock("duel_cut_lime_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_PINK_CONCRETE_SLAB = registerBlock("duel_cut_pink_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_GRAY_CONCRETE_SLAB = registerBlock("duel_cut_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIGHT_GRAY_CONCRETE_SLAB = registerBlock("duel_cut_light_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_CYAN_CONCRETE_SLAB = registerBlock("duel_cut_cyan_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_PURPLE_CONCRETE_SLAB = registerBlock("duel_cut_purple_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BLUE_CONCRETE_SLAB = registerBlock("duel_cut_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BROWN_CONCRETE_SLAB = registerBlock("duel_cut_brown_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_GREEN_CONCRETE_SLAB = registerBlock("duel_cut_green_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_RED_CONCRETE_SLAB = registerBlock("duel_cut_red_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BLACK_CONCRETE_SLAB = registerBlock("duel_cut_black_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_ORANGE_CONCRETE_SLAB = registerBlock("checkered_orange_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_MAGENTA_CONCRETE_SLAB = registerBlock("checkered_magenta_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_LIGHT_BLUE_CONCRETE_SLAB = registerBlock("checkered_light_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_YELLOW_CONCRETE_SLAB = registerBlock("checkered_yellow_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_LIME_CONCRETE_SLAB = registerBlock("checkered_lime_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_PINK_CONCRETE_SLAB = registerBlock("checkered_pink_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_GRAY_CONCRETE_SLAB = registerBlock("checkered_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_LIGHT_GRAY_CONCRETE_SLAB = registerBlock("checkered_light_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_CYAN_CONCRETE_SLAB = registerBlock("checkered_cyan_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_PURPLE_CONCRETE_SLAB = registerBlock("checkered_purple_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_BLUE_CONCRETE_SLAB = registerBlock("checkered_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_BROWN_CONCRETE_SLAB = registerBlock("checkered_brown_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_GREEN_CONCRETE_SLAB = registerBlock("checkered_green_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_RED_CONCRETE_SLAB = registerBlock("checkered_red_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_BLACK_CONCRETE_SLAB = registerBlock("checkered_black_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block WHITE_SANDSTONE_SLAB = registerBlock("white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_WHITE_SANDSTONE_SLAB = registerBlock("cut_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block SMOOTH_WHITE_SANDSTONE_SLAB = registerBlock("smooth_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_WHITE_SANDSTONE_BRICK_SLAB = registerBlock("cut_white_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block COBBLED_WHITE_SANDSTONE_SLAB = registerBlock("cobbled_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_WHITE_SANDSTONE_SLAB = registerBlock("polished_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WHITE_SANDSTONE_BRICK_SLAB = registerBlock("white_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BLACK_SANDSTONE_SLAB = registerBlock("black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_BLACK_SANDSTONE_SLAB = registerBlock("cut_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block SMOOTH_BLACK_SANDSTONE_SLAB = registerBlock("smooth_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_BLACK_SANDSTONE_BRICK_SLAB = registerBlock("cut_black_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block COBBLED_BLACK_SANDSTONE_SLAB = registerBlock("cobbled_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_BLACK_SANDSTONE_SLAB = registerBlock("polished_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BLACK_SANDSTONE_BRICK_SLAB = registerBlock("black_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_SLAB = registerBlock("cracked_red_nether_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_SLAB = registerBlock("cracked_polished_blackstone_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CLOUD_SLAB = registerBlock("cloud_slab",
            new TransparentSlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SOLID_CLOUD)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CLOUD_BRICK_SLAB = registerBlock("cloud_brick_slab",
            new TransparentSlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CLOUD_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block COPPER_STAIRS = registerBlock("copper_stairs",
            new OxidizableStairsBlock(Oxidizable.OxidationLevel.UNAFFECTED,Blocks.COPPER_BLOCK.getDefaultState(),
                    FabricBlockSettings.copyOf(Blocks.COPPER_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block EXPOSED_COPPER_STAIRS = registerBlock("exposed_copper_stairs",
            new OxidizableStairsBlock(Oxidizable.OxidationLevel.EXPOSED,Blocks.EXPOSED_COPPER.getDefaultState(),
                    FabricBlockSettings.copyOf(Blocks.EXPOSED_COPPER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WEATHERED_COPPER_STAIRS = registerBlock("weathered_copper_stairs",
            new OxidizableStairsBlock(Oxidizable.OxidationLevel.WEATHERED,Blocks.WEATHERED_COPPER.getDefaultState(),
                    FabricBlockSettings.copyOf(Blocks.WEATHERED_COPPER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block OXIDIZED_COPPER_STAIRS = registerBlock("oxidized_copper_stairs",
            new OxidizableStairsBlock(Oxidizable.OxidationLevel.OXIDIZED,Blocks.OXIDIZED_COPPER.getDefaultState(),
                    FabricBlockSettings.copyOf(Blocks.OXIDIZED_COPPER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block OAK_WOOD_STAIRS = registerBlock("oak_wood_stairs",
            new StairsBlock(Blocks.OAK_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(Blocks.OAK_PLANKS)
                    .mapColor(MapColor.DIRT_BROWN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block SPRUCE_WOOD_STAIRS = registerBlock("spruce_wood_stairs",
            new StairsBlock(Blocks.SPRUCE_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(Blocks.SPRUCE_PLANKS)
                    .mapColor(MapColor.BROWN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BIRCH_WOOD_STAIRS = registerBlock("birch_wood_stairs",
            new StairsBlock(Blocks.BIRCH_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(Blocks.BIRCH_PLANKS)
                    .mapColor(MapColor.OFF_WHITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRIMSON_HYPHAE_STAIRS = registerBlock("crimson_hyphae_stairs",
            new StairsBlock(Blocks.CRIMSON_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(Blocks.CRIMSON_PLANKS)
                    .mapColor(MapColor.DARK_CRIMSON).sounds(BlockSoundGroup.NETHER_STEM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WARPED_HYPHAE_STAIRS = registerBlock("warped_hyphae_stairs",
            new StairsBlock(Blocks.WARPED_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(Blocks.WARPED_PLANKS)
                    .mapColor(MapColor.DARK_DULL_PINK).sounds(BlockSoundGroup.NETHER_STEM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WOODEN_WOOD_STAIRS = registerBlock("wooden_wood_stairs",
            new StairsBlock(DecoBlocks.WOODEN_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(DecoBlocks.WOODEN_PLANKS)
                    .mapColor(MapColor.TERRACOTTA_BROWN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block STRIPPED_CRIMSON_HYPHAE_STAIRS = registerBlock("stripped_crimson_hyphae_stairs",
            new StairsBlock(Blocks.CRIMSON_PLANKS.getDefaultState(),FabricBlockSettings.copyOf(Blocks.CRIMSON_PLANKS)
                    .sounds(BlockSoundGroup.NETHER_STEM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block WHITE_SAND_STAIRS = registerBlock("white_sand_stairs",
            new FallingStairBlock(0xc0c0c0,DecoBlocks.WHITE_SAND.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.WHITE_SAND)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BLACK_SAND_STAIRS = registerBlock("black_sand_stairs",
            new FallingStairBlock(0x404040,DecoBlocks.BLACK_SAND.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.BLACK_SAND)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_STAIRS = registerBlock("cracked_red_nether_brick_stairs",
            new StairsBlock(DecoBlocks.CRACKED_RED_NETHER_BRICKS.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_STAIRS = registerBlock("cracked_polished_blackstone_tile_stairs",
            new StairsBlock(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CLOUD_STAIRS = registerBlock("cloud_stairs",
            new TransparentStairsBlock(DecoBlocks.SOLID_CLOUD.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.SOLID_CLOUD)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CLOUD_BRICK_STAIRS = registerBlock("cloud_brick_stairs",
            new TransparentStairsBlock(DecoBlocks.CLOUD_BRICKS.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CLOUD_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block IRON_LADDER = registerBlock("iron_ladder",
            new LadderBlock(FabricBlockSettings.copyOf(Blocks.LADDER).sounds(BlockSoundGroup.METAL)
                    .strength(5.0F, 6.0F).requiresTool()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block COPPER_LADDER = registerBlock("copper_ladder",
            new OxidizableLadderBlock(Oxidizable.OxidationLevel.UNAFFECTED,FabricBlockSettings.copyOf(Blocks.LADDER)
                    .sounds(BlockSoundGroup.COPPER).strength(5.0F, 6.0F).requiresTool()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block WAXED_COPPER_LADDER = registerBlock("waxed_copper_ladder",
            new LadderBlock(FabricBlockSettings.copyOf(DecoBlocks.COPPER_LADDER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WAXED_EXPOSED_COPPER_LADDER = registerBlock("waxed_exposed_copper_ladder",
            new LadderBlock(FabricBlockSettings.copyOf(DecoBlocks.EXPOSED_COPPER_LADDER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WAXED_WEATHERED_COPPER_LADDER = registerBlock("waxed_weathered_copper_ladder",
            new LadderBlock(FabricBlockSettings.copyOf(DecoBlocks.WEATHERED_COPPER_LADDER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block WAXED_OXIDIZED_COPPER_LADDER = registerBlock("waxed_oxidized_copper_ladder",
            new LadderBlock(FabricBlockSettings.copyOf(DecoBlocks.OXIDIZED_COPPER_LADDER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block PODZOL_CARPET = registerBlock("podzol_carpet",
            new CarpetBlock(FabricBlockSettings.copyOf(Blocks.MOSS_CARPET).mapColor(MapColor.SPRUCE_BROWN)
                    .sounds(BlockSoundGroup.GRAVEL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRIMSON_NYLIUM_CARPET = registerBlock("crimson_nylium_carpet",
            new CarpetBlock(FabricBlockSettings.copyOf(Blocks.MOSS_CARPET).mapColor(MapColor.DULL_RED)
                    .sounds(BlockSoundGroup.NYLIUM)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SAND_CARPET = registerBlock("sand_carpet",
            new CarpetBlock(FabricBlockSettings.copyOf(Blocks.MOSS_CARPET).mapColor(MapColor.PALE_YELLOW)
                    .sounds(BlockSoundGroup.SAND)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block HEAVY_GOLD_BARS = registerBlock("heavy_gold_bars",
            new PaneBlock(FabricBlockSettings.copyOf(DecoBlocks.HEAVY_IRON_BARS).sounds(BlockSoundGroup.METAL)
                    .mapColor(MapColor.GOLD)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_NETHER_BRICK_FENCE = registerBlock("cracked_nether_brick_fence",
            new FenceBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE = registerBlock("cracked_red_nether_brick_fence",
            new FenceBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE = registerBlock("cracked_blue_nether_brick_fence",
            new FenceBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block DIRT_WALL = registerBlock("dirt_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DIRT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block COARSE_DIRT_WALL = registerBlock("coarse_dirt_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.COARSE_DIRT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block ROOTED_DIRT_WALL = registerBlock("rooted_dirt_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.ROOTED_DIRT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MUD_WALL = registerBlock("mud_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.MUD)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block DARK_OAK_WOOD_WALL = registerBlock("dark_oak_wood_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DARK_OAK_PLANKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block OBSIDIAN_WALL = registerBlock("obsidian_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.OBSIDIAN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PURPUR_WALL = registerBlock("purpur_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.PURPUR_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CLAY_WALL = registerBlock("clay_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CLAY)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SMOOTH_BASALT_WALL = registerBlock("smooth_basalt_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.SMOOTH_BASALT)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_STONE_BRICK_WALL = registerBlock("cracked_stone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_DEEPSLATE_BRICK_WALL = registerBlock("cracked_deepslate_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_DEEPSLATE_TILE_WALL = registerBlock("cracked_deepslate_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_NETHER_BRICK_WALL = registerBlock("cracked_nether_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block END_STONE_WALL = registerBlock("end_stone_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.END_STONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block BONE_WALL = registerBlock("bone_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.BONE_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_TUBE_CORAL_WALL = registerBlock("dead_tube_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_BRAIN_CORAL_WALL = registerBlock("dead_brain_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_BUBBLE_CORAL_WALL = registerBlock("dead_bubble_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_FIRE_CORAL_WALL = registerBlock("dead_fire_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DEAD_HORN_CORAL_WALL = registerBlock("dead_horn_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block TUBE_CORAL_WALL = registerBlock("tube_coral_wall",
            new CoralWallBlock(DEAD_TUBE_CORAL_WALL, FabricBlockSettings.copyOf(Blocks.TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BRAIN_CORAL_WALL = registerBlock("brain_coral_wall",
            new CoralWallBlock(DEAD_BRAIN_CORAL_WALL, FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block BUBBLE_CORAL_WALL = registerBlock("bubble_coral_wall",
            new CoralWallBlock(DEAD_BUBBLE_CORAL_WALL,FabricBlockSettings.copyOf(Blocks.BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block FIRE_CORAL_WALL = registerBlock("fire_coral_wall",
            new CoralWallBlock(DEAD_FIRE_CORAL_WALL,FabricBlockSettings.copyOf(Blocks.FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block HORN_CORAL_WALL = registerBlock("horn_coral_wall",
            new CoralWallBlock(DEAD_HORN_CORAL_WALL,FabricBlockSettings.copyOf(Blocks.HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block GRANITE_BRICK_WALL = registerBlock("granite_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.GRANITE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_DIORITE_WALL = registerBlock("cut_diorite_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_DIORITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DIORITE_BRICK_WALL = registerBlock("diorite_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DIORITE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_ANDESITE_WALL = registerBlock("cut_andesite_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_ANDESITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block ANDESITE_BRICK_WALL = registerBlock("andesite_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.ANDESITE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_CALCITE_WALL = registerBlock("polished_calcite_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_CALCITE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block COBBLED_SANDSTONE_WALL = registerBlock("cobbled_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SMOOTH_PURPUR_WALL = registerBlock("smooth_purpur_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_PURPUR)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block OBSIDIAN_BRICK_WALL = registerBlock("obsidian_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.OBSIDIAN_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_OBSIDIAN_WALL = registerBlock("cut_obsidian_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_OBSIDIAN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CUT_PURPUR_WALL = registerBlock("cut_purpur_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_PURPUR)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block PURPUR_BRICK_WALL = registerBlock("purpur_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.PURPUR_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_STONE_TILE_WALL = registerBlock("cracked_stone_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_STONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MOSSY_DEEPSLATE_BRICK_WALL = registerBlock("mossy_deepslate_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_END_STONE_WALL = registerBlock("polished_end_stone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_END_STONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MOSSY_END_STONE_BRICK_WALL = registerBlock("mossy_end_stone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_END_STONE_BRICK_WALL = registerBlock("cracked_end_stone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block END_STONE_TILE_WALL = registerBlock("end_stone_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.END_STONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_END_STONE_TILE_WALL = registerBlock("cracked_end_stone_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block VOID_STONE_BRICK_WALL = registerBlock("void_stone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block VOID_STONE_BRICK_PILLAR_WALL = registerBlock("void_stone_brick_pillar_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICK_PILLAR)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block COBBLED_SOUL_SOILSTONE_WALL = registerBlock("cobbled_soul_soilstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_SOUL_SOILSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block POLISHED_SOUL_SOILSTONE_WALL = registerBlock("polished_soul_soilstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_SOUL_SOILSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block SOUL_SOILSTONE_BRICK_WALL = registerBlock("soul_soilstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SOUL_SOILSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block DUEL_CUT_ORANGE_CONCRETE_WALL = registerBlock("duel_cut_orange_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_MAGENTA_CONCRETE_WALL = registerBlock("duel_cut_magenta_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIGHT_BLUE_CONCRETE_WALL = registerBlock("duel_cut_light_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_YELLOW_CONCRETE_WALL = registerBlock("duel_cut_yellow_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIME_CONCRETE_WALL = registerBlock("duel_cut_lime_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_PINK_CONCRETE_WALL = registerBlock("duel_cut_pink_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_GRAY_CONCRETE_WALL = registerBlock("duel_cut_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_LIGHT_GRAY_CONCRETE_WALL = registerBlock("duel_cut_light_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_CYAN_CONCRETE_WALL = registerBlock("duel_cut_cyan_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_PURPLE_CONCRETE_WALL = registerBlock("duel_cut_purple_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BLUE_CONCRETE_WALL = registerBlock("duel_cut_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BROWN_CONCRETE_WALL = registerBlock("duel_cut_brown_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_GREEN_CONCRETE_WALL = registerBlock("duel_cut_green_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_RED_CONCRETE_WALL = registerBlock("duel_cut_red_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DUEL_CUT_BLACK_CONCRETE_WALL = registerBlock("duel_cut_black_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_ORANGE_CONCRETE_WALL = registerBlock("checkered_orange_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_MAGENTA_CONCRETE_WALL = registerBlock("checkered_magenta_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_LIGHT_BLUE_CONCRETE_WALL = registerBlock("checkered_light_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_YELLOW_CONCRETE_WALL = registerBlock("checkered_yellow_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_LIME_CONCRETE_WALL = registerBlock("checkered_lime_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_PINK_CONCRETE_WALL = registerBlock("checkered_pink_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_GRAY_CONCRETE_WALL = registerBlock("checkered_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_LIGHT_GRAY_CONCRETE_WALL = registerBlock("checkered_light_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_CYAN_CONCRETE_WALL = registerBlock("checkered_cyan_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_PURPLE_CONCRETE_WALL = registerBlock("checkered_purple_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_BLUE_CONCRETE_WALL = registerBlock("checkered_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_BROWN_CONCRETE_WALL = registerBlock("checkered_brown_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_GREEN_CONCRETE_WALL = registerBlock("checkered_green_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_RED_CONCRETE_WALL = registerBlock("checkered_red_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CHECKERED_BLACK_CONCRETE_WALL = registerBlock("checkered_black_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block COBBLED_RED_SANDSTONE_WALL = registerBlock("cobbled_red_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_RED_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SMOOTH_WHITE_SANDSTONE_WALL = registerBlock("smooth_white_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SMOOTH_BLACK_SANDSTONE_WALL = registerBlock("smooth_black_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_WALL = registerBlock("cracked_red_nether_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_WALL = registerBlock("cracked_polished_blackstone_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CLOUD_WALL = registerBlock("cloud_wall",
            new TransparentWallBlock(FabricBlockSettings.copyOf(DecoBlocks.SOLID_CLOUD)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CLOUD_BRICK_WALL = registerBlock("cloud_brick_wall",
            new TransparentWallBlock(FabricBlockSettings.copyOf(DecoBlocks.CLOUD_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block SPRUCE_BARREL = registerBlock("spruce_barrel",
            new NonStationBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block JUNGLE_BARREL = registerBlock("jungle_barrel",
            new NonStationBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).mapColor(MapColor.DIRT_BROWN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block ACACIA_BARREL = registerBlock("acacia_barrel",
            new NonStationBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).mapColor(MapColor.ORANGE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block DARK_OAK_BARREL = registerBlock("dark_oak_barrel",
            new NonStationBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).mapColor(MapColor.BROWN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block MANGROVE_BARREL = registerBlock("mangrove_barrel",
            new NonStationBarrelBlock(FabricBlockSettings.copyOf(Blocks.BARREL).mapColor(MapColor.RED)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block MUSHROOM_CARTOGRAPHY_TABLE = registerBlock("mushroom_cartography_table",
            new MushroomCartographyTableBlock(FabricBlockSettings.copyOf(Blocks.CARTOGRAPHY_TABLE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block MUSHROOM_SMITHING_TABLE = registerBlock("mushroom_smithing_table",
            new MushroomSmithingTableBlock(FabricBlockSettings.copyOf(Blocks.SMITHING_TABLE)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block GOLD_LANTERN = registerBlock("gold_lantern",
            new LanternBlock(FabricBlockSettings.copyOf(Blocks.LANTERN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block GOLD_SOUL_LANTERN = registerBlock("gold_soul_lantern",
            new LanternBlock(FabricBlockSettings.copyOf(Blocks.SOUL_LANTERN)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block HANGING_WHITE_LAMP = registerBlock("hanging_white_lamp",
            new HangingLampBlock(FabricBlockSettings.copyOf(DecoBlocks.HANGING_LAMP)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block STONE_LEVER = registerBlock("stone_lever",
            new LeverBlock(FabricBlockSettings.copyOf(Blocks.LEVER)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block END_STONE_PRESSURE_PLATE = registerBlock("end_stone_pressure_plate",
            new PressurePlateBlock(PressurePlateBlock.ActivationRule.MOBS, FabricBlockSettings.copyOf(Blocks.STONE_PRESSURE_PLATE)
                    .mapColor(MapColor.PALE_YELLOW)), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block IRON_BAR_DOOR = registerBlock("iron_bar_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block GOLD_BAR_DOOR = registerBlock("gold_bar_door",
            new DoorBlock(FabricBlockSettings.copyOf(DecoBlocks.GOLD_DOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block MUSHROOM_PALLET_DOOR = registerBlock("mushroom_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(DecoBlocks.MUSHROOM_DOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block IRON_BAR_TRAPDOOR = registerBlock("iron_bar_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_TRAPDOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block GOLD_BAR_TRAPDOOR = registerBlock("gold_bar_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(DecoBlocks.GOLD_TRAPDOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block MUSHROOM_PALLET_TRAPDOOR = registerBlock("mushroom_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(DecoBlocks.MUSHROOM_TRAPDOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_BLOCKS);
    ...
    public static final Block CRACKED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_nether_brick_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_red_nether_brick_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_blue_nether_brick_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BLOCKS);
