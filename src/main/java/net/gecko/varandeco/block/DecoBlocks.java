...
public class DecoBlocks {
    ...
    public static final Block POLISHED_CALCITE = registerBlock("polished_calcite",
            new Block(AbstractBlock.Settings.copy(Blocks.CALCITE).strength(1.0F)));
    public static final Block CUT_CALCITE = registerBlock("cut_calcite",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.POLISHED_CALCITE)));
    public static final Block CALCITE_BRICKS = registerBlock("calcite_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.POLISHED_CALCITE)));
    public static final Block DRIPSTONE_BRICKS = registerBlock("dripstone_bricks",
            new Block(AbstractBlock.Settings.copy(Blocks.DRIPSTONE_BLOCK).strength(2.0F, 1.0F)));
    public static final Block DRIPSTONE_BRICK_PILLAR = registerBlock("dripstone_brick_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICKS)));
    ...
    public static final Block PACKED_GRASS = registerBlock("packed_grass",
            new PackedGrassBlock(AbstractBlock.Settings.copy(Blocks.GRASS_BLOCK)));
    ...
    public static final Block PACKED_CRIMSON_NYLIUM = registerBlock("packed_crimson_nylium",
            new PackedCrimsonNyliumBlock(AbstractBlock.Settings.copy(Blocks.CRIMSON_NYLIUM)));
    public static final Block PACKED_WARPED_NYLIUM = registerBlock("packed_warped_nylium",
            new PackedWarpedNyliumBlock(AbstractBlock.Settings.copy(Blocks.WARPED_NYLIUM)));
    public static final Block CACTUS_PLANKS = registerBlock("cactus_planks",
            new Block(AbstractBlock.Settings.create().strength(1.0f,1.5f)
    ...
    public static final Block MUSHROOM_PLANKS = registerBlock("mushroom_planks",
            new Block(AbstractBlock.Settings.create().mapColor(MapColor.RAW_IRON_PINK).strength(1.0f,1.5f)
                    .sounds(BlockSoundGroup.WOOD)));
    public static final Block IRON_CAP_PLANKS = registerBlock("iron_cap_planks",
            new Block(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(2.0f,3.0f)
                    .sounds(BlockSoundGroup.NETHER_WOOD).requiresTool().instrument(NoteBlockInstrument.IRON_XYLOPHONE)));
    ...
    public static final Block WHITE_SAND = registerBlock("white_sand",
            new ColoredFallingBlock(new ColorCode(0xc0c0c0),AbstractBlock.Settings.copy(Blocks.SAND).mapColor(MapColor.OFF_WHITE)));
    public static final Block BLACK_SAND = registerBlock("black_sand",
            new ColoredFallingBlock(new ColorCode(0x404040),AbstractBlock.Settings.copy(Blocks.SAND).mapColor(MapColor.DEEPSLATE_GRAY)));
    ...
    public static final Block CHISELED_COAL_BRICKS = registerBlock("chiseled_coal_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.COAL_BRICKS)));
    ...
    public static final Block SHINED_AMETHYST = registerBlock("shined_amethyst",
            new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.PALE_PURPLE)));
    public static final Block AMETHYST_BRICKS = registerBlock("amethyst_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST).strength(2.0F)));
    public static final Block SCATTERED_AMETHYST = registerBlock("scattered_amethyst",
            new GlazedTerracottaBlock(AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST)));
    public static final Block AMETHYST_PILLAR = registerBlock("amethyst_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST)));
    ...
    public static final Block SHINED_ECHO = registerBlock("shined_echo",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.ECHO_BLOCK).luminance(state -> 3)));
    public static final Block ECHO_BRICKS = registerBlock("echo_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO).strength(2.5F)));
    public static final Block SCATTERED_ECHO = registerBlock("scattered_echo",
            new GlazedTerracottaBlock(AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO)));
    public static final Block ECHO_PILLAR = registerBlock("echo_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO)));
    ...
    public static final Block CASTED_IRON = registerBlock("casted_iron",
            new Block(AbstractBlock.Settings.copy(Blocks.IRON_BLOCK).strength(10.0F, 6.0F)
                    .mapColor(MapColor.DEEPSLATE_GRAY)));
    public static final Block CASTED_IRON_STAIRS = registerBlock("casted_iron_stairs",
            new StairsBlock(DecoBlocks.CASTED_IRON.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CASTED_IRON)));
    public static final Block CASTED_IRON_SLAB = registerBlock("casted_iron_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CASTED_IRON)));
    ...
    public static final Block CUT_GOLD_STAIRS = registerBlock("cut_gold_stairs",
            new StairsBlock(DecoBlocks.CUT_GOLD.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_GOLD)));
    public static final Block CUT_GOLD_SLAB = registerBlock("cut_gold_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_GOLD)));
    ...
    public static final Block GOLD_GRATE = registerBlock("gold_grate",
            new GrateBlock(AbstractBlock.Settings.copy(Blocks.GOLD_BLOCK).nonOpaque()));
    ...
    public static final Block STRIPPED_IRON_CAP_HYPHAE = registerBlock("stripped_iron_cap_hyphae",
            new PillarBlock(AbstractBlock.Settings.create().mapColor(MapColor.LIGHT_BLUE_GRAY).strength(2.0f,2.0f)
                    .sounds(BlockSoundGroup.NETHER_WOOD).requiresTool().instrument(NoteBlockInstrument.IRON_XYLOPHONE)));
    public static final Block IRON_CAP_HYPHAE = registerBlock("iron_cap_hyphae",
            new PillarBlock(AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_GRAY).strength(2.0f,2.0f)
                    .sounds(BlockSoundGroup.NETHER_WOOD).requiresTool().instrument(NoteBlockInstrument.IRON_XYLOPHONE)));
    public static final Block GLOWING_GLASS = registerBlock("glowing_glass",
            new TransparentBlock(AbstractBlock.Settings.copy(Blocks.GLASS).nonOpaque().luminance(state -> 15)) );
    ...
    public static final Block HARDENED_GLOWING_GLASS = registerBlock("hardened_glowing_glass",
            new TransparentBlock(AbstractBlock.Settings.copy(DecoBlocks.HARDENED_GLASS).nonOpaque().luminance(state -> 15)) );
    ...
    public static final Block LAPIS_BRICKS = registerBlock("lapis_bricks",
            new Block(AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK).strength(4)));
    ...
    public static final Block LAPIS_PILLAR = registerBlock("lapis_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK)));
    ...
    public static final Block SANDSTONE_BRICKS = registerBlock("sandstone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_SANDSTONE_BRICKS)));
    public static final Block SMOOTH_OBSIDIAN = registerBlock("smooth_obsidian",
            new Block(AbstractBlock.Settings.copy(Blocks.OBSIDIAN).strength(60.0F, 1200.0F)));
    public static final Block SMOOTH_LAPIS = registerBlock("smooth_lapis",
            new Block(AbstractBlock.Settings.copy(Blocks.LAPIS_BLOCK).mapColor(MapColor.BLUE)));
    ...
    public static final Block SMOOTH_END_STONE = registerBlock("smooth_end_stone",
            new Block(AbstractBlock.Settings.copy(Blocks.END_STONE).strength(3.5F, 9.0F)));
    ...
    public static final Block SANDED_OBSIDIAN = registerBlock("sanded_obsidian",
            new Block(AbstractBlock.Settings.copy(Blocks.OBSIDIAN).mapColor(MapColor.PURPLE).strength(25.0F, 1200.0F)));
    public static final Block OBSIDIAN_BRICKS = registerBlock("obsidian_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SANDED_OBSIDIAN)));
    ...
    public static final Block JACK_O_SOUL_LANTERN = registerBlock("jack_o_soul_lantern",
            new MovablePumpkinBlock(AbstractBlock.Settings.copy(Blocks.CARVED_PUMPKIN).luminance(state -> 10)));
    public static final Block PACKED_NETHERRACK = registerBlock("packed_netherrack",
            new Block(AbstractBlock.Settings.copy(Blocks.NETHERRACK).strength(3.2F,1.0f)));
    public static final Block NETHERRACK_BRICKS = registerBlock("netherrack_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.PACKED_NETHERRACK)));
    public static final Block CHISELED_NETHERRACK_BRICKS = registerBlock("chiseled_netherrack_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.NETHERRACK_BRICKS)));
    public static final Block BASALT_BRICKS = registerBlock("basalt_bricks",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.POLISHED_BASALT)));
    public static final Block SMOOTH_GLOWSTONE = registerBlock("smooth_glowstone",
            new Block(AbstractBlock.Settings.copy(Blocks.GLOWSTONE).strength(0.6f)));

    public static final Block WHITE_LAMP = registerBlock("white_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor. WHITE)));
    public static final Block ORANGE_LAMP = registerBlock("orange_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.ORANGE)));
    public static final Block MAGENTA_LAMP = registerBlock("magenta_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.MAGENTA)));
    public static final Block LIGHT_BLUE_LAMP = registerBlock("light_blue_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIGHT_BLUE)));
    public static final Block YELLOW_LAMP = registerBlock("yellow_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.YELLOW)));
    public static final Block LIME_LAMP = registerBlock("lime_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIME)));
    public static final Block PINK_LAMP = registerBlock("pink_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.PINK)));
    public static final Block GRAY_LAMP = registerBlock("gray_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.GRAY)));
    public static final Block LIGHT_GRAY_LAMP = registerBlock("light_gray_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.LIGHT_GRAY)));
    public static final Block CYAN_LAMP = registerBlock("cyan_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.CYAN)));
    public static final Block PURPLE_LAMP = registerBlock("purple_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.PURPLE)));
    public static final Block BLUE_LAMP = registerBlock("blue_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BLUE)));
    public static final Block BROWN_LAMP = registerBlock("brown_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BROWN)));
    public static final Block GREEN_LAMP = registerBlock("green_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.GREEN)));
    public static final Block RED_LAMP = registerBlock("red_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.RED)));
    public static final Block BLACK_LAMP = registerBlock("black_lamp",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_GLOWSTONE).mapColor(DyeColor.BLACK)));
    ...
    public static final Block CRACKED_STONE_TILES = registerBlock("cracked_stone_tiles",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.STONE_TILES)));
    ...
    public static final Block PACKED_MYCELIUM = registerBlock("packed_mycelium",
            new PackedMyceliumBlock(AbstractBlock.Settings.copy(Blocks.MYCELIUM)));
    public static final Block NETHER_BRICK_PILLAR = registerBlock("nether_brick_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.NETHER_BRICKS)));
    ...
    public static final Block CRACKED_END_STONE_TILES = registerBlock("cracked_end_stone_tiles",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.END_STONE_TILES)));
    ...
    public static final Block VOID_STONE_BRICKS = registerBlock("void_stone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE).strength(5.5F, 12.0F)));
    public static final Block VOID_STONE_BRICK_PILLAR = registerBlock("void_stone_brick_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE_BRICKS)));
    ...
    public static final Block RED_SANDSTONE_BRICKS = registerBlock("red_sandstone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_RED_SANDSTONE_BRICKS)));
    public static final Block WHITE_SANDSTONE = registerBlock("white_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.SANDSTONE).requiresTool().mapColor(MapColor.OFF_WHITE)));
    public static final Block CHISELED_WHITE_SANDSTONE = registerBlock("chiseled_white_sandstone",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.WHITE_SANDSTONE)));
    ...
    public static final Block CUT_WHITE_SANDSTONE_BRICKS = registerBlock("cut_white_sandstone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE).strength(1.6f)));
    ...
    public static final Block CHISELED_POLISHED_WHITE_SANDSTONE = registerBlock("chiseled_polished_white_sandstone",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CHISELED_WHITE_SANDSTONE)));
    public static final Block POLISHED_WHITE_SANDSTONE = registerBlock("polished_white_sandstone",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE)));
    public static final Block WHITE_SANDSTONE_BRICKS = registerBlock("white_sandstone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)));
    public static final Block BLACK_SANDSTONE = registerBlock("black_sandstone",
            new Block(AbstractBlock.Settings.copy(Blocks.SANDSTONE).requiresTool().mapColor(MapColor.DEEPSLATE_GRAY)));
    public static final Block CHISELED_BLACK_SANDSTONE = registerBlock("chiseled_black_sandstone",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.BLACK_SANDSTONE)));
    ...
    public static final Block CUT_BLACK_SANDSTONE_BRICKS = registerBlock("cut_black_sandstone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE).strength(1.6f)));
    ...
    public static final Block CHISELED_POLISHED_BLACK_SANDSTONE = registerBlock("chiseled_polished_black_sandstone",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CHISELED_BLACK_SANDSTONE)));
    public static final Block POLISHED_BLACK_SANDSTONE = registerBlock("polished_black_sandstone",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE)));
    public static final Block BLACK_SANDSTONE_BRICKS = registerBlock("black_sandstone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)));
    ...
    public static final Block CHISELED_ICE_BRICKS = registerBlock("chiseled_ice_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.ICE_BRICKS)));
    ...
    public static final Block SOUL_SOILSTONE_BRICKS = registerBlock("soul_soilstone_bricks",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.CUT_SOUL_SOILSTONE_BRICKS)));
    ...
    public static final Block CHISELED_BUBBLE_BLOCK = registerBlock("chiseled_bubble_block",
            new BubbleBlock(AbstractBlock.Settings.copy(DecoBlocks.BUBBLE_BLOCK)));
    ...
    public static final Block RED_NETHER_BRICK_PILLAR = registerBlock("red_nether_brick_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.RED_NETHER_BRICKS)));
    ...
    public static final Block BLUE_NETHER_BRICK_PILLAR = registerBlock("blue_nether_brick_pillar",
            new PillarBlock(AbstractBlock.Settings.copy(DecoBlocks.BLUE_NETHER_BRICKS)));
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILES = registerBlock("cracked_polished_blackstone_tiles",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.POLISHED_BLACKSTONE_TILES)));

    public static final Block CLOUD_BLOCK = registerBlock("cloud_block",
            new CloudBlock(AbstractBlock.Settings.create().mapColor(MapColor.CLEAR).strength(0.4f,0.2f)
    ...
    public static final Block SOLID_CLOUD = registerBlock("solid_cloud",
            new TransparentBlock(AbstractBlock.Settings.copy(Blocks.WHITE_WOOL).strength(0.8f,0.4f)
                    .allowsSpawning(DecoBlocks::never).nonOpaque()));
    public static final Block CLOUD_BRICKS = registerBlock("cloud_bricks",
            new TransparentBlock(AbstractBlock.Settings.copy(DecoBlocks.SOLID_CLOUD).strength(1.2f,0.6f)));
    ...
    public static final Block FRAGILE_ICE = registerBlock("fragile_ice",
            new FragileIceBlock(AbstractBlock.Settings.create().mapColor(MapColor.PALE_PURPLE).slipperiness(0.98F)
    ...
    public static final Block CRACKED_TUFF_TILES = registerBlock("cracked_tuff_tiles",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.TUFF_TILES)));
    ...
    public static final Block MUSHROOM_MOSAIC = registerBlock("mushroom_mosaic",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS)));
    ...
    public static final Block IRON_CAP_MOSAIC = registerBlock("iron_cap_mosaic",
            new Block(AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS)));
    ...
    public static final Block MUSHROOM_MOSAIC_STAIRS = registerBlock("mushroom_mosaic_stairs",
            new StairsBlock(DecoBlocks.MUSHROOM_MOSAIC.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_MOSAIC)));
    ...
    public static final Block IRON_CAP_MOSAIC_STAIRS = registerBlock("iron_cap_mosaic_stairs",
            new StairsBlock(DecoBlocks.IRON_CAP_MOSAIC.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_MOSAIC)));
    ...
    public static final Block MUSHROOM_MOSAIC_SLAB = registerBlock("mushroom_mosaic_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_MOSAIC)));
    ...
    public static final Block IRON_CAP_MOSAIC_SLAB = registerBlock("iron_cap_mosaic_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_MOSAIC)));

    public static final Block PASTEL_ORANGE_BLOCK = registerBlock("pastel_orange_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.ORANGE).resistance(0.5f)
    ...
    public static final Block PASTEL_MAGENTA_BLOCK = registerBlock("pastel_magenta_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.MAGENTA).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_LIGHT_BLUE_BLOCK = registerBlock("pastel_light_blue_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.LIGHT_BLUE).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_YELLOW_BLOCK = registerBlock("pastel_yellow_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.YELLOW).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_LIME_BLOCK = registerBlock("pastel_lime_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.LIME).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_PINK_BLOCK = registerBlock("pastel_pink_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.PINK).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_GRAY_BLOCK = registerBlock("pastel_gray_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.GRAY).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_LIGHT_GRAY_BLOCK = registerBlock("pastel_light_gray_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.LIGHT_GRAY).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_CYAN_BLOCK = registerBlock("pastel_cyan_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.CYAN).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_PURPLE_BLOCK = registerBlock("pastel_purple_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.PURPLE).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_BLUE_BLOCK = registerBlock("pastel_blue_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.BLUE).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_BROWN_BLOCK = registerBlock("pastel_brown_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.BROWN).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_GREEN_BLOCK = registerBlock("pastel_green_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.GREEN).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    public static final Block PASTEL_RED_BLOCK = registerBlock("pastel_red_block",
            new Block(AbstractBlock.Settings.create().mapColor(DyeColor.RED).resistance(0.5f)
                    .breakInstantly().sounds(BlockSoundGroup.CANDLE)));
    ...
    public static final Block GRASS_SLAB = registerBlock("grass_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_GRASS)));
    ...
    public static final Block PODZOL_SLAB = registerBlock("podzol_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_PODZOL)));
    ...
    public static final Block CRIMSON_NYLIUM_SLAB = registerBlock("crimson_nylium_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_CRIMSON_NYLIUM)));
    public static final Block WARPED_NYLIUM_SLAB = registerBlock("warped_nylium_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_WARPED_NYLIUM)));
    ...
    public static final Block SAND_SLAB = registerBlock("sand_slab",
            new FallingSlabBlock(14406560,AbstractBlock.Settings.copy(Blocks.SAND)));
    public static final Block RED_SAND_SLAB = registerBlock("red_sand_slab",
            new FallingSlabBlock(11098145,AbstractBlock.Settings.copy(Blocks.RED_SAND)));
    public static final Block GRAVEL_SLAB = registerBlock("gravel_slab",
            new FallingSlabBlock(-8356741,AbstractBlock.Settings.copy(Blocks.GRAVEL)));
    ...
    public static final Block BAMBOO_BLOCK_SLAB = registerBlock("bamboo_block_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).mapColor(MapColor.DARK_GREEN)));
    ...
    public static final Block STRIPPED_IRON_CAP_HYPHAE_SLAB = registerBlock("stripped_iron_cap_hyphae_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS).sounds(BlockSoundGroup.NETHER_STEM)));
    ...
    public static final Block CRACKED_DEEPSLATE_TILE_SLAB = registerBlock("cracked_deepslate_tile_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.CRACKED_DEEPSLATE_TILES)));
    public static final Block MYCELIUM_SLAB = registerBlock("packed_mycelium_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_MYCELIUM)));
    ...
    public static final Block HAY_SLAB = registerBlock("hay_slab",
            new HaySlabBlock(AbstractBlock.Settings.copy(Blocks.HAY_BLOCK)));
    ...
    public static final Block TUBE_CORAL_SLAB = registerBlock("tube_coral_slab",
            new CoralSlabBlock(DEAD_TUBE_CORAL_SLAB, AbstractBlock.Settings.copy(Blocks.TUBE_CORAL_BLOCK)));
    public static final Block BRAIN_CORAL_SLAB = registerBlock("brain_coral_slab",
            new CoralSlabBlock(DEAD_BRAIN_CORAL_SLAB, AbstractBlock.Settings.copy(Blocks.DEAD_BRAIN_CORAL_BLOCK)));
    public static final Block BUBBLE_CORAL_SLAB = registerBlock("bubble_coral_slab",
            new CoralSlabBlock(DEAD_BUBBLE_CORAL_SLAB,AbstractBlock.Settings.copy(Blocks.BUBBLE_CORAL_BLOCK)));
    public static final Block FIRE_CORAL_SLAB = registerBlock("fire_coral_slab",
            new CoralSlabBlock(DEAD_FIRE_CORAL_SLAB,AbstractBlock.Settings.copy(Blocks.FIRE_CORAL_BLOCK)));
    public static final Block HORN_CORAL_SLAB = registerBlock("horn_coral_slab",
            new CoralSlabBlock(DEAD_HORN_CORAL_SLAB,AbstractBlock.Settings.copy(Blocks.HORN_CORAL_BLOCK)));
    ...
    public static final Block CUT_GRANITE_SLAB = registerBlock("cut_granite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_GRANITE)));
    public static final Block GRANITE_BRICK_SLAB = registerBlock("granite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.GRANITE_BRICKS)));
    public static final Block CUT_DIORITE_SLAB = registerBlock("cut_diorite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_DIORITE)));
    public static final Block DIORITE_BRICK_SLAB = registerBlock("diorite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.DIORITE_BRICKS)));
    public static final Block CUT_ANDESITE_SLAB = registerBlock("cut_andesite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_ANDESITE)));
    public static final Block ANDESITE_BRICK_SLAB = registerBlock("andesite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.ANDESITE_BRICKS)));
    public static final Block POLISHED_CALCITE_SLAB = registerBlock("polished_calcite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.POLISHED_CALCITE)));
    public static final Block CUT_CALCITE_SLAB = registerBlock("cut_calcite_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_CALCITE)));
    public static final Block CALCITE_BRICK_SLAB = registerBlock("calcite_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CALCITE_BRICKS)));
    public static final Block DRIPSTONE_BRICK_SLAB = registerBlock("dripstone_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICKS)));
    public static final Block DRIPSTONE_BRICK_PILLAR_SLAB = registerBlock("dripstone_brick_pillar_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICK_PILLAR)));
    ...
    public static final Block MUSHROOM_SLAB = registerBlock("mushroom_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS)));
    ...
    public static final Block WHITE_SAND_SLAB = registerBlock("white_sand_slab",
            new FallingSlabBlock(0xc0c0c0,AbstractBlock.Settings.copy(DecoBlocks.WHITE_SAND)));
    public static final Block BLACK_SAND_SLAB = registerBlock("black_sand_slab",
            new FallingSlabBlock(0x404040,AbstractBlock.Settings.copy(DecoBlocks.BLACK_SAND)));
    public static final Block COAL_BRICK_SLAB = registerBlock("coal_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.COAL_BRICKS)));
    public static final Block CHARCOAL_SLAB = registerBlock("charcoal_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CHARCOAL_BLOCK)));
    public static final Block FLINT_SLAB = registerBlock("flint_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.FLINT_BLOCK)));
    public static final Block SHINED_AMETHYST_SLAB = registerBlock("shined_amethyst_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST)));
    public static final Block AMETHYST_BRICK_SLAB = registerBlock("amethyst_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.AMETHYST_BRICKS)));
    public static final Block SCATTERED_AMETHYST_SLAB = registerBlock("scattered_amethyst_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SCATTERED_AMETHYST)));
    public static final Block ECHO_SLAB = registerBlock("echo_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.ECHO_BLOCK)));
    public static final Block SHINED_ECHO_SLAB = registerBlock("shined_echo_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO)));
    public static final Block ECHO_BRICK_SLAB = registerBlock("echo_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.ECHO_BRICKS)));
    public static final Block SCATTERED_ECHO_SLAB = registerBlock("scattered_echo_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SCATTERED_ECHO)));
    public static final Block LAPIS_BRICK_SLAB = registerBlock("lapis_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.LAPIS_BRICKS)));
    public static final Block CUT_LAPIS_SLAB = registerBlock("cut_lapis_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_LAPIS)));
    ...
    public static final Block SMOOTH_LAPIS_SLAB = registerBlock("smooth_lapis_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_LAPIS)));
    public static final Block SMOOTH_OBSIDIAN_SLAB = registerBlock("smooth_obsidian_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_OBSIDIAN)));
    ...
    public static final Block SMOOTH_WHITE_SANDSTONE_SLAB = registerBlock("smooth_white_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_WHITE_SANDSTONE)));
    public static final Block SMOOTH_BLACK_SANDSTONE_SLAB = registerBlock("smooth_black_sandstone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_BLACK_SANDSTONE)));
    ...
    public static final Block SMOOTH_END_STONE_SLAB = registerBlock("smooth_end_stone_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_END_STONE)));
    public static final Block SANDED_OBSIDIAN_SLAB = registerBlock("sanded_obsidian_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SANDED_OBSIDIAN)));
    ...
    public static final Block CUT_OBSIDIAN_SLAB = registerBlock("cut_obsidian_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_OBSIDIAN)));
    ...
    public static final Block CUT_PURPUR_SLAB = registerBlock("cut_purpur_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_PURPUR)));
    ...
    public static final Block PACKED_NETHERRACK_SLAB = registerBlock("packed_netherrack_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_NETHERRACK)));
    public static final Block NETHERRACK_BRICK_SLAB = registerBlock("netherrack_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.NETHERRACK_BRICKS)));
    ...
    public static final Block VOID_STONE_BRICK_PILLAR_SLAB = registerBlock("void_stone_brick_pillar_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE_BRICK_PILLAR)));
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_SLAB = registerBlock("cracked_red_nether_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_RED_NETHER_BRICKS)));
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_SLAB = registerBlock("cracked_polished_blackstone_tile_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)));
    public static final Block CLOUD_SLAB = registerBlock("cloud_slab",
            new TransparentSlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SOLID_CLOUD)));
    public static final Block CLOUD_BRICK_SLAB = registerBlock("cloud_brick_slab",
            new TransparentSlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CLOUD_BRICKS)));
    ...
    public static final Block GRASS_STAIRS = registerBlock("grass_stairs",
            new StairsBlock(DecoBlocks.PACKED_GRASS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.PACKED_GRASS)));
    ...
    public static final Block PODZOL_STAIRS = registerBlock("podzol_stairs",
            new StairsBlock(DecoBlocks.PACKED_PODZOL.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.PACKED_PODZOL)));
    ...
    public static final Block CRIMSON_NYLIUM_STAIRS = registerBlock("crimson_nylium_stairs",
            new StairsBlock(DecoBlocks.PACKED_CRIMSON_NYLIUM.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.PACKED_CRIMSON_NYLIUM)));
    public static final Block WARPED_NYLIUM_STAIRS = registerBlock("warped_nylium_stairs",
            new StairsBlock(DecoBlocks.PACKED_WARPED_NYLIUM.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.PACKED_WARPED_NYLIUM)));
    ...
    public static final Block SAND_STAIRS = registerBlock("sand_stairs",
            new FallingStairBlock(14406560,Blocks.SAND.getDefaultState(),AbstractBlock.Settings.copy(Blocks.SAND)));
    public static final Block RED_SAND_STAIRS = registerBlock("red_sand_stairs",
            new FallingStairBlock(11098145,Blocks.RED_SAND.getDefaultState(),AbstractBlock.Settings.copy(Blocks.RED_SAND)));
    public static final Block GRAVEL_STAIRS = registerBlock("gravel_stairs",
            new FallingStairBlock(-8356741,Blocks.GRAVEL.getDefaultState(),AbstractBlock.Settings.copy(Blocks.GRAVEL)));
    ...
    public static final Block SPRUCE_WOOD_STAIRS = registerBlock("spruce_wood_stairs",
            new StairsBlock(Blocks.SPRUCE_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(Blocks.SPRUCE_PLANKS)
                    .mapColor(MapColor.BROWN)));
    public static final Block BIRCH_WOOD_STAIRS = registerBlock("birch_wood_stairs",
            new StairsBlock(Blocks.BIRCH_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(Blocks.BIRCH_PLANKS)
                    .mapColor(MapColor.OFF_WHITE)));
    public static final Block JUNGLE_WOOD_STAIRS = registerBlock("jungle_wood_stairs",
            new StairsBlock(Blocks.JUNGLE_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(Blocks.JUNGLE_PLANKS)
                    .mapColor(MapColor.DIRT_BROWN)));
    public static final Block ACACIA_WOOD_STAIRS = registerBlock("acacia_wood_stairs",
            new StairsBlock(Blocks.ACACIA_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(Blocks.ACACIA_PLANKS)
                    .mapColor(MapColor.STONE_GRAY)));
    public static final Block DARK_OAK_WOOD_STAIRS = registerBlock("dark_oak_wood_stairs",
            new StairsBlock(Blocks.DARK_OAK_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(Blocks.DARK_OAK_PLANKS)));
    ...
    public static final Block BAMBOO_BLOCK_STAIRS = registerBlock("bamboo_block_stairs",
            new StairsBlock(Blocks.BAMBOO_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS)
    ...
    public static final Block STRIPPED_IRON_CAP_HYPHAE_STAIRS = registerBlock("stripped_iron_cap_hyphae_stairs",
            new StairsBlock(DecoBlocks.IRON_CAP_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS)));public static final Block STRIPPED_BAMBOO_STAIRS = registerBlock("stripped_bamboo_stairs",
            new StairsBlock(Blocks.BAMBOO_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS)));
    ...
    public static final Block CRACKED_DEEPSLATE_TILE_STAIRS = registerBlock("cracked_deepslate_tile_stairs",
            new StairsBlock(Blocks.CRACKED_DEEPSLATE_TILES.getDefaultState(),AbstractBlock.Settings.copy(Blocks.CRACKED_DEEPSLATE_TILES)));
    public static final Block MYCELIUM_STAIRS = registerBlock("mycelium_stairs",
            new StairsBlock(DecoBlocks.PACKED_MYCELIUM.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.PACKED_MYCELIUM)));
    ...
    public static final Block HAY_STAIRS = registerBlock("hay_stairs",
            new HayStairsBlock(Blocks.HAY_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(Blocks.HAY_BLOCK)));
    ...
    public static final Block TUBE_CORAL_STAIRS = registerBlock("tube_coral_stairs",
            new CoralStairBlock(DEAD_TUBE_CORAL_STAIRS,Blocks.TUBE_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(Blocks.TUBE_CORAL_BLOCK)));
    public static final Block BRAIN_CORAL_STAIRS = registerBlock("brain_coral_stairs",
            new CoralStairBlock(DEAD_BRAIN_CORAL_STAIRS,Blocks.BRAIN_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(Blocks.BRAIN_CORAL_BLOCK)));
    public static final Block BUBBLE_CORAL_STAIRS = registerBlock("bubble_coral_stairs",
            new CoralStairBlock(DEAD_BUBBLE_CORAL_STAIRS,Blocks.BUBBLE_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(Blocks.BUBBLE_CORAL_BLOCK)));
    public static final Block FIRE_CORAL_STAIRS = registerBlock("fire_coral_stairs",
            new CoralStairBlock(DEAD_FIRE_CORAL_STAIRS,Blocks.FIRE_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(Blocks.FIRE_CORAL_BLOCK)));
    public static final Block HORN_CORAL_STAIRS = registerBlock("horn_coral_stairs",
            new CoralStairBlock(DEAD_HORN_CORAL_STAIRS,Blocks.HORN_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(Blocks.HORN_CORAL_BLOCK)));
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS = registerBlock("cracked_polished_blackstone_brick_stairs",
            new StairsBlock(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(
    ...
    public static final Block CUT_GRANITE_STAIRS = registerBlock("cut_granite_stairs",
            new StairsBlock(DecoBlocks.CUT_GRANITE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_GRANITE)));
    public static final Block GRANITE_BRICK_STAIRS = registerBlock("granite_brick_stairs",
            new StairsBlock(DecoBlocks.GRANITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.GRANITE_BRICKS)));
    public static final Block CUT_DIORITE_STAIRS = registerBlock("cut_diorite_stairs",
            new StairsBlock(DecoBlocks.CUT_DIORITE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_DIORITE)));
    public static final Block DIORITE_BRICK_STAIRS = registerBlock("diorite_brick_stairs",
            new StairsBlock(DecoBlocks.DIORITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DIORITE_BRICKS)));
    public static final Block CUT_ANDESITE_STAIRS = registerBlock("cut_andesite_stairs",
            new StairsBlock(DecoBlocks.CUT_ANDESITE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_ANDESITE)));
    public static final Block ANDESITE_BRICK_STAIRS = registerBlock("andesite_brick_stairs",
            new StairsBlock(DecoBlocks.ANDESITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.ANDESITE_BRICKS)));
    public static final Block POLISHED_CALCITE_STAIRS = registerBlock("polished_calcite_stairs",
            new StairsBlock(DecoBlocks.POLISHED_CALCITE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.POLISHED_CALCITE)));
    public static final Block CUT_CALCITE_STAIRS = registerBlock("cut_calcite_stairs",
            new StairsBlock(DecoBlocks.CUT_CALCITE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_CALCITE)));
    public static final Block CALCITE_BRICK_STAIRS = registerBlock("calcite_brick_stairs",
            new StairsBlock(DecoBlocks.CALCITE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CALCITE_BRICKS)));
    public static final Block DRIPSTONE_BRICK_STAIRS = registerBlock("dripstone_brick_stairs",
            new StairsBlock(DecoBlocks.DRIPSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICKS)));
    public static final Block DRIPSTONE_BRICK_PILLAR_STAIRS = registerBlock("dripstone_brick_pillar_stairs",
            new StairsBlock(DecoBlocks.DRIPSTONE_BRICK_PILLAR.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DRIPSTONE_BRICK_PILLAR)));
    ...
    public static final Block MUSHROOM_STAIRS = registerBlock("mushroom_stairs",
            new StairsBlock(DecoBlocks.MUSHROOM_PLANKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS)));
    ...
    public static final Block WHITE_SAND_STAIRS = registerBlock("white_sand_stairs",
            new FallingStairBlock(0xc0c0c0,DecoBlocks.WHITE_SAND.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.WHITE_SAND)));
    public static final Block BLACK_SAND_STAIRS = registerBlock("black_sand_stairs",
            new FallingStairBlock(0x404040,DecoBlocks.BLACK_SAND.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.BLACK_SAND)));
    public static final Block COAL_BRICK_STAIRS = registerBlock("coal_brick_stairs",
            new StairsBlock(DecoBlocks.COAL_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.COAL_BRICKS)));
    public static final Block CHARCOAL_STAIRS = registerBlock("charcoal_stairs",
            new StairsBlock(DecoBlocks.CHARCOAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHARCOAL_BLOCK)));
    public static final Block SHINED_AMETHYST_STAIRS = registerBlock("shined_amethyst_stairs",
            new StairsBlock(DecoBlocks.SHINED_AMETHYST.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SHINED_AMETHYST)));
    public static final Block AMETHYST_BRICK_STAIRS = registerBlock("amethyst_brick_stairs",
            new StairsBlock(DecoBlocks.AMETHYST_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.AMETHYST_BRICKS)));
    public static final Block SCATTERED_AMETHYST_STAIRS = registerBlock("scattered_amethyst_stairs",
            new StairsBlock(DecoBlocks.SCATTERED_AMETHYST.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SCATTERED_AMETHYST)));
    public static final Block ECHO_STAIRS = registerBlock("echo_stairs",
            new StairsBlock(DecoBlocks.ECHO_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.ECHO_BLOCK)));
    public static final Block SHINED_ECHO_STAIRS = registerBlock("shined_echo_stairs",
            new StairsBlock(DecoBlocks.SHINED_ECHO.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SHINED_ECHO)));
    public static final Block ECHO_BRICK_STAIRS = registerBlock("echo_brick_stairs",
            new StairsBlock(DecoBlocks.ECHO_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.ECHO_BRICKS)));
    public static final Block SCATTERED_ECHO_STAIRS = registerBlock("scattered_echo_stairs",
            new StairsBlock(DecoBlocks.SCATTERED_ECHO.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SCATTERED_ECHO)));
    public static final Block FLINT_STAIRS = registerBlock("flint_stairs",
            new StairsBlock(DecoBlocks.FLINT_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.FLINT_BLOCK)));
    public static final Block LAPIS_BRICK_STAIRS = registerBlock("lapis_brick_stairs",
            new StairsBlock(DecoBlocks.LAPIS_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.LAPIS_BRICKS)));
    public static final Block CUT_LAPIS_STAIRS = registerBlock("cut_lapis_stairs",
            new StairsBlock(DecoBlocks.CUT_LAPIS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_LAPIS)));
    ...
    public static final Block COBBLED_SANDSTONE_STAIRS = registerBlock("cobbled_sandstone_stairs",
            new StairsBlock(DecoBlocks.COBBLED_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.COBBLED_SANDSTONE)));
    public static final Block POLISHED_SANDSTONE_STAIRS = registerBlock("polished_sandstone_stairs",
            new StairsBlock(DecoBlocks.POLISHED_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.POLISHED_SANDSTONE)));
    public static final Block SANDSTONE_BRICK_STAIRS = registerBlock("sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.SANDSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SANDSTONE_BRICKS)));
    public static final Block SMOOTH_LAPIS_STAIRS = registerBlock("smooth_lapis_stairs",
            new StairsBlock(DecoBlocks.SMOOTH_LAPIS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_LAPIS)));
    public static final Block SMOOTH_OBSIDIAN_STAIRS = registerBlock("smooth_obsidian_stairs",
            new StairsBlock(DecoBlocks.SMOOTH_OBSIDIAN.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_OBSIDIAN)));
    ...
    public static final Block SMOOTH_WHITE_SANDSTONE_STAIRS = registerBlock("smooth_white_sandstone_stairs",
            new StairsBlock(DecoBlocks.SMOOTH_WHITE_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_WHITE_SANDSTONE)));
    public static final Block SMOOTH_BLACK_SANDSTONE_STAIRS = registerBlock("smooth_black_sandstone_stairs",
            new StairsBlock(DecoBlocks.SMOOTH_BLACK_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_BLACK_SANDSTONE)));
    ...
    public static final Block SMOOTH_END_STONE_STAIRS = registerBlock("smooth_end_stone_stairs",
            new StairsBlock(DecoBlocks.SMOOTH_END_STONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_END_STONE)));
    public static final Block SANDED_OBSIDIAN_STAIRS = registerBlock("sanded_obsidian_stairs",
            new StairsBlock(DecoBlocks.SANDED_OBSIDIAN.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SANDED_OBSIDIAN)));
    ...
    public static final Block CUT_OBSIDIAN_STAIRS = registerBlock("cut_obsidian_stairs",
            new StairsBlock(DecoBlocks.CUT_OBSIDIAN.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_OBSIDIAN)));
    ...
    public static final Block CUT_PURPUR_STAIRS = registerBlock("cut_purpur_stairs",
            new StairsBlock(DecoBlocks.CUT_PURPUR.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_PURPUR)));
    ...
    public static final Block PACKED_NETHERRACK_STAIRS = registerBlock("packed_netherrack_stairs",
            new StairsBlock(DecoBlocks.PACKED_NETHERRACK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.PACKED_NETHERRACK)));
    public static final Block NETHERRACK_BRICK_STAIRS = registerBlock("netherrack_brick_stairs",
            new StairsBlock(DecoBlocks.NETHERRACK_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.NETHERRACK_BRICKS)));
    ...
    public static final Block CRACKED_STONE_TILE_STAIRS = registerBlock("cracked_stone_tile_stairs",
            new StairsBlock(DecoBlocks.CRACKED_STONE_TILES.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CRACKED_STONE_TILES)));
    public static final Block MOSSY_DEEPSLATE_BRICK_STAIRS = registerBlock("mossy_deepslate_brick_stairs",
            new StairsBlock(DecoBlocks.MOSSY_DEEPSLATE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.MOSSY_DEEPSLATE_BRICKS)));
    public static final Block POLISHED_END_STONE_STAIRS = registerBlock("polished_end_stone_stairs",
            new StairsBlock(DecoBlocks.POLISHED_END_STONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.POLISHED_END_STONE)));
    public static final Block MOSSY_END_STONE_BRICK_STAIRS = registerBlock("mossy_end_stone_brick_stairs",
            new StairsBlock(DecoBlocks.MOSSY_END_STONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.MOSSY_END_STONE_BRICKS)));
    public static final Block CRACKED_END_STONE_BRICK_STAIRS = registerBlock("cracked_end_stone_brick_stairs",
            new StairsBlock(DecoBlocks.CRACKED_END_STONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CRACKED_END_STONE_BRICKS)));
    public static final Block END_STONE_TILE_STAIRS = registerBlock("end_stone_tile_stairs",
            new StairsBlock(DecoBlocks.END_STONE_TILES.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.END_STONE_TILES)));
    public static final Block CRACKED_END_STONE_TILE_STAIRS = registerBlock("cracked_end_stone_tile_stairs",
            new StairsBlock(DecoBlocks.CRACKED_END_STONE_TILES.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CRACKED_END_STONE_TILES)));
    ...
    public static final Block VOID_STONE_BRICK_PILLAR_STAIRS = registerBlock("void_stone_brick_pillar_stairs",
            new StairsBlock(DecoBlocks.VOID_STONE_BRICK_PILLAR.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE_BRICK_PILLAR)));
    ...
    public static final Block COBBLED_SOUL_SOILSTONE_STAIRS = registerBlock("cobbled_soul_soilstone_stairs",
            new StairsBlock(DecoBlocks.COBBLED_SOUL_SOILSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.COBBLED_SOUL_SOILSTONE)));
    public static final Block POLISHED_SOUL_SOILSTONE_STAIRS = registerBlock("polished_soul_soilstone_stairs",
            new StairsBlock(DecoBlocks.POLISHED_SOUL_SOILSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.POLISHED_SOUL_SOILSTONE)));
    public static final Block SOUL_SOILSTONE_BRICK_STAIRS = registerBlock("soul_soilstone_brick_stairs",
            new StairsBlock(DecoBlocks.SOUL_SOILSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SOUL_SOILSTONE_BRICKS)));
    ...
    public static final Block DUEL_CUT_ORANGE_CONCRETE_STAIRS = registerBlock("duel_cut_orange_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_ORANGE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_ORANGE_CONCRETE)));
    public static final Block DUEL_CUT_MAGENTA_CONCRETE_STAIRS = registerBlock("duel_cut_magenta_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE)));
    public static final Block DUEL_CUT_LIGHT_BLUE_CONCRETE_STAIRS = registerBlock("duel_cut_light_blue_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE)));
    public static final Block DUEL_CUT_YELLOW_CONCRETE_STAIRS = registerBlock("duel_cut_yellow_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_YELLOW_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_YELLOW_CONCRETE)));
    public static final Block DUEL_CUT_LIME_CONCRETE_STAIRS = registerBlock("duel_cut_lime_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_LIME_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_LIME_CONCRETE)));
    public static final Block DUEL_CUT_PINK_CONCRETE_STAIRS = registerBlock("duel_cut_pink_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_PINK_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_PINK_CONCRETE)));
    public static final Block DUEL_CUT_GRAY_CONCRETE_STAIRS = registerBlock("duel_cut_gray_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_GRAY_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_GRAY_CONCRETE)));
    public static final Block DUEL_CUT_LIGHT_GRAY_CONCRETE_STAIRS = registerBlock("duel_cut_light_gray_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE)));
    public static final Block DUEL_CUT_CYAN_CONCRETE_STAIRS = registerBlock("duel_cut_cyan_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_CYAN_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_CYAN_CONCRETE)));
    public static final Block DUEL_CUT_PURPLE_CONCRETE_STAIRS = registerBlock("duel_cut_purple_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_PURPLE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_PURPLE_CONCRETE)));
    public static final Block DUEL_CUT_BLUE_CONCRETE_STAIRS = registerBlock("duel_cut_blue_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_BLUE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_BLUE_CONCRETE)));
    public static final Block DUEL_CUT_BROWN_CONCRETE_STAIRS = registerBlock("duel_cut_brown_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_BROWN_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_BROWN_CONCRETE)));
    public static final Block DUEL_CUT_GREEN_CONCRETE_STAIRS = registerBlock("duel_cut_green_concrete_stairs",
            new StairsBlock(DecoBlocks.CUT_GREEN_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_GREEN_CONCRETE)));
    public static final Block DUEL_CUT_RED_CONCRETE_STAIRS = registerBlock("duel_cut_red_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_RED_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_RED_CONCRETE)));
    public static final Block DUEL_CUT_BLACK_CONCRETE_STAIRS = registerBlock("duel_cut_black_concrete_stairs",
            new StairsBlock(DecoBlocks.DUEL_CUT_BLACK_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DUEL_CUT_BLACK_CONCRETE)));
    public static final Block CHECKERED_ORANGE_CONCRETE_STAIRS = registerBlock("checkered_orange_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_ORANGE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_ORANGE_CONCRETE)));
    public static final Block CHECKERED_MAGENTA_CONCRETE_STAIRS = registerBlock("checkered_magenta_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_MAGENTA_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_MAGENTA_CONCRETE)));
    public static final Block CHECKERED_LIGHT_BLUE_CONCRETE_STAIRS = registerBlock("checkered_light_blue_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE)));
    public static final Block CHECKERED_YELLOW_CONCRETE_STAIRS = registerBlock("checkered_yellow_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_YELLOW_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_YELLOW_CONCRETE)));
    public static final Block CHECKERED_LIME_CONCRETE_STAIRS = registerBlock("checkered_lime_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_LIME_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_LIME_CONCRETE)));
    public static final Block CHECKERED_PINK_CONCRETE_STAIRS = registerBlock("checkered_pink_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_PINK_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_PINK_CONCRETE)));
    public static final Block CHECKERED_GRAY_CONCRETE_STAIRS = registerBlock("checkered_gray_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_GRAY_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_GRAY_CONCRETE)));
    public static final Block CHECKERED_LIGHT_GRAY_CONCRETE_STAIRS = registerBlock("checkered_light_gray_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE)));
    public static final Block CHECKERED_CYAN_CONCRETE_STAIRS = registerBlock("checkered_cyan_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_CYAN_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CUT_CYAN_CONCRETE)));
    public static final Block CHECKERED_PURPLE_CONCRETE_STAIRS = registerBlock("checkered_purple_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_PURPLE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_PURPLE_CONCRETE)));
    public static final Block CHECKERED_BLUE_CONCRETE_STAIRS = registerBlock("checkered_blue_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_BLUE_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_BLUE_CONCRETE)));
    public static final Block CHECKERED_BROWN_CONCRETE_STAIRS = registerBlock("checkered_brown_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_BROWN_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_BROWN_CONCRETE)));
    public static final Block CHECKERED_GREEN_CONCRETE_STAIRS = registerBlock("checkered_green_concrete_stairs",
            new StairsBlock(DecoBlocks.CUT_GREEN_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_GREEN_CONCRETE)));
    public static final Block CHECKERED_RED_CONCRETE_STAIRS = registerBlock("checkered_red_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_RED_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_RED_CONCRETE)));
    public static final Block CHECKERED_BLACK_CONCRETE_STAIRS = registerBlock("checkered_black_concrete_stairs",
            new StairsBlock(DecoBlocks.CHECKERED_BLACK_CONCRETE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHECKERED_BLACK_CONCRETE)));
    ...
    public static final Block COBBLED_RED_SANDSTONE_STAIRS = registerBlock("cobbled_red_sandstone_stairs",
            new StairsBlock(DecoBlocks.COBBLED_RED_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.COBBLED_RED_SANDSTONE)));
    public static final Block POLISHED_RED_SANDSTONE_STAIRS = registerBlock("polished_red_sandstone_stairs",
            new StairsBlock(DecoBlocks.POLISHED_RED_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.POLISHED_RED_SANDSTONE)));
    public static final Block RED_SANDSTONE_BRICK_STAIRS = registerBlock("red_sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.RED_SANDSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.RED_SANDSTONE_BRICKS)));
    public static final Block WHITE_SANDSTONE_STAIRS = registerBlock("white_sandstone_stairs",
            new StairsBlock(DecoBlocks.WHITE_SANDSTONE.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.WHITE_SANDSTONE)));
    public static final Block CUT_WHITE_SANDSTONE_STAIRS = registerBlock("cut_white_sandstone_stairs",
            new StairsBlock(DecoBlocks.CUT_WHITE_SANDSTONE.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE)));
    public static final Block CUT_WHITE_SANDSTONE_BRICK_STAIRS = registerBlock("cut_white_sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)));
    public static final Block COBBLED_WHITE_SANDSTONE_STAIRS = registerBlock("cobbled_white_sandstone_stairs",
            new StairsBlock(DecoBlocks.COBBLED_WHITE_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.COBBLED_WHITE_SANDSTONE)));
    public static final Block POLISHED_WHITE_SANDSTONE_STAIRS = registerBlock("polished_white_sandstone_stairs",
            new StairsBlock(DecoBlocks.POLISHED_WHITE_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.POLISHED_WHITE_SANDSTONE)));
    public static final Block WHITE_SANDSTONE_BRICK_STAIRS = registerBlock("white_sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.WHITE_SANDSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.WHITE_SANDSTONE_BRICKS)));
    public static final Block BLACK_SANDSTONE_STAIRS = registerBlock("black_sandstone_stairs",
            new StairsBlock(DecoBlocks.BLACK_SANDSTONE.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.BLACK_SANDSTONE)));
    public static final Block CUT_BLACK_SANDSTONE_STAIRS = registerBlock("cut_black_sandstone_stairs",
            new StairsBlock(DecoBlocks.CUT_BLACK_SANDSTONE.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE)));
    public static final Block CUT_BLACK_SANDSTONE_BRICK_STAIRS = registerBlock("cut_black_sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)));
    public static final Block COBBLED_BLACK_SANDSTONE_STAIRS = registerBlock("cobbled_black_sandstone_stairs",
            new StairsBlock(DecoBlocks.COBBLED_BLACK_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.COBBLED_BLACK_SANDSTONE)));
    public static final Block POLISHED_BLACK_SANDSTONE_STAIRS = registerBlock("polished_black_sandstone_stairs",
            new StairsBlock(DecoBlocks.POLISHED_BLACK_SANDSTONE.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.POLISHED_BLACK_SANDSTONE)));
    public static final Block BLACK_SANDSTONE_BRICK_STAIRS = registerBlock("black_sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.BLACK_SANDSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.BLACK_SANDSTONE_BRICKS)));
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_STAIRS = registerBlock("cracked_red_nether_brick_stairs",
            new StairsBlock(DecoBlocks.CRACKED_RED_NETHER_BRICKS.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CRACKED_RED_NETHER_BRICKS)));
    ...
    public static final Block CRACKED_BLUE_NETHER_BRICK_STAIRS = registerBlock("cracked_blue_nether_brick_stairs",
            new StairsBlock(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)));
    public static final Block HYDRATED_TUBE_CORAL_STAIRS = registerBlock("hydrated_tube_coral_stairs",
            new StairsBlock(DecoBlocks.HYDRATED_TUBE_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.HYDRATED_TUBE_CORAL_BLOCK)));
    public static final Block HYDRATED_BRAIN_CORAL_STAIRS = registerBlock("hydrated_brain_coral_stairs",
            new StairsBlock(DecoBlocks.HYDRATED_BRAIN_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.HYDRATED_BRAIN_CORAL_BLOCK)));
    public static final Block HYDRATED_BUBBLE_CORAL_STAIRS = registerBlock("hydrated_bubble_coral_stairs",
            new StairsBlock(DecoBlocks.HYDRATED_BUBBLE_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.HYDRATED_BUBBLE_CORAL_BLOCK)));
    public static final Block HYDRATED_FIRE_CORAL_STAIRS = registerBlock("hydrated_fire_coral_stairs",
            new StairsBlock(DecoBlocks.HYDRATED_FIRE_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.HYDRATED_FIRE_CORAL_BLOCK)));
    public static final Block HYDRATED_HORN_CORAL_STAIRS = registerBlock("hydrated_horn_coral_stairs",
            new StairsBlock(DecoBlocks.HYDRATED_HORN_CORAL_BLOCK.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.HYDRATED_HORN_CORAL_BLOCK)));
    public static final Block MOSSY_POLISHED_BLACKSTONE_BRICK_STAIRS = registerBlock("mossy_polished_blackstone_brick_stairs",
            new StairsBlock(DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS)));
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_STAIRS = registerBlock("cracked_polished_blackstone_tile_stairs",
            new StairsBlock(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)));
    public static final Block CLOUD_STAIRS = registerBlock("cloud_stairs",
            new TransparentStairsBlock(DecoBlocks.SOLID_CLOUD.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.SOLID_CLOUD)));
    public static final Block CLOUD_BRICK_STAIRS = registerBlock("cloud_brick_stairs",
            new TransparentStairsBlock(DecoBlocks.CLOUD_BRICKS.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CLOUD_BRICKS)));
    public static final Block CRACKED_TUFF_BRICK_STAIRS = registerBlock("cracked_tuff_brick_stairs",
            new StairsBlock(DecoBlocks.CRACKED_TUFF_BRICKS.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_BRICKS)));
    public static final Block MOSSY_TUFF_BRICK_STAIRS = registerBlock("mossy_tuff_brick_stairs",
            new StairsBlock(DecoBlocks.MOSSY_TUFF_BRICKS.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.MOSSY_TUFF_BRICKS)));
    public static final Block TUFF_TILE_STAIRS = registerBlock("tuff_tile_stairs",
            new StairsBlock(DecoBlocks.TUFF_TILES.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.TUFF_TILES)));
    public static final Block CRACKED_TUFF_TILE_STAIRS = registerBlock("cracked_tuff_tile_stairs",
            new StairsBlock(DecoBlocks.CRACKED_TUFF_TILES.getDefaultState(),
                    AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_TILES)));
    ...
    public static final Block CRACKED_TUFF_BRICK_SLAB = registerBlock("cracked_tuff_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_BRICKS)));
    public static final Block MOSSY_TUFF_BRICK_SLAB = registerBlock("mossy_tuff_brick_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.MOSSY_TUFF_BRICKS)));
    public static final Block TUFF_TILE_SLAB = registerBlock("tuff_tile_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.TUFF_TILES)));
    public static final Block CRACKED_TUFF_TILE_SLAB = registerBlock("cracked_tuff_tile_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_TILES)));
    ...
    public static final Block IRON_CAP_MUSHROOM = registerBlock("iron_cap_mushroom",
            new IronCapBlock(DecoSaplingGenerators.IRON_CAP,AbstractBlock.Settings.copy(Blocks.BROWN_MUSHROOM)
                    .mapColor(MapColor.IRON_GRAY)));
    public static final Block POTTED_IRON_CAP_MUSHROOM = registerBlockWithoutItem("potted_iron_cap_mushroom",
            new FlowerPotBlock(IRON_CAP_MUSHROOM,AbstractBlock.Settings.copy(Blocks.POTTED_BROWN_MUSHROOM)));

    public static final Block IRON_CAP_MUSHROOM_BLOCK = registerBlock("iron_cap_mushroom_block",
            new Block(AbstractBlock.Settings.create().strength(4.0F, 6.0F).mapColor(MapColor.IRON_GRAY)
                    .sounds(BlockSoundGroup.CANDLE)));

    public static final Block SPORE_IRON_ORE = registerBlock("spore_iron_ore",
            new Block(AbstractBlock.Settings.create().strength(3.0F, 3.0F).mapColor(MapColor.LICHEN_GREEN)
    ...
    public static final Block CALIFORNIA_POPPY = registerBlock("california_poppy",
            new FlowerBlock(StatusEffects.FIRE_RESISTANCE, 5,AbstractBlock.Settings.copy(Blocks.POPPY)));
    ...
    public static final Block SALMON_POPPY = registerBlock("salmon_poppy",
            new FlowerBlock(StatusEffects.WATER_BREATHING, 7,AbstractBlock.Settings.copy(Blocks.POPPY)));
    ...
    public static final Block ALPINE_POPPY = registerBlock("alpine_poppy",
            new FlowerBlock(StatusEffects.JUMP_BOOST, 5,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_ALPINE_POPPY = registerBlockWithoutItem("potted_alpine_poppy",
            new FlowerPotBlock(ALPINE_POPPY,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block YELLOW_ORCHID = registerBlock("yellow_orchid",
            new FlowerBlock(StatusEffects.SATURATION, 7,AbstractBlock.Settings.copy(Blocks.BLUE_ORCHID)));
    ...
    public static final Block CYAN_ORCHID = registerBlock("cyan_orchid",
            new FlowerBlock(StatusEffects.GLOWING, 7,AbstractBlock.Settings.copy(Blocks.BLUE_ORCHID)));
    public static final Block POTTED_CYAN_ORCHID = registerBlockWithoutItem("potted_cyan_orchid",
            new FlowerPotBlock(CYAN_ORCHID,AbstractBlock.Settings.copy(Blocks.POTTED_BLUE_ORCHID)));

    public static final Block POPPED_BLUET = registerBlock("popped_bluet",
            new DesertFlowerBlock(StatusEffects.SPEED, 5,AbstractBlock.Settings.copy(Blocks.BLUE_ORCHID)));
    public static final Block POTTED_POPPED_BLUET = registerBlockWithoutItem("potted_popped_bluet",
            new FlowerPotBlock(POPPED_BLUET,AbstractBlock.Settings.copy(Blocks.POTTED_BLUE_ORCHID)));

    public static final Block YELLOW_TULIP = registerBlock("yellow_tulip",
            new FlowerBlock(StatusEffects.WEAKNESS, 7,AbstractBlock.Settings.copy(Blocks.RED_TULIP)));
    ...
    public static final Block BLACK_TULIP = registerBlock("black_tulip",
            new FlowerBlock(StatusEffects.WEAKNESS, 15,AbstractBlock.Settings.copy(Blocks.RED_TULIP)));
    ...
    public static final Block DEAD_EYE_DAISY = registerBlock("dead_eye_daisy",
            new DesertFlowerBlock(StatusEffects.STRENGTH, 5,AbstractBlock.Settings.copy(Blocks.OXEYE_DAISY)));
    public static final Block POTTED_DEAD_EYE_DAISY = registerBlockWithoutItem("potted_dead_eye_daisy",
            new FlowerPotBlock(DEAD_EYE_DAISY,AbstractBlock.Settings.copy(Blocks.POTTED_OXEYE_DAISY)));
    public static final Block FELICIA_DAISY = registerBlock("felicia_daisy",
            new DesertFlowerBlock(StatusEffects.HUNGER, 11,AbstractBlock.Settings.copy(Blocks.OXEYE_DAISY)));
    public static final Block POTTED_FELICIA_DAISY = registerBlockWithoutItem("potted_felicia_daisy",
            new FlowerPotBlock(FELICIA_DAISY,AbstractBlock.Settings.copy(Blocks.POTTED_OXEYE_DAISY)));
    ...
    public static final Block FERN_LAVENDER = registerBlock("fern_lavender",
            new FlowerBlock(StatusEffects.SPEED,9,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_FERN_LAVENDER = registerBlockWithoutItem("potted_fern_lavender",
            new FlowerPotBlock(FERN_LAVENDER,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block BLUE_HIBISCUS = registerBlock("blue_hibiscus",
            new FlowerBlock(StatusEffects.ABSORPTION,7,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_BLUE_HIBISCUS = registerBlockWithoutItem("potted_blue_hibiscus",
            new FlowerPotBlock(BLUE_HIBISCUS,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block BROMELIAD = registerBlock("bromeliad",
            new FlowerBlock(StatusEffects.HUNGER,5,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_BROMELIAD = registerBlockWithoutItem("potted_bromeliad",
            new FlowerPotBlock(BROMELIAD,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));
    ...
    public static final Block POTTED_BUTTERCUP = registerBlockWithoutItem("potted_buttercup",
            new FlowerPotBlock(BUTTERCUP,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));
    public static final Block CARAMEL_BUTTERCUP = registerBlock("caramel_buttercup",
            new FlowerBlock(StatusEffects.NAUSEA,3,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_CARAMEL_BUTTERCUP = registerBlockWithoutItem("potted_caramel_buttercup",
            new FlowerPotBlock(CARAMEL_BUTTERCUP,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block NIGHTSHADE = registerBlock("nightshade",
            new FlowerBlock(StatusEffects.INSTANT_DAMAGE,1,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_NIGHTSHADE = registerBlockWithoutItem("potted_nightshade",
            new FlowerPotBlock(NIGHTSHADE,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));
    public static final Block ENDERSHADE = registerBlock("endershade",
            new EnderFlowerBlock(StatusEffects.MINING_FATIGUE,9,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_ENDERSHADE = registerBlockWithoutItem("potted_endershade",
            new FlowerPotBlock(ENDERSHADE,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block IRIS = registerBlock("iris",
            new FlowerBlock(StatusEffects.MINING_FATIGUE,7,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_IRIS = registerBlockWithoutItem("potted_iris",
            new FlowerPotBlock(IRIS,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block BLUE_DELPHINIUM = registerBlock("blue_delphinium",
            new FlowerBlock(StatusEffects.REGENERATION,5,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_BLUE_DELPHINIUM = registerBlockWithoutItem("potted_blue_delphinium",
            new FlowerPotBlock(BLUE_DELPHINIUM,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block ALPINE_SPEEDWELL = registerBlock("alpine_speedwell",
            new FlowerBlock(StatusEffects.SPEED,13,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_ALPINE_SPEEDWELL = registerBlockWithoutItem("potted_alpine_speedwell",
            new FlowerPotBlock(ALPINE_SPEEDWELL,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));

    public static final Block ROSE = registerBlock("rose",
            new FlowerBlock(StatusEffects.POISON, 5,AbstractBlock.Settings.copy(Blocks.POPPY)));
    ...
    public static final Block SILVER_ROSE = registerBlock("silver_rose",
            new SilverRoseBlock(StatusEffects.INSTANT_DAMAGE,1,AbstractBlock.Settings.copy(Blocks.POPPY)));
    public static final Block POTTED_SILVER_ROSE = registerBlockWithoutItem("potted_silver_rose",
            new FlowerPotBlock(SILVER_ROSE,AbstractBlock.Settings.copy(Blocks.POTTED_POPPY)));
    ...
    public static final Block ANCIENT_ROSE = registerBlock("ancient_rose",
            new FlowerBlock(StatusEffects.POISON, 12,AbstractBlock.Settings.copy(Blocks.POPPY)));
    ...
    public static final Block OAK_CRAFTING_TABLE = registerBlock("oak_crafting_table",
            new OakCraftingTableBlock(AbstractBlock.Settings.copy(Blocks.CRAFTING_TABLE).mapColor(MapColor.OAK_TAN)));
    ...
    public static final Block MUSHROOM_CRAFTING_TABLE = registerBlock("mushroom_crafting_table",
            new MushroomCraftingTableBlock(AbstractBlock.Settings.copy(Blocks.CRAFTING_TABLE).mapColor(MapColor.OFF_WHITE)));
    public static final Block IRON_CAP_CRAFTING_TABLE = registerBlock("iron_cap_crafting_table",
            new IronCapCraftingTableBlock(AbstractBlock.Settings.copy(Blocks.CRAFTING_TABLE).mapColor(MapColor.TERRACOTTA_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM)));
    ...
    public static final Block END_STONE_FURNACE = registerBlock("end_stone_furnace",
            new EndstoneFurnaceBlock(AbstractBlock.Settings.copy(Blocks.FURNACE).mapColor(MapColor.PALE_YELLOW)
                    .strength(4.5f)));
    ...
    public static final Block IRON_LADDER = registerBlock("iron_ladder",
            new LadderBlock(AbstractBlock.Settings.copy(Blocks.LADDER).sounds(BlockSoundGroup.METAL)
    ...
    public static final Block COPPER_LADDER = registerBlock("copper_ladder",
            new OxidizableLadderBlock(Oxidizable.OxidationLevel.UNAFFECTED,AbstractBlock.Settings.copy(Blocks.LADDER)
    ...
    public static final Block EXPOSED_COPPER_LADDER = registerBlock("exposed_copper_ladder",
            new OxidizableLadderBlock(Oxidizable.OxidationLevel.EXPOSED,AbstractBlock.Settings.copy(Blocks.LADDER)
                    .sounds(BlockSoundGroup.COPPER).strength(5.0F, 6.0F).requiresTool()));
    public static final Block WEATHERED_COPPER_LADDER = registerBlock("weathered_copper_ladder",
            new OxidizableLadderBlock(Oxidizable.OxidationLevel.WEATHERED,AbstractBlock.Settings.copy(Blocks.LADDER)
                    .sounds(BlockSoundGroup.COPPER).strength(5.0F, 6.0F).requiresTool()));
    public static final Block OXIDIZED_COPPER_LADDER = registerBlock("oxidized_copper_ladder",
            new OxidizableLadderBlock(Oxidizable.OxidationLevel.OXIDIZED,AbstractBlock.Settings.copy(Blocks.LADDER)
                    .sounds(BlockSoundGroup.COPPER).strength(5.0F, 6.0F).requiresTool()));

    public static final Block WAXED_COPPER_LADDER = registerBlock("waxed_copper_ladder",
            new LadderBlock(AbstractBlock.Settings.copy(DecoBlocks.COPPER_LADDER)));
    public static final Block WAXED_EXPOSED_COPPER_LADDER = registerBlock("waxed_exposed_copper_ladder",
            new LadderBlock(AbstractBlock.Settings.copy(DecoBlocks.EXPOSED_COPPER_LADDER)));
    public static final Block WAXED_WEATHERED_COPPER_LADDER = registerBlock("waxed_weathered_copper_ladder",
            new LadderBlock(AbstractBlock.Settings.copy(DecoBlocks.WEATHERED_COPPER_LADDER)));
    public static final Block WAXED_OXIDIZED_COPPER_LADDER = registerBlock("waxed_oxidized_copper_ladder",
            new LadderBlock(AbstractBlock.Settings.copy(DecoBlocks.OXIDIZED_COPPER_LADDER)));

    public static final Block GRASS_CARPET = registerBlock("grass_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).sounds(BlockSoundGroup.GRASS)));
    public static final Block PODZOL_CARPET = registerBlock("podzol_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.SPRUCE_BROWN)
                    .sounds(BlockSoundGroup.GRAVEL)));
    public static final Block CRIMSON_NYLIUM_CARPET = registerBlock("crimson_nylium_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.DULL_RED)
                    .sounds(BlockSoundGroup.NYLIUM)));
    public static final Block WARPED_NYLIUM_CARPET = registerBlock("warped_nylium_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.TEAL)
                    .sounds(BlockSoundGroup.NYLIUM)));
    public static final Block SAND_CARPET = registerBlock("sand_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.PALE_YELLOW)
                    .sounds(BlockSoundGroup.SAND)));
    public static final Block RED_SAND_CARPET = registerBlock("red_sand_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.ORANGE)
                    .sounds(BlockSoundGroup.SAND)));
    public static final Block GRAVEL_CARPET = registerBlock("gravel_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.STONE_GRAY)
                    .sounds(BlockSoundGroup.GRAVEL)));
    public static final Block MYCELIUM_CARPET = registerBlock("mycelium_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.PURPLE)
                    .sounds(BlockSoundGroup.GRASS)));

    public static final Block HAY_CARPET = registerBlock("hay_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.YELLOW)
                    .sounds(BlockSoundGroup.GRASS)));
    public static final Block SCULK_CARPET = registerBlock("sculk_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.BLACK)
                    .sounds(BlockSoundGroup.SCULK)));

    public static final Block WHITE_SAND_CARPET = registerBlock("white_sand_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.OFF_WHITE)
                    .sounds(BlockSoundGroup.SAND)));
    public static final Block BLACK_SAND_CARPET = registerBlock("black_sand_carpet",
            new CarpetBlock(AbstractBlock.Settings.copy(Blocks.MOSS_CARPET).mapColor(MapColor.DEEPSLATE_GRAY)
                    .sounds(BlockSoundGroup.SAND)));

    public static final Block PACKED_CACTUS = registerBlock("packed_cactus",
            new PillarBlock(AbstractBlock.Settings.copy(Blocks.DARK_OAK_WOOD).strength(0.4F).sounds(BlockSoundGroup.WOOL)
                    .mapColor(MapColor.GREEN)));
    public static final Block STRIPPED_CACTUS = registerBlock("stripped_cactus",
            new PillarBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_CACTUS).mapColor(MapColor.PALE_GREEN)));
    ...
    public static final Block MUSHROOM_FENCE = registerBlock("mushroom_fence",
            new FenceBlock(AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS)));
    public static final Block IRON_CAP_FENCE = registerBlock("iron_cap_fence",
            new FenceBlock(AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS)));
    ...
    public static final Block INFESTED_POLISHED_STONE = registerBlock("infested_polished_stone",
            new InfestedBlock(DecoBlocks.POLISHED_STONE, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)));
    public static final Block INFESTED_STONE_TILES = registerBlock("infested_stone_tiles",
            new InfestedBlock(DecoBlocks.STONE_TILES, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)));
    public static final Block INFESTED_CRACKED_STONE_TILES = registerBlock("infested_cracked_stone_tiles",
            new InfestedBlock(DecoBlocks.CRACKED_STONE_TILES, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)));
    public static final Block INFESTED_MOSSY_COBBLESTONE = registerBlock("infested_mossy_cobblestone",
            new InfestedBlock(Blocks.MOSSY_COBBLESTONE, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)));

    public static final Block INFESTED_COBBLED_DEEPSLATE = registerBlock("infested_cobbled_deepslate",
            new InfestedBlock(Blocks.COBBLED_DEEPSLATE, AbstractBlock.Settings.copy(Blocks.INFESTED_DEEPSLATE)
                    .sounds(BlockSoundGroup.DEEPSLATE)));
    public static final Block INFESTED_POLISHED_DEEPSLATE = registerBlock("infested_polished_deepslate",
            new InfestedBlock(Blocks.POLISHED_DEEPSLATE, AbstractBlock.Settings.copy(Blocks.INFESTED_DEEPSLATE)
    ...
    public static final Block INFESTED_DEEPSLATE_BRICKS = registerBlock("infested_deepslate_bricks",
            new InfestedBlock(Blocks.DEEPSLATE_BRICKS, AbstractBlock.Settings.copy(Blocks.INFESTED_DEEPSLATE)
                    .sounds(BlockSoundGroup.DEEPSLATE_BRICKS)));
    public static final Block INFESTED_DEEPSLATE_TILES = registerBlock("infested_deepslate_tiles",
            new InfestedBlock(Blocks.DEEPSLATE_TILES, AbstractBlock.Settings.copy(Blocks.INFESTED_DEEPSLATE)
                    .sounds(BlockSoundGroup.DEEPSLATE_TILES)));
    public static final Block INFESTED_CRACKED_DEEPSLATE_BRICKS = registerBlock("infested_cracked_deepslate_bricks",
            new InfestedBlock(Blocks.CRACKED_DEEPSLATE_BRICKS, AbstractBlock.Settings.copy(Blocks.INFESTED_DEEPSLATE)
                    .sounds(BlockSoundGroup.DEEPSLATE_BRICKS)));
    public static final Block INFESTED_MOSSY_DEEPSLATE_BRICKS = registerBlock("infested_mossy_deepslate_bricks",
            new InfestedBlock(DecoBlocks.MOSSY_DEEPSLATE_BRICKS, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_CRACKED_DEEPSLATE_BRICKS)));
    public static final Block INFESTED_CRACKED_DEEPSLATE_TILES = registerBlock("infested_cracked_deepslate_tiles",
            new InfestedBlock(Blocks.CRACKED_DEEPSLATE_TILES, AbstractBlock.Settings.copy(Blocks.INFESTED_DEEPSLATE)
                    .sounds(BlockSoundGroup.DEEPSLATE_TILES)));
    public static final Block INFESTED_CHISELED_DEEPSLATE = registerBlock("infested_chiseled_deepslate",
            new InfestedBlock(Blocks.CHISELED_DEEPSLATE, AbstractBlock.Settings.copy(Blocks.INFESTED_DEEPSLATE)
                    .sounds(BlockSoundGroup.DEEPSLATE_BRICKS)));

    public static final Block INFESTED_CALCITE = registerBlock("infested_calcite",
            new InfestedBlock(Blocks.CALCITE, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
    ...
    public static final Block INFESTED_POLISHED_CALCITE = registerBlock("infested_polished_calcite",
            new InfestedBlock(DecoBlocks.POLISHED_CALCITE, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_CALCITE)));
    public static final Block INFESTED_CUT_CALCITE = registerBlock("infested_cut_calcite",
            new InfestedBlock(DecoBlocks.CUT_CALCITE, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_CALCITE)));
    public static final Block INFESTED_CALCITE_BRICKS = registerBlock("infested_calcite_bricks",
            new InfestedBlock(DecoBlocks.CALCITE_BRICKS, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_CALCITE)));
    ...
    public static final Block INFESTED_POLISHED_GRANITE = registerBlock("infested_polished_granite",
            new InfestedBlock(Blocks.POLISHED_GRANITE, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.DIRT_BROWN)));
    public static final Block INFESTED_CUT_GRANITE = registerBlock("infested_cut_granite",
            new InfestedBlock(DecoBlocks.CUT_GRANITE, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_GRANITE)));
    public static final Block INFESTED_GRANITE_BRICKS = registerBlock("infested_granite_bricks",
            new InfestedBlock(DecoBlocks.GRANITE_BRICKS, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_GRANITE)));
    ...
    public static final Block INFESTED_POLISHED_DIORITE = registerBlock("infested_polished_diorite",
            new InfestedBlock(Blocks.POLISHED_DIORITE, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.OFF_WHITE)));
    public static final Block INFESTED_CUT_DIORITE = registerBlock("infested_cut_diorite",
            new InfestedBlock(DecoBlocks.CUT_DIORITE, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_DIORITE)));
    public static final Block INFESTED_DIORITE_BRICKS = registerBlock("infested_diorite_bricks",
            new InfestedBlock(DecoBlocks.DIORITE_BRICKS, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_DIORITE)));
    ...
    public static final Block INFESTED_CUT_ANDESITE = registerBlock("infested_cut_andesite",
            new InfestedBlock(DecoBlocks.CUT_ANDESITE, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_ANDESITE)));
    public static final Block INFESTED_ANDESITE_BRICKS = registerBlock("infested_andesite_bricks",
            new InfestedBlock(DecoBlocks.ANDESITE_BRICKS, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_ANDESITE)));

    public static final Block INFESTED_BLACKSTONE = registerBlock("infested_blackstone",
            new InfestedBlock(Blocks.BLACKSTONE, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.BLACK)));
    public static final Block INFESTED_POLISHED_BLACKSTONE = registerBlock("infested_polished_blackstone",
            new InfestedBlock(Blocks.POLISHED_BLACKSTONE, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.BLACK)));
    public static final Block INFESTED_POLISHED_BLACKSTONE_BRICKS = registerBlock("infested_polished_blackstone_bricks",
            new InfestedBlock(Blocks.POLISHED_BLACKSTONE_BRICKS, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.BLACK)));
    public static final Block INFESTED_MOSSY_POLISHED_BLACKSTONE_BRICKS = registerBlock("infested_mossy_polished_blackstone_bricks",
            new InfestedBlock(DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS, AbstractBlock.Settings.copy(DecoBlocks.INFESTED_POLISHED_BLACKSTONE_BRICKS)));
    public static final Block INFESTED_POLISHED_BLACKSTONE_TILES = registerBlock("infested_polished_blackstone_tiles",
            new InfestedBlock(DecoBlocks.POLISHED_BLACKSTONE_TILES, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.BLACK)));
    public static final Block INFESTED_CRACKED_POLISHED_BLACKSTONE_TILES = registerBlock("infested_cracked_polished_blackstone_tiles",
            new InfestedBlock(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.BLACK)));
    public static final Block INFESTED_CRACKED_POLISHED_BLACKSTONE_BRICKS = registerBlock("infested_cracked_polished_blackstone_bricks",
            new InfestedBlock(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, AbstractBlock.Settings.copy(Blocks.INFESTED_COBBLESTONE)
                    .mapColor(MapColor.BLACK)));
    ...
    public static final Block LIGHT_GOLD_BARS = registerBlock("light_gold_bars",
            new PaneBlock(AbstractBlock.Settings.copy(DecoBlocks.LIGHT_IRON_BARS).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block GOLD_BARS = registerBlock("gold_bars",
            new PaneBlock(AbstractBlock.Settings.copy(Blocks.IRON_BARS).sounds(BlockSoundGroup.METAL)));
    ...
    public static final Block HEAVY_GOLD_BARS = registerBlock("heavy_gold_bars",
            new PaneBlock(AbstractBlock.Settings.copy(DecoBlocks.HEAVY_IRON_BARS).sounds(BlockSoundGroup.METAL)
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE = registerBlock("cracked_red_nether_brick_fence",
            new FenceBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_RED_NETHER_BRICKS)));
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE = registerBlock("cracked_blue_nether_brick_fence",
            new FenceBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)));
    ...
    public static final Block BAMBOO_BLOCK_WALL = registerBlock("bamboo_block_wall",
            new WallBlock(AbstractBlock.Settings.copy(Blocks.BAMBOO_PLANKS).mapColor(MapColor.DARK_GREEN)));
    ...
    public static final Block STRIPPED_IRON_CAP_HYPHAE_WALL = registerBlock("stripped_iron_cap_hyphae_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS)));public static final Block STRIPPED_BAMBOO_WALL = registerBlock("stripped_bamboo_wall",
    ...
    public static final Block CRACKED_DEEPSLATE_TILE_WALL = registerBlock("cracked_deepslate_tile_wall",
            new WallBlock(AbstractBlock.Settings.copy(Blocks.CRACKED_DEEPSLATE_TILES)));
    ...
    public static final Block TUBE_CORAL_WALL = registerBlock("tube_coral_wall",
            new CoralWallBlock(DEAD_TUBE_CORAL_WALL, AbstractBlock.Settings.copy(Blocks.TUBE_CORAL_BLOCK)));
    public static final Block BRAIN_CORAL_WALL = registerBlock("brain_coral_wall",
            new CoralWallBlock(DEAD_BRAIN_CORAL_WALL, AbstractBlock.Settings.copy(Blocks.DEAD_BRAIN_CORAL_BLOCK)));
    public static final Block BUBBLE_CORAL_WALL = registerBlock("bubble_coral_wall",
            new CoralWallBlock(DEAD_BUBBLE_CORAL_WALL,AbstractBlock.Settings.copy(Blocks.BUBBLE_CORAL_BLOCK)));
    public static final Block FIRE_CORAL_WALL = registerBlock("fire_coral_wall",
            new CoralWallBlock(DEAD_FIRE_CORAL_WALL,AbstractBlock.Settings.copy(Blocks.FIRE_CORAL_BLOCK)));
    public static final Block HORN_CORAL_WALL = registerBlock("horn_coral_wall",
            new CoralWallBlock(DEAD_HORN_CORAL_WALL,AbstractBlock.Settings.copy(Blocks.HORN_CORAL_BLOCK)));
    ...
    public static final Block COBBLED_SANDSTONE_WALL = registerBlock("cobbled_sandstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.COBBLED_SANDSTONE)));
    public static final Block POLISHED_SANDSTONE_WALL = registerBlock("polished_sandstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.POLISHED_SANDSTONE)));
    public static final Block SANDSTONE_BRICK_WALL = registerBlock("sandstone_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SANDSTONE_BRICKS)));
    public static final Block SMOOTH_LAPIS_WALL = registerBlock("smooth_lapis_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_LAPIS)));
    public static final Block SMOOTH_OBSIDIAN_WALL = registerBlock("smooth_obsidian_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_OBSIDIAN)));
    ...
    public static final Block SMOOTH_WHITE_SANDSTONE_WALL = registerBlock("smooth_white_sandstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_WHITE_SANDSTONE)));
    public static final Block SMOOTH_BLACK_SANDSTONE_WALL = registerBlock("smooth_black_sandstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_BLACK_SANDSTONE)));
    ...
    public static final Block SMOOTH_END_STONE_WALL = registerBlock("smooth_end_stone_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SMOOTH_END_STONE)));
    public static final Block SANDED_OBSIDIAN_WALL = registerBlock("sanded_obsidian_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SANDED_OBSIDIAN)));
    ...
    public static final Block CUT_OBSIDIAN_WALL = registerBlock("cut_obsidian_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_OBSIDIAN)));
    public static final Block CUT_PURPUR_WALL = registerBlock("cut_purpur_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.CUT_PURPUR)));
    ...
    public static final Block PACKED_NETHERRACK_WALL = registerBlock("packed_netherrack_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.PACKED_NETHERRACK)));
    public static final Block NETHERRACK_BRICK_WALL = registerBlock("netherrack_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.NETHERRACK_BRICKS)));
    ...
    public static final Block VOID_STONE_BRICK_PILLAR_WALL = registerBlock("void_stone_brick_pillar_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.VOID_STONE_BRICK_PILLAR)));
    ...
    public static final Block COBBLED_SOUL_SOILSTONE_WALL = registerBlock("cobbled_soul_soilstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.COBBLED_SOUL_SOILSTONE)));
    public static final Block POLISHED_SOUL_SOILSTONE_WALL = registerBlock("polished_soul_soilstone_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.POLISHED_SOUL_SOILSTONE)));
    public static final Block SOUL_SOILSTONE_BRICK_WALL = registerBlock("soul_soilstone_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.SOUL_SOILSTONE_BRICKS)));
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_WALL = registerBlock("cracked_red_nether_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_RED_NETHER_BRICKS)));
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_WALL = registerBlock("cracked_polished_blackstone_tile_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)));
    public static final Block CLOUD_WALL = registerBlock("cloud_wall",
            new TransparentWallBlock(AbstractBlock.Settings.copy(DecoBlocks.SOLID_CLOUD)));
    public static final Block CLOUD_BRICK_WALL = registerBlock("cloud_brick_wall",
            new TransparentWallBlock(AbstractBlock.Settings.copy(DecoBlocks.CLOUD_BRICKS)));
    public static final Block CRACKED_TUFF_BRICK_WALL = registerBlock("cracked_tuff_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_BRICKS)));
    public static final Block MOSSY_TUFF_BRICK_WALL = registerBlock("mossy_tuff_brick_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.MOSSY_TUFF_BRICKS)));
    ...
    public static final Block CRACKED_TUFF_TILE_WALL = registerBlock("cracked_tuff_tile_wall",
            new WallBlock(AbstractBlock.Settings.copy(DecoBlocks.CRACKED_TUFF_TILES)));
    ...
    public static final Block GLOWING_GLASS_PANE = registerBlock("glowing_glass_pane",
            new PaneBlock(AbstractBlock.Settings.copy(Blocks.GLASS_PANE).nonOpaque().luminance(state -> 15)));
    ...
    public static final Block HARDENED_TINTED_GLASS_PANE = registerBlock("hardened_tinted_glass_pane",
            new TintedGlassPaneBlock(AbstractBlock.Settings.copy(DecoBlocks.TINTED_GLASS_PANE).strength(25.0F,100.0f)
                    .nonOpaque().requiresTool()));
    public static final Block HARDENED_GLOWING_GLASS_PANE = registerBlock("hardened_glowing_glass_pane",
            new PaneBlock(AbstractBlock.Settings.copy(DecoBlocks.HARDENED_GLASS_PANE).luminance(state -> 15)
                    .nonOpaque()));
    ...
    public static final Block MUSHROOM_BARREL = registerBlock("mushroom_barrel",
            new MushroomBarrelBlock(AbstractBlock.Settings.copy(Blocks.BARREL).mapColor(MapColor.RAW_IRON_PINK)));
    public static final Block IRON_CAP_BARREL = registerBlock("iron_cap_barrel",
            new IronCapBarrelBlock(AbstractBlock.Settings.copy(Blocks.BARREL).mapColor(MapColor.LIGHT_BLUE_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM)));
    ...
    public static final Block MUSHROOM_BOOKSHELF = registerBlock("mushroom_bookshelf",
            new Block(AbstractBlock.Settings.copy(Blocks.BOOKSHELF).mapColor(MapColor.RAW_IRON_PINK)));
    public static final Block IRON_CAP_BOOKSHELF = registerBlock("iron_cap_bookshelf",
            new Block(AbstractBlock.Settings.copy(Blocks.BOOKSHELF).mapColor(MapColor.LIGHT_BLUE_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block OAK_BOOKSHELF_STAIRS = registerBlock("oak_bookshelf_stairs",
            new StairsBlock(DecoBlocks.OAK_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.OAK_BOOKSHELF)));
    public static final Block OAK_BOOKSHELF_SLAB = registerBlock("oak_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.OAK_BOOKSHELF)));

    public static final Block SPRUCE_BOOKSHELF_STAIRS = registerBlock("spruce_bookshelf_stairs",
            new StairsBlock(DecoBlocks.SPRUCE_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.SPRUCE_BOOKSHELF)));
    public static final Block SPRUCE_BOOKSHELF_SLAB = registerBlock("spruce_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.SPRUCE_BOOKSHELF)));

    public static final Block BIRCH_BOOKSHELF_STAIRS = registerBlock("birch_bookshelf_stairs",
            new StairsBlock(DecoBlocks.BIRCH_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.BIRCH_BOOKSHELF)));
    public static final Block BIRCH_BOOKSHELF_SLAB = registerBlock("birch_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.BIRCH_BOOKSHELF)));

    public static final Block JUNGLE_BOOKSHELF_STAIRS = registerBlock("jungle_bookshelf_stairs",
            new StairsBlock(DecoBlocks.JUNGLE_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.JUNGLE_BOOKSHELF)));
    public static final Block JUNGLE_BOOKSHELF_SLAB = registerBlock("jungle_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.JUNGLE_BOOKSHELF)));

    public static final Block DARK_OAK_BOOKSHELF_STAIRS = registerBlock("dark_oak_bookshelf_stairs",
            new StairsBlock(DecoBlocks.DARK_OAK_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.DARK_OAK_BOOKSHELF)));
    public static final Block DARK_OAK_BOOKSHELF_SLAB = registerBlock("dark_oak_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.DARK_OAK_BOOKSHELF)));

    public static final Block ACACIA_BOOKSHELF_STAIRS = registerBlock("acacia_bookshelf_stairs",
            new StairsBlock(DecoBlocks.ACACIA_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.ACACIA_BOOKSHELF)));
    public static final Block ACACIA_BOOKSHELF_SLAB = registerBlock("acacia_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.ACACIA_BOOKSHELF)));

    public static final Block MANGROVE_BOOKSHELF_STAIRS = registerBlock("mangrove_bookshelf_stairs",
            new StairsBlock(DecoBlocks.MANGROVE_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.MANGROVE_BOOKSHELF)));
    public static final Block MANGROVE_BOOKSHELF_SLAB = registerBlock("mangrove_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.MANGROVE_BOOKSHELF)));

    public static final Block CHERRY_BOOKSHELF_STAIRS = registerBlock("cherry_bookshelf_stairs",
            new StairsBlock(DecoBlocks.CHERRY_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CHERRY_BOOKSHELF)));
    public static final Block CHERRY_BOOKSHELF_SLAB = registerBlock("cherry_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CHERRY_BOOKSHELF)));

    public static final Block BAMBOO_BOOKSHELF_STAIRS = registerBlock("bamboo_bookshelf_stairs",
            new StairsBlock(DecoBlocks.BAMBOO_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.BAMBOO_BOOKSHELF)));
    public static final Block BAMBOO_BOOKSHELF_SLAB = registerBlock("bamboo_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.BAMBOO_BOOKSHELF)));

    public static final Block CRIMSON_BOOKSHELF_STAIRS = registerBlock("crimson_bookshelf_stairs",
            new StairsBlock(DecoBlocks.CRIMSON_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CRIMSON_BOOKSHELF)));
    public static final Block CRIMSON_BOOKSHELF_SLAB = registerBlock("crimson_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CRIMSON_BOOKSHELF)));

    public static final Block WARPED_BOOKSHELF_STAIRS = registerBlock("warped_bookshelf_stairs",
            new StairsBlock(DecoBlocks.WARPED_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.WARPED_BOOKSHELF)));
    public static final Block WARPED_BOOKSHELF_SLAB = registerBlock("warped_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.WARPED_BOOKSHELF)));

    public static final Block CACTUS_BOOKSHELF_STAIRS = registerBlock("cactus_bookshelf_stairs",
            new StairsBlock(DecoBlocks.CACTUS_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.CACTUS_BOOKSHELF)));
    public static final Block CACTUS_BOOKSHELF_SLAB = registerBlock("cactus_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.CACTUS_BOOKSHELF)));

    public static final Block MUSHROOM_BOOKSHELF_STAIRS = registerBlock("mushroom_bookshelf_stairs",
            new StairsBlock(DecoBlocks.MUSHROOM_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_BOOKSHELF)));
    public static final Block MUSHROOM_BOOKSHELF_SLAB = registerBlock("mushroom_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_BOOKSHELF)));

    public static final Block IRON_CAP_BOOKSHELF_STAIRS = registerBlock("iron_cap_bookshelf_stairs",
            new StairsBlock(DecoBlocks.IRON_CAP_BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_BOOKSHELF)));
    public static final Block IRON_CAP_BOOKSHELF_SLAB = registerBlock("iron_cap_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_BOOKSHELF)));

    public static final Block WOODEN_BOOKSHELF_STAIRS = registerBlock("wooden_bookshelf_stairs",
            new StairsBlock(Blocks.BOOKSHELF.getDefaultState(),AbstractBlock.Settings.copy(Blocks.BOOKSHELF)));
    public static final Block WOODEN_BOOKSHELF_SLAB = registerBlock("wooden_bookshelf_slab",
            new SlabBlock(AbstractBlock.Settings.copy(Blocks.BOOKSHELF)));
    ...
    public static final Block END_STONE_SMOKER = registerBlock("end_stone_smoker",
            new EndstoneSmokerBlock(AbstractBlock.Settings.copy(Blocks.SMOKER).mapColor(MapColor.PALE_YELLOW)
                    .strength(4.5f)));
    ...
    public static final Block END_STONE_BLAST_FURNACE = registerBlock("end_stone_blast_furnace",
            new EndstoneBlastFurnaceBlock(AbstractBlock.Settings.copy(Blocks.BLAST_FURNACE).mapColor(MapColor.PALE_YELLOW)
                    .strength(4.5f)));
    ...
    public static final Block MUSHROOM_CARTOGRAPHY_TABLE = registerBlock("mushroom_cartography_table",
            new MushroomCartographyTableBlock(AbstractBlock.Settings.copy(Blocks.CARTOGRAPHY_TABLE)));
    public static final Block IRON_CAP_CARTOGRAPHY_TABLE = registerBlock("iron_cap_cartography_table",
            new IronCapCartographyTableBlock(AbstractBlock.Settings.copy(Blocks.CARTOGRAPHY_TABLE)
                    .sounds(BlockSoundGroup.NETHER_STEM)));

    public static final Block DEEPSLATE_GRINDSTONE = registerBlock("deepslate_grindstone",
            new DeepslateGrindstoneBlock(AbstractBlock.Settings.copy(Blocks.GRINDSTONE).sounds(BlockSoundGroup.DEEPSLATE)
                    .mapColor(MapColor.DEEPSLATE_GRAY)));
    public static final Block BLACKSTONE_GRINDSTONE = registerBlock("blackstone_grindstone",
            new BlackstoneGrindstoneBlock(AbstractBlock.Settings.copy(Blocks.GRINDSTONE).mapColor(MapColor.BLACK)));
    public static final Block TUFF_GRINDSTONE = registerBlock("tuff_grindstone",
            new TuffGrindstoneBlock(AbstractBlock.Settings.copy(Blocks.GRINDSTONE).mapColor(MapColor.TERRACOTTA_GRAY)
                    .sounds(BlockSoundGroup.TUFF)));
    public static final Block END_STONE_GRINDSTONE = registerBlock("end_stone_grindstone",
            new EndstoneGrindstoneBlock(AbstractBlock.Settings.copy(Blocks.GRINDSTONE).mapColor(MapColor.PALE_YELLOW)));
    ...
    public static final Block MUSHROOM_SMITHING_TABLE = registerBlock("mushroom_smithing_table",
            new MushroomSmithingTableBlock(AbstractBlock.Settings.copy(Blocks.SMITHING_TABLE)));
    public static final Block IRON_CAP_SMITHING_TABLE = registerBlock("iron_cap_smithing_table",
            new IronCapSmithingTableBlock(AbstractBlock.Settings.copy(Blocks.SMITHING_TABLE)
                    .sounds(BlockSoundGroup.NETHER_STEM)));
    ...
    public static final Block END_STONE_STONECUTTER = registerBlock("end_stone_stonecutter",
            new EndstoneStonecutterBlock(AbstractBlock.Settings.copy(Blocks.STONECUTTER).mapColor(MapColor.PALE_YELLOW)
                    .strength(4.5f)));
    ...
    public static final Block HANGING_LAMP = registerBlock("hanging_lamp",
            new HangingLampBlock(AbstractBlock.Settings.copy(Blocks.LANTERN)));

    public static final Block HANGING_WHITE_LAMP = registerBlock("hanging_white_lamp",
            new HangingLampBlock(AbstractBlock.Settings.copy(DecoBlocks.HANGING_LAMP)));
    ...
    public static final Block BUBBLE_ELEVATOR_BLOCK_BUBBLE = registerBlock("bubble_elevator_block_bubble",
            new BubbleElevatorBubbleBlock(AbstractBlock.Settings.copy(Blocks.WAXED_COPPER_BLOCK).resistance(25.0f)
    ...
    public static final Block BUBBLE_ELEVATOR_BLOCK_MAGMA = registerBlockWithoutItem("bubble_elevator_block_magma",
            new BubbleElevatorMagmaBlock(AbstractBlock.Settings.copy(Blocks.WAXED_COPPER_BLOCK).resistance(25.0f)
    ...
    public static final Block STONE_LEVER = registerBlock("stone_lever",
            new LeverBlock(AbstractBlock.Settings.copy(Blocks.LEVER)));
    public static final Block DEEPSLATE_LEVER = registerBlock("deepslate_lever",
            new LeverBlock(AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.DEEPSLATE)));
    ...
    public static final Block POLISHED_DEEPSLATE_LEVER = registerBlock("polished_deepslate_lever",
            new LeverBlock(AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.POLISHED_DEEPSLATE)));
    ...
    public static final Block TUFF_LEVER = registerBlock("tuff_lever",
            new LeverBlock(AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.TUFF)));
    public static final Block POLISHED_TUFF_LEVER = registerBlock("polished_tuff_lever",
            new LeverBlock(AbstractBlock.Settings.copy(Blocks.LEVER).sounds(BlockSoundGroup.POLISHED_TUFF)));
    ...
    public static final Block OAK_NOTE_BLOCK = registerBlock("oak_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.OAK_TAN)));
    public static final Block SPRUCE_NOTE_BLOCK = registerBlock("spruce_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.SPRUCE_BROWN)));
    public static final Block BIRCH_NOTE_BLOCK = registerBlock("birch_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.PALE_YELLOW)));
    public static final Block JUNGLE_NOTE_BLOCK = registerBlock("jungle_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.DIRT_BROWN)));
    public static final Block ACACIA_NOTE_BLOCK = registerBlock("acacia_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.ORANGE)));
    public static final Block DARK_OAK_NOTE_BLOCK = registerBlock("dark_oak_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.BROWN)));
    public static final Block MANGROVE_NOTE_BLOCK = registerBlock("mangrove_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.RED)));
    public static final Block CHERRY_NOTE_BLOCK = registerBlock("cherry_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.TERRACOTTA_WHITE)
                    .sounds(BlockSoundGroup.CHERRY_WOOD)));
    public static final Block BAMBOO_NOTE_BLOCK = registerBlock("bamboo_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.YELLOW)
                    .sounds(BlockSoundGroup.BAMBOO_WOOD)));
    public static final Block CRIMSON_NOTE_BLOCK = registerBlock("crimson_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.DULL_PINK)
                    .sounds(BlockSoundGroup.NETHER_WOOD)));
    public static final Block WARPED_NOTE_BLOCK = registerBlock("warped_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.DARK_AQUA)
                    .sounds(BlockSoundGroup.NETHER_WOOD)));
    public static final Block CACTUS_NOTE_BLOCK = registerBlock("cactus_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.PALE_GREEN)));
    public static final Block MUSHROOM_NOTE_BLOCK = registerBlock("mushroom_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.RAW_IRON_PINK)));
    public static final Block IRON_CAP_NOTE_BLOCK = registerBlock("iron_cap_note_block",
            new NoteBlock(AbstractBlock.Settings.copy(Blocks.NOTE_BLOCK).mapColor(MapColor.LIGHT_BLUE_GRAY)
                    .sounds(BlockSoundGroup.NETHER_STEM)));
    ...
    public static final Block END_STONE_BUTTON = registerBlock("end_stone_button",
            new ButtonBlock(DecoBlockSets.END_STONE, 20, AbstractBlock.Settings.copy(Blocks.STONE_BUTTON)));
    ...
    public static final Block MUSHROOM_BUTTON = registerBlock("mushroom_button",
            new ButtonBlock(DecoBlockSets.MUSHROOM, 30, AbstractBlock.Settings.copy(Blocks.OAK_BUTTON)));
    public static final Block IRON_CAP_BUTTON = registerBlock("iron_cap_button",
            new ButtonBlock(DecoBlockSets.IRON_CAP, 50, AbstractBlock.Settings.copy(Blocks.OAK_BUTTON)
                    .sounds(BlockSoundGroup.NETHER_WOOD)));
    ...
    public static final Block END_STONE_PRESSURE_PLATE = registerBlock("end_stone_pressure_plate",
            new PressurePlateBlock(DecoBlockSets.END_STONE, AbstractBlock.Settings.copy(Blocks.STONE_PRESSURE_PLATE)
    ...
    public static final Block MUSHROOM_PRESSURE_PLATE = registerBlock("mushroom_pressure_plate",
            new PressurePlateBlock(DecoBlockSets.MUSHROOM, AbstractBlock.Settings.copy(Blocks.OAK_PRESSURE_PLATE).mapColor(MapColor.PALE_YELLOW)));
    public static final Block IRON_CAP_PRESSURE_PLATE = registerBlock("iron_cap_pressure_plate",
            new PressurePlateBlock(DecoBlockSets.IRON_CAP, AbstractBlock.Settings.copy(Blocks.OAK_PRESSURE_PLATE).mapColor(MapColor.LIGHT_BLUE_GRAY)
                                .sounds(BlockSoundGroup.NETHER_WOOD)));
    ...
    public static final Block GOLD_BAR_DOOR = registerBlock("gold_bar_door",
            new DoorBlock(BlockSetType.GOLD, AbstractBlock.Settings.copy(DecoBlocks.GOLD_DOOR).nonOpaque()));

    public static final Block COPPER_BAR_DOOR = registerBlock("copper_bar_door",
            new OxidizableDoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED,
                    AbstractBlock.Settings.copy(Blocks.COPPER_DOOR).nonOpaque()));
    public static final Block EXPOSED_COPPER_BAR_DOOR = registerBlock("exposed_copper_bar_door",
            new OxidizableDoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.EXPOSED,
                    AbstractBlock.Settings.copy(Blocks.EXPOSED_COPPER_DOOR).nonOpaque()));
    public static final Block WEATHERED_COPPER_BAR_DOOR = registerBlock("weathered_copper_bar_door",
            new OxidizableDoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED,
                    AbstractBlock.Settings.copy(Blocks.WEATHERED_COPPER_DOOR).nonOpaque()));
    public static final Block OXIDIZED_COPPER_BAR_DOOR = registerBlock("oxidized_copper_bar_door",
            new OxidizableDoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.OXIDIZED,
                    AbstractBlock.Settings.copy(Blocks.OXIDIZED_COPPER_DOOR).nonOpaque()));

    public static final Block WAXED_COPPER_BAR_DOOR = registerBlock("waxed_copper_bar_door",
            new DoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.COPPER_BAR_DOOR).nonOpaque()));
    public static final Block WAXED_EXPOSED_COPPER_BAR_DOOR = registerBlock("waxed_exposed_copper_bar_door",
            new DoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.EXPOSED_COPPER_BAR_DOOR).nonOpaque()));
    public static final Block WAXED_WEATHERED_COPPER_BAR_DOOR = registerBlock("waxed_weathered_copper_bar_door",
            new DoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.WEATHERED_COPPER_BAR_DOOR).nonOpaque()));
    public static final Block WAXED_OXIDIZED_COPPER_BAR_DOOR = registerBlock("waxed_oxidized_copper_bar_door",
            new DoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.OXIDIZED_COPPER_BAR_DOOR).nonOpaque()));
    ...
    public static final Block MUSHROOM_DOOR = registerBlock("mushroom_door",
            new DoorBlock(DecoBlockSets.MUSHROOM, AbstractBlock.Settings.copy(Blocks.OAK_DOOR).mapColor(MapColor.PALE_YELLOW).nonOpaque()));
    public static final Block IRON_CAP_DOOR = registerBlock("iron_cap_door",
            new DoorBlock(DecoBlockSets.IRON_CAP, AbstractBlock.Settings.copy(Blocks.OAK_DOOR).sounds(BlockSoundGroup.NETHER_WOOD)
    ...
    public static final Block SPRUCE_PALLET_DOOR = registerBlock("spruce_pallet_door",
            new DoorBlock(BlockSetType.SPRUCE, AbstractBlock.Settings.copy(Blocks.SPRUCE_DOOR).nonOpaque()));
    ...
    public static final Block JUNGLE_PALLET_DOOR = registerBlock("jungle_pallet_door",
            new DoorBlock(BlockSetType.JUNGLE, AbstractBlock.Settings.copy(Blocks.JUNGLE_DOOR).nonOpaque()));
    public static final Block ACACIA_PALLET_DOOR = registerBlock("acacia_pallet_door",
            new DoorBlock(BlockSetType.ACACIA, AbstractBlock.Settings.copy(Blocks.ACACIA_DOOR).nonOpaque()));
    public static final Block DARK_OAK_PALLET_DOOR = registerBlock("dark_oak_pallet_door",
            new DoorBlock(BlockSetType.DARK_OAK, AbstractBlock.Settings.copy(Blocks.DARK_OAK_DOOR).nonOpaque()));
    ...
    public static final Block BAMBOO_PALLET_DOOR = registerBlock("bamboo_pallet_door",
            new DoorBlock(BlockSetType.BAMBOO, AbstractBlock.Settings.copy(Blocks.BAMBOO_DOOR).nonOpaque()));
    public static final Block CRIMSON_PALLET_DOOR = registerBlock("crimson_pallet_door",
            new DoorBlock(BlockSetType.CRIMSON, AbstractBlock.Settings.copy(Blocks.CRIMSON_DOOR).nonOpaque()));
    public static final Block WARPED_PALLET_DOOR = registerBlock("warped_pallet_door",
            new DoorBlock(BlockSetType.WARPED, AbstractBlock.Settings.copy(Blocks.MANGROVE_DOOR).nonOpaque()));

    public static final Block CACTUS_PALLET_DOOR = registerBlock("cactus_pallet_door",
            new DoorBlock(DecoBlockSets.CACUTS, AbstractBlock.Settings.copy(DecoBlocks.CACTUS_DOOR).nonOpaque()));
    public static final Block MUSHROOM_PALLET_DOOR = registerBlock("mushroom_pallet_door",
            new DoorBlock(DecoBlockSets.MUSHROOM, AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_DOOR).nonOpaque()));
    public static final Block IRON_CAP_PALLET_DOOR = registerBlock("iron_cap_pallet_door",
            new DoorBlock(DecoBlockSets.IRON_CAP, AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_DOOR).nonOpaque()));
    public static final Block WOODEN_PALLET_DOOR = registerBlock("wooden_pallet_door",
            new DoorBlock(DecoBlockSets.WOODEN, AbstractBlock.Settings.copy(DecoBlocks.WOODEN_DOOR).nonOpaque()));
    ...
    public static final Block GOLD_BAR_TRAPDOOR = registerBlock("gold_bar_trapdoor",
            new TrapdoorBlock(BlockSetType.GOLD, AbstractBlock.Settings.copy(DecoBlocks.GOLD_TRAPDOOR).nonOpaque()));

    public static final Block COPPER_BAR_TRAPDOOR = registerBlock("copper_bar_trapdoor",
            new OxidizableTrapdoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED,
                    AbstractBlock.Settings.copy(Blocks.COPPER_TRAPDOOR).nonOpaque()));
    public static final Block EXPOSED_COPPER_BAR_TRAPDOOR = registerBlock("exposed_copper_bar_trapdoor",
            new OxidizableTrapdoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.EXPOSED,
                    AbstractBlock.Settings.copy(Blocks.EXPOSED_COPPER_TRAPDOOR).nonOpaque()));
    public static final Block WEATHERED_COPPER_BAR_TRAPDOOR = registerBlock("weathered_copper_bar_trapdoor",
            new OxidizableTrapdoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.UNAFFECTED,
                    AbstractBlock.Settings.copy(Blocks.WEATHERED_COPPER_TRAPDOOR).nonOpaque()));
    public static final Block OXIDIZED_COPPER_BAR_TRAPDOOR = registerBlock("oxidized_copper_bar_trapdoor",
            new OxidizableTrapdoorBlock(BlockSetType.COPPER, Oxidizable.OxidationLevel.OXIDIZED,
                    AbstractBlock.Settings.copy(Blocks.OXIDIZED_COPPER_TRAPDOOR).nonOpaque()));

    public static final Block WAXED_COPPER_BAR_TRAPDOOR = registerBlock("waxed_copper_bar_trapdoor",
            new TrapdoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.COPPER_BAR_TRAPDOOR).nonOpaque()));
    public static final Block WAXED_EXPOSED_COPPER_BAR_TRAPDOOR = registerBlock("waxed_exposed_copper_bar_trapdoor",
            new TrapdoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.EXPOSED_COPPER_BAR_TRAPDOOR).nonOpaque()));
    public static final Block WAXED_WEATHERED_COPPER_BAR_TRAPDOOR = registerBlock("waxed_weathered_copper_bar_trapdoor",
            new TrapdoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.WEATHERED_COPPER_BAR_TRAPDOOR).nonOpaque()));
    public static final Block WAXED_OXIDIZED_COPPER_BAR_TRAPDOOR = registerBlock("waxed_oxidized_copper_bar_trapdoor",
            new TrapdoorBlock(BlockSetType.COPPER, AbstractBlock.Settings.copy(DecoBlocks.OXIDIZED_COPPER_BAR_TRAPDOOR).nonOpaque()));
    ...
    public static final Block MUSHROOM_TRAPDOOR = registerBlock("mushroom_trapdoor",
            new TrapdoorBlock(DecoBlockSets.MUSHROOM, AbstractBlock.Settings.copy(Blocks.OAK_TRAPDOOR)
                    .mapColor(MapColor.PALE_YELLOW).nonOpaque()));
    public static final Block IRON_CAP_TRAPDOOR = registerBlock("iron_cap_trapdoor",
            new TrapdoorBlock(DecoBlockSets.IRON_CAP, AbstractBlock.Settings.copy(Blocks.OAK_TRAPDOOR)
    ...
    public static final Block SPRUCE_PALLET_TRAPDOOR = registerBlock("spruce_pallet_trapdoor",
            new TrapdoorBlock(BlockSetType.SPRUCE, AbstractBlock.Settings.copy(Blocks.SPRUCE_TRAPDOOR).nonOpaque()));
    ...
    public static final Block JUNGLE_PALLET_TRAPDOOR = registerBlock("jungle_pallet_trapdoor",
            new TrapdoorBlock(BlockSetType.JUNGLE, AbstractBlock.Settings.copy(Blocks.JUNGLE_TRAPDOOR).nonOpaque()));
    public static final Block ACACIA_PALLET_TRAPDOOR = registerBlock("acacia_pallet_trapdoor",
            new TrapdoorBlock(BlockSetType.ACACIA, AbstractBlock.Settings.copy(Blocks.ACACIA_TRAPDOOR).nonOpaque()));
    ...
    public static final Block BAMBOO_PALLET_TRAPDOOR = registerBlock("bamboo_pallet_trapdoor",
            new TrapdoorBlock(BlockSetType.BAMBOO, AbstractBlock.Settings.copy(Blocks.BAMBOO_TRAPDOOR).nonOpaque()));
    public static final Block CRIMSON_PALLET_TRAPDOOR = registerBlock("crimson_pallet_trapdoor",
            new TrapdoorBlock(BlockSetType.CRIMSON, AbstractBlock.Settings.copy(Blocks.CRIMSON_TRAPDOOR).nonOpaque()));
    public static final Block WARPED_PALLET_TRAPDOOR = registerBlock("warped_pallet_trapdoor",
            new TrapdoorBlock(BlockSetType.WARPED, AbstractBlock.Settings.copy(Blocks.MANGROVE_TRAPDOOR).nonOpaque()));

    public static final Block CACTUS_PALLET_TRAPDOOR = registerBlock("cactus_pallet_trapdoor",
            new TrapdoorBlock(DecoBlockSets.CACUTS, AbstractBlock.Settings.copy(DecoBlocks.CACTUS_TRAPDOOR).nonOpaque()));
    public static final Block MUSHROOM_PALLET_TRAPDOOR = registerBlock("mushroom_pallet_trapdoor",
            new TrapdoorBlock(DecoBlockSets.MUSHROOM, AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_TRAPDOOR).nonOpaque()));
    public static final Block IRON_CAP_PALLET_TRAPDOOR = registerBlock("iron_cap_pallet_trapdoor",
            new TrapdoorBlock(DecoBlockSets.IRON_CAP, AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_TRAPDOOR).nonOpaque()));
    public static final Block WOODEN_PALLET_TRAPDOOR = registerBlock("wooden_pallet_trapdoor",
            new TrapdoorBlock(DecoBlockSets.WOODEN, AbstractBlock.Settings.copy(DecoBlocks.WOODEN_TRAPDOOR).nonOpaque()));
    ...
    public static final Block MUSHROOM_FENCE_GATE = registerBlock("mushroom_fence_gate",
            new FenceGateBlock(WoodType.JUNGLE, AbstractBlock.Settings.copy(DecoBlocks.MUSHROOM_PLANKS)));
    ...
    public static final Block IRON_CAP_FENCE_GATE = registerBlock("iron_cap_fence_gate",
            new FenceGateBlock(WoodType.CRIMSON, AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS)));
    ...
    public static final Block CRACKED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_nether_brick_fence_gate",
            new FenceGateBlock(WoodType.SPRUCE, AbstractBlock.Settings.copy(Blocks.CRACKED_NETHER_BRICKS)));
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_red_nether_brick_fence_gate",
            new FenceGateBlock(WoodType.MANGROVE, AbstractBlock.Settings.copy(DecoBlocks.CRACKED_RED_NETHER_BRICKS)));
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_blue_nether_brick_fence_gate",
            new FenceGateBlock(WoodType.SPRUCE, AbstractBlock.Settings.copy(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)));

    public static final Identifier CACTUS_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/cactus");
    public static final Identifier MUSHROOM_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/mushroom");
    public static final Identifier IRON_CAP_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/iron_cap");
    public static final Identifier WOODEN_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/wooden");

    public static final Identifier CACTUS_HANGING_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/hanging/cactus");
    public static final Identifier CACTUS_HANGING_SIGN_GUI = Identifier.of(VaranDeco.MOD_ID,"textures/gui/hanging_signs/cactus");
    public static final Identifier MUSHROOM_HANGING_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/hanging/mushroom");
    public static final Identifier MUSHROOM_HANGING_SIGN_GUI = Identifier.of(VaranDeco.MOD_ID,"textures/gui/hanging_signs/mushroom");
    public static final Identifier IRON_CAP_HANGING_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/hanging/iron_cap");
    public static final Identifier IRON_CAP_HANGING_SIGN_GUI = Identifier.of(VaranDeco.MOD_ID,"textures/gui/hanging_signs/iron_cap");
    ...
    public static final Identifier STRIPPED_CACTUS_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/stripped_cactus");
    public static final Identifier MUSHROOM_STEM_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/mushroom_stem");
    public static final Identifier STRIPPED_IRON_CAP_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/stripped_iron_cap");
    ...
    public static final Identifier MUSHROOM_MOSAIC_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/mushroom_mosaic");
    public static final Identifier IRON_CAP_MOSAIC_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/iron_cap_mosaic");
    ...
    public static final Identifier MUSHROOM_MOSAIC_HANGING_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/hanging/mushroom_mosaic");
    public static final Identifier IRON_CAP_MOSAIC_HANGING_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/hanging/iron_cap_mosaic");
    ...
    public static final Identifier MUSHROOM_MOSAIC_HANGING_SIGN_GUI = Identifier.of(VaranDeco.MOD_ID,"textures/gui/hanging_signs/mushroom_mosaic");
    public static final Identifier IRON_CAP_MOSAIC_HANGING_SIGN_GUI = Identifier.of(VaranDeco.MOD_ID,"textures/gui/hanging_signs/iron_cap_mosaic");
    ...
    public static final Identifier MUSHROOM_PLANKS_HANGING_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/hanging/mushroom_planks");
    public static final Identifier IRON_CAP_PLANKS_HANGING_SIGN_TEXTURE = Identifier.of(VaranDeco.MOD_ID,"entity/signs/hanging/iron_cap_planks");
    ...
    public static final Identifier MUSHROOM_PLANKS_HANGING_SIGN_GUI = Identifier.of(VaranDeco.MOD_ID,"textures/gui/hanging_signs/mushroom_planks");
    public static final Identifier IRON_CAP_PLANKS_HANGING_SIGN_GUI = Identifier.of(VaranDeco.MOD_ID,"textures/gui/hanging_signs/iron_cap_planks");
    ...
    public static final Block STANDING_MUSHROOM_SIGN = registerBlockWithoutItem("standing_mushroom_sign",
            new TerraformSignBlock(MUSHROOM_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    public static final Block WALL_MUSHROOM_SIGN = registerBlockWithoutItem("wall_mushroom_sign",
            new TerraformWallSignBlock(MUSHROOM_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));

    public static final Block STANDING_IRON_CAP_SIGN = registerBlockWithoutItem("standing_iron_cap_sign",
            new TerraformSignBlock(IRON_CAP_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    public static final Block WALL_IRON_CAP_SIGN = registerBlockWithoutItem("wall_iron_cap_sign",
            new TerraformWallSignBlock(IRON_CAP_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));
    ...
    public static final Block HANGING_CACTUS_SIGN = registerBlockWithoutItem("hanging_cactus_sign",
            new TerraformHangingSignBlock(CACTUS_HANGING_SIGN_TEXTURE, CACTUS_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    public static final Block WALL_HANGING_CACTUS_SIGN = registerBlockWithoutItem("wall_hanging_cactus_sign",
            new TerraformWallHangingSignBlock(CACTUS_HANGING_SIGN_TEXTURE, CACTUS_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));

    public static final Block HANGING_MUSHROOM_SIGN = registerBlockWithoutItem("hanging_mushroom_sign",
            new TerraformHangingSignBlock(MUSHROOM_HANGING_SIGN_TEXTURE, MUSHROOM_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    public static final Block WALL_HANGING_MUSHROOM_SIGN = registerBlockWithoutItem("wall_hanging_mushroom_sign",
            new TerraformWallHangingSignBlock(MUSHROOM_HANGING_SIGN_TEXTURE, MUSHROOM_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));

    public static final Block HANGING_IRON_CAP_SIGN = registerBlockWithoutItem("hanging_iron_cap_sign",
            new TerraformHangingSignBlock(IRON_CAP_HANGING_SIGN_TEXTURE, IRON_CAP_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    public static final Block WALL_HANGING_IRON_CAP_SIGN = registerBlockWithoutItem("wall_hanging_iron_cap_sign",
            new TerraformWallHangingSignBlock(IRON_CAP_HANGING_SIGN_TEXTURE, IRON_CAP_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));
    ...
    public static final Block STANDING_STRIPPED_CACTUS_SIGN = registerBlockWithoutItem("standing_stripped_cactus_sign",
            new TerraformSignBlock(STRIPPED_CACTUS_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    public static final Block WALL_STRIPPED_CACTUS_SIGN = registerBlockWithoutItem("wall_stripped_cactus_sign",
            new TerraformWallSignBlock(STRIPPED_CACTUS_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));
    public static final Block STANDING_MUSHROOM_STEM_SIGN = registerBlockWithoutItem("standing_mushroom_stem_sign",
            new TerraformSignBlock(MUSHROOM_STEM_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    public static final Block WALL_MUSHROOM_STEM_SIGN = registerBlockWithoutItem("wall_mushroom_stem_sign",
            new TerraformWallSignBlock(MUSHROOM_STEM_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));
    public static final Block STANDING_STRIPPED_IRON_CAP_SIGN = registerBlockWithoutItem("standing_stripped_iron_cap_sign",
            new TerraformSignBlock(STRIPPED_IRON_CAP_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    public static final Block WALL_STRIPPED_IRON_CAP_SIGN = registerBlockWithoutItem("wall_stripped_iron_cap_sign",
            new TerraformWallSignBlock(STRIPPED_IRON_CAP_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));
    ...
    public static final Block STANDING_MUSHROOM_MOSAIC_SIGN = registerBlockWithoutItem("standing_mushroom_mosaic_sign",
            new TerraformSignBlock(MUSHROOM_MOSAIC_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    public static final Block WALL_MUSHROOM_MOSAIC_SIGN = registerBlockWithoutItem("wall_mushroom_mosaic_sign",
            new TerraformWallSignBlock(MUSHROOM_MOSAIC_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));
    public static final Block STANDING_IRON_CAP_MOSAIC_SIGN = registerBlockWithoutItem("standing_iron_cap_mosaic_sign",
            new TerraformSignBlock(IRON_CAP_MOSAIC_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_SIGN)));
    public static final Block WALL_IRON_CAP_MOSAIC_SIGN = registerBlockWithoutItem("wall_iron_cap_mosaic_sign",
            new TerraformWallSignBlock(IRON_CAP_MOSAIC_SIGN_TEXTURE, AbstractBlock.Settings.copy(Blocks.OAK_WALL_SIGN)));
    ...
    public static final Block HANGING_MUSHROOM_MOSAIC_SIGN = registerBlockWithoutItem("hanging_mushroom_mosaic_sign",
            new TerraformHangingSignBlock(MUSHROOM_MOSAIC_HANGING_SIGN_TEXTURE, MUSHROOM_MOSAIC_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    public static final Block WALL_HANGING_MUSHROOM_MOSAIC_SIGN = registerBlockWithoutItem("wall_hanging_mushroom_mosaic_sign",
            new TerraformWallHangingSignBlock(MUSHROOM_MOSAIC_HANGING_SIGN_TEXTURE, MUSHROOM_MOSAIC_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));
    public static final Block HANGING_IRON_CAP_MOSAIC_SIGN = registerBlockWithoutItem("hanging_iron_cap_mosaic_sign",
            new TerraformHangingSignBlock(IRON_CAP_MOSAIC_HANGING_SIGN_TEXTURE, IRON_CAP_MOSAIC_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    public static final Block WALL_HANGING_IRON_CAP_MOSAIC_SIGN = registerBlockWithoutItem("wall_hanging_iron_cap_mosaic_sign",
            new TerraformWallHangingSignBlock(IRON_CAP_MOSAIC_HANGING_SIGN_TEXTURE, IRON_CAP_MOSAIC_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));
    ...
    public static final Block HANGING_MUSHROOM_PLANKS_SIGN = registerBlockWithoutItem("hanging_mushroom_planks_sign",
            new TerraformHangingSignBlock(MUSHROOM_PLANKS_HANGING_SIGN_TEXTURE, MUSHROOM_PLANKS_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    public static final Block WALL_HANGING_MUSHROOM_PLANKS_SIGN = registerBlockWithoutItem("wall_hanging_mushroom_planks_sign",
            new TerraformWallHangingSignBlock(MUSHROOM_PLANKS_HANGING_SIGN_TEXTURE, MUSHROOM_PLANKS_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));
    public static final Block HANGING_IRON_CAP_PLANKS_SIGN = registerBlockWithoutItem("hanging_iron_cap_planks_sign",
            new TerraformHangingSignBlock(IRON_CAP_PLANKS_HANGING_SIGN_TEXTURE, IRON_CAP_PLANKS_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_HANGING_SIGN)));
    public static final Block WALL_HANGING_IRON_CAP_PLANKS_SIGN = registerBlockWithoutItem("wall_hanging_iron_cap_planks_sign",
            new TerraformWallHangingSignBlock(IRON_CAP_PLANKS_HANGING_SIGN_TEXTURE, IRON_CAP_PLANKS_HANGING_SIGN_GUI, AbstractBlock.Settings.copy(Blocks.OAK_WALL_HANGING_SIGN)));
