...
import net.gecko.varandeco.block.nature.corals.*;
...
public class DecoBlocks {
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS = registerStairs("cracked_polished_blackstone_brick_stairs",
            Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS);
    ...
    public static final Block STRIPPED_IRON_CAP_HYPHAE_WALL = registerBlock("stripped_iron_cap_hyphae_wall",
            AbstractBlock.Settings.copy(DecoBlocks.IRON_CAP_PLANKS), WallBlock::new);public static final Block STRIPPED_BAMBOO_WALL = registerBlock("stripped_bamboo_wall",
