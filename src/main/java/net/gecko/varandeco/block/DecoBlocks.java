...
public class DecoBlocks {
    ...
    public static final Block WHITE_SAND = registerBlock("white_sand",
            new SandBlock(0xc0c0c0,FabricBlockSettings.copyOf(Blocks.SAND).mapColor(MapColor.OFF_WHITE)));
    public static final Block BLACK_SAND = registerBlock("black_sand",
            new SandBlock(0x404040,FabricBlockSettings.copyOf(Blocks.SAND).mapColor(MapColor.DEEPSLATE_GRAY)));
    ...
    public static final Block CLOUD_BLOCK = registerBlock("cloud_block",
            new CloudBlock(FabricBlockSettings.of(Material.GLASS).strength(0.4f,0.2f).sounds(BlockSoundGroup.WOOL)
                    .nonOpaque().allowsSpawning(DecoBlocks::never).noCollision()));
    ...
    public static final Block INFESTED_CUT_GRANITE = registerBlock("infested_cut_granite",
            new InfestedBlock(DecoBlocks.CUT_GRANITE, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    public static final Block INFESTED_GRANITE_BRICKS = registerBlock("infested_granite_bricks",
            new InfestedBlock(DecoBlocks.GRANITE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    ...
    public static final Block INFESTED_CUT_DIORITE = registerBlock("infested_cut_diorite",
            new InfestedBlock(DecoBlocks.CUT_DIORITE, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    public static final Block INFESTED_DIORITE_BRICKS = registerBlock("infested_diorite_bricks",
            new InfestedBlock(DecoBlocks.DIORITE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    ...
    public static final Block INFESTED_CUT_ANDESITE = registerBlock("infested_cut_andesite",
            new InfestedBlock(DecoBlocks.CUT_ANDESITE, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    public static final Block INFESTED_ANDESITE_BRICKS = registerBlock("infested_andesite_bricks",
            new InfestedBlock(DecoBlocks.ANDESITE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    ...
    public static final Block INFESTED_POLISHED_CALCITE = registerBlock("infested_polished_calcite",
            new InfestedBlock(DecoBlocks.POLISHED_CALCITE, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    public static final Block INFESTED_CUT_CALCITE = registerBlock("infested_cut_calcite",
            new InfestedBlock(DecoBlocks.CUT_CALCITE, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    public static final Block INFESTED_CALCITE_BRICKS = registerBlock("infested_calcite_bricks",
            new InfestedBlock(DecoBlocks.CALCITE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    ...
    public static final Block INFESTED_MOSSY_DEEPSLATE_BRICKS = registerBlock("infested_mossy_deepslate_bricks",
            new InfestedBlock(DecoBlocks.MOSSY_DEEPSLATE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    ...
    public static final Block INFESTED_MOSSY_POLISHED_BLACKSTONE_BRICKS = registerBlock("infested_mossy_polished_blackstone_bricks",
            new InfestedBlock(DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS, AbstractBlock.Settings.of(Material.ORGANIC_PRODUCT)));
    ...
    public static final Block DEEPSLATE_BUTTON = registerBlock("deepslate_button",
            new ButtonBlock(FabricBlockSettings.copyOf(Blocks.STONE_BUTTON).sounds(BlockSoundGroup.DEEPSLATE),
                    20, false,SoundEvents.BLOCK_STONE_BUTTON_CLICK_OFF,
    ...
    public static final Block POLISHED_END_STONE_PRESSURE_PLATE = registerBlock("polished_end_stone_pressure_plate",
            new PressurePlateBlock(PressurePlateBlock.ActivationRule.MOBS, FabricBlockSettings.copyOf(Blocks.STONE_PRESSURE_PLATE)
                    .mapColor(MapColor.PALE_YELLOW), SoundEvents.BLOCK_STONE_PRESSURE_PLATE_CLICK_OFF,
                    SoundEvents.BLOCK_STONE_PRESSURE_PLATE_CLICK_ON));
    ...
    public static final Block COPPER_WEIGHT_PRESSURE_PLATE = registerBlock("copper_weight_pressure_plate",
            new OxidizablePressurePlateBlock(Oxidizable.OxidationLevel.UNAFFECTED, 20,FabricBlockSettings.copyOf(Blocks.LIGHT_WEIGHTED_PRESSURE_PLATE)
                                .sounds(BlockSoundGroup.COPPER), SoundEvents.BLOCK_METAL_PRESSURE_PLATE_CLICK_OFF,
    ...
    public static final Block WAXED_COPPER_WEIGHT_PRESSURE_PLATE = registerBlock("waxed_copper_weight_pressure_plate",
            new WeightedPressurePlateBlock(20,FabricBlockSettings.copyOf(DecoBlocks.COPPER_WEIGHT_PRESSURE_PLATE),
    ...
    public static final Block WAXED_EXPOSED_COPPER_WEIGHT_PRESSURE_PLATE = registerBlock("waxed_exposed_copper_weight_pressure_plate",
            new WeightedPressurePlateBlock(50,FabricBlockSettings.copyOf(DecoBlocks.EXPOSED_COPPER_WEIGHT_PRESSURE_PLATE),
                    SoundEvents.BLOCK_METAL_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_METAL_PRESSURE_PLATE_CLICK_ON));
    ...
    public static final Block WAXED_WEATHERED_COPPER_WEIGHT_PRESSURE_PLATE = registerBlock("waxed_weathered_copper_weight_pressure_plate",
            new WeightedPressurePlateBlock(70,FabricBlockSettings.copyOf(DecoBlocks.WEATHERED_COPPER_WEIGHT_PRESSURE_PLATE),
                    SoundEvents.BLOCK_METAL_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_METAL_PRESSURE_PLATE_CLICK_ON));
    ...
    public static final Block WAXED_OXIDIZED_COPPER_WEIGHT_PRESSURE_PLATE = registerBlock("waxed_oxidized_copper_weight_pressure_plate",
            new WeightedPressurePlateBlock(100,FabricBlockSettings.copyOf(DecoBlocks.OXIDIZED_COPPER_WEIGHT_PRESSURE_PLATE),
                    SoundEvents.BLOCK_METAL_PRESSURE_PLATE_CLICK_OFF, SoundEvents.BLOCK_METAL_PRESSURE_PLATE_CLICK_ON));
    ...
    public static final Block GOLD_DOOR = registerBlock("gold_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.GOLD_BLOCK).nonOpaque(),
                    SoundEvents.BLOCK_IRON_DOOR_CLOSE,
                    SoundEvents.BLOCK_IRON_DOOR_OPEN));
    ...
    public static final Block WOODEN_DOOR = registerBlock("wooden_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.OAK_DOOR).mapColor(MapColor.BROWN).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    ...
    public static final Block SPRUCE_PALLET_DOOR = registerBlock("spruce_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.SPRUCE_DOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    public static final Block BIRCH_PALLET_DOOR = registerBlock("birch_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.BIRCH_DOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    public static final Block JUNGLE_PALLET_DOOR = registerBlock("jungle_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.JUNGLE_DOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    ...
    public static final Block MANGROVE_PALLET_DOOR = registerBlock("mangrove_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.MANGROVE_DOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    public static final Block CRIMSON_PALLET_DOOR = registerBlock("crimson_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.CRIMSON_DOOR).nonOpaque(),
    ...
    public static final Block CACTUS_PALLET_DOOR = registerBlock("cactus_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(DecoBlocks.CACTUS_DOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    public static final Block MUSHROOM_PALLET_DOOR = registerBlock("mushroom_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(DecoBlocks.MUSHROOM_DOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    public static final Block WOODEN_PALLET_DOOR = registerBlock("wooden_pallet_door",
            new DoorBlock(FabricBlockSettings.copyOf(DecoBlocks.WOODEN_DOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_DOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_DOOR_OPEN));
    ...
    public static final Block GOLD_TRAPDOOR = registerBlock("gold_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.GOLD_BLOCK).nonOpaque(),
                    SoundEvents.BLOCK_IRON_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_IRON_TRAPDOOR_OPEN));
    ...
    public static final Block CACTUS_TRAPDOOR = registerBlock("cactus_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR).mapColor(MapColor.PALE_GREEN).nonOpaque(),
    ...
    public static final Block MUSHROOM_TRAPDOOR = registerBlock("mushroom_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR).mapColor(MapColor.PALE_YELLOW).nonOpaque(),
            SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
            SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    public static final Block WOODEN_TRAPDOOR = registerBlock("wooden_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.OAK_TRAPDOOR).mapColor(MapColor.BROWN).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    ...
    public static final Block SPRUCE_PALLET_TRAPDOOR = registerBlock("spruce_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.SPRUCE_TRAPDOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    public static final Block BIRCH_PALLET_TRAPDOOR = registerBlock("birch_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.BIRCH_TRAPDOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    public static final Block JUNGLE_PALLET_TRAPDOOR = registerBlock("jungle_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.JUNGLE_TRAPDOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    ...
    public static final Block MANGROVE_PALLET_TRAPDOOR = registerBlock("mangrove_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.MANGROVE_TRAPDOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    public static final Block CRIMSON_PALLET_TRAPDOOR = registerBlock("crimson_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.CRIMSON_TRAPDOOR).nonOpaque(),
    ...
    public static final Block CACTUS_PALLET_TRAPDOOR = registerBlock("cactus_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(DecoBlocks.CACTUS_TRAPDOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    public static final Block MUSHROOM_PALLET_TRAPDOOR = registerBlock("mushroom_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(DecoBlocks.MUSHROOM_TRAPDOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));
    public static final Block WOODEN_PALLET_TRAPDOOR = registerBlock("wooden_pallet_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(DecoBlocks.WOODEN_TRAPDOOR).nonOpaque(),
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_CLOSE,
                    SoundEvents.BLOCK_WOODEN_TRAPDOOR_OPEN));

    public static final Block CACTUS_PLANK_FENCE_GATE = registerBlock("cactus_plank_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(DecoBlocks.CACTUS_PLANKS),
    ...
    public static final Block MUSHROOM_FENCE_GATE = registerBlock("mushroom_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(DecoBlocks.MUSHROOM_PLANKS),
                    SoundEvents.BLOCK_FENCE_GATE_CLOSE,
                    SoundEvents.BLOCK_FENCE_GATE_OPEN));
    public static final Block WOODEN_FENCE_GATE = registerBlock("wooden_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(DecoBlocks.WOODEN_PLANKS),
                    SoundEvents.BLOCK_FENCE_GATE_CLOSE,
                    SoundEvents.BLOCK_FENCE_GATE_OPEN));
    public static final Block NETHER_BRICK_FENCE_GATE = registerBlock("nether_brick_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS),
    ...
    public static void addBlocksToItemGroups() {
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OAK_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OAK_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OAK_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_OAK_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_OAK_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_OAK_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OAK_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OAK_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SPRUCE_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SPRUCE_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SPRUCE_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_SPRUCE_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_SPRUCE_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_SPRUCE_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SPRUCE_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SPRUCE_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BIRCH_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BIRCH_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BIRCH_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_BIRCH_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_BIRCH_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_BIRCH_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BIRCH_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BIRCH_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.JUNGLE_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.JUNGLE_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.JUNGLE_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_JUNGLE_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_JUNGLE_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_JUNGLE_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.JUNGLE_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.JUNGLE_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ACACIA_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ACACIA_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ACACIA_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_ACACIA_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_ACACIA_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_ACACIA_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ACACIA_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ACACIA_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DARK_OAK_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DARK_OAK_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DARK_OAK_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_DARK_OAK_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_DARK_OAK_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_DARK_OAK_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DARK_OAK_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DARK_OAK_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MANGROVE_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MANGROVE_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MANGROVE_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_MANGROVE_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_MANGROVE_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_MANGROVE_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MANGROVE_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MANGROVE_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_HYPHAE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_HYPHAE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_HYPHAE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_CRIMSON_HYPHAE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_CRIMSON_HYPHAE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_CRIMSON_HYPHAE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_HYPHAE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_HYPHAE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_HYPHAE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_WARPED_HYPHAE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_WARPED_HYPHAE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_WARPED_HYPHAE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, PACKED_CACTUS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, STRIPPED_CACTUS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CACTUS_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CACTUS_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CACTUS_PALLET_TRAPDOOR.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, MUSHROOM_PLANKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_FENCE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_FENCE_GATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_PALLET_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_PRESSURE_PLATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_BUTTON.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_WOOD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, STRIPPED_WOODEN_WOOD.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_WOODEN_WOOD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_WOODEN_WOOD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STRIPPED_WOODEN_WOOD_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_PALLET_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_PALLET_TRAPDOOR.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.STONE_LEVER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_STONE_LEVER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_STONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_STONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_STONE_BRICK_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_STONE_TILES.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_STONE_TILE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_STONE_TILE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_STONE_TILE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_GRANITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_GRANITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_GRANITE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_GRANITE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_GRANITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRANITE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRANITE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRANITE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRANITE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_DIORITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_DIORITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_DIORITE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_DIORITE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_DIORITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DIORITE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DIORITE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DIORITE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DIORITE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_ANDESITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_ANDESITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_ANDESITE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_ANDESITE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_ANDESITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ANDESITE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ANDESITE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ANDESITE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ANDESITE_BRICK_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEEPSLATE_LEVER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_DEEPSLATE_LEVER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_DEEPSLATE_LEVER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_DEEPSLATE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_DEEPSLATE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_DEEPSLATE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_DEEPSLATE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_DEEPSLATE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_DEEPSLATE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_DEEPSLATE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_DEEPSLATE_TILE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_DEEPSLATE_TILE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_DEEPSLATE_TILE_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_CALCITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_CALCITE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_CALCITE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_CALCITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_CALCITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_CALCITE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_CALCITE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_CALCITE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CALCITE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CALCITE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CALCITE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CALCITE_BRICK_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_DRIPSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICK_PILLAR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICK_PILLAR_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICK_PILLAR_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DRIPSTONE_BRICK_PILLAR_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, CHISELED_MUD_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SAND_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SAND_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SAND_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, COBBLED_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_POLISHED_SANDSTONE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, POLISHED_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_SANDSTONE_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, SANDSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SANDSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SANDSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SANDSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_SAND_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_SAND_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_SAND_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, COBBLED_RED_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_RED_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_RED_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_RED_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_POLISHED_RED_SANDSTONE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, POLISHED_RED_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_RED_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_RED_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_RED_SANDSTONE_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, RED_SANDSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_SANDSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_SANDSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_SANDSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SAND.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SAND_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SAND_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SAND_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_WHITE_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_WHITE_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_WHITE_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_WHITE_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_WHITE_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_POLISHED_WHITE_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_WHITE_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_WHITE_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_WHITE_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_WHITE_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_WHITE_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_WHITE_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_WHITE_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_WHITE_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_SANDSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SAND.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SAND_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SAND_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SAND_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_BLACK_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_BLACK_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_BLACK_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_BLACK_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_BLACK_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_POLISHED_BLACK_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_BLACK_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_BLACK_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_BLACK_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_BLACK_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_BLACK_SANDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_BLACK_SANDSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_BLACK_SANDSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_BLACK_SANDSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_SANDSTONE_BRICK_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_NETHERRACK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_NETHERRACK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_NETHERRACK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_NETHERRACK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHERRACK_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHERRACK_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHERRACK_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHERRACK_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_NETHERRACK_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_NETHER_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_NETHER_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_NETHER_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_NETHER_BRICK_FENCE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHER_BRICK_FENCE_GATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_NETHER_BRICK_FENCE_GATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHER_BRICK_PILLAR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_RED_NETHER_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_RED_NETHER_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_RED_NETHER_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_RED_NETHER_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_NETHER_BRICK_FENCE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_RED_NETHER_BRICK_FENCE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_NETHER_BRICK_FENCE_GATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_RED_NETHER_BRICK_FENCE_GATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_NETHER_BRICK_PILLAR.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_BLUE_NETHER_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_NETHER_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_BLUE_NETHER_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_NETHER_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_BLUE_NETHER_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_NETHER_BRICK_FENCE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_BLUE_NETHER_BRICK_FENCE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_NETHER_BRICK_FENCE_GATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_BLUE_NETHER_BRICK_FENCE_GATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_NETHER_BRICK_PILLAR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_BLUE_NETHER_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_BASALT_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_BASALT_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_BASALT_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BASALT_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACKSTONE_LEVER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_BLACKSTONE_LEVER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_POLISHED_BLACKSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICK_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_BUTTON.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_PRESSURE_PLATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_LEVER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, CHISELED_END_STONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_END_STONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_END_STONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_END_STONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_END_STONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_END_STONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_END_STONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_END_STONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_END_STONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_END_STONE_BUTTON.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_END_STONE_PRESSURE_PLATE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_END_STONE_LEVER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_END_STONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_END_STONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_END_STONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSSY_END_STONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_TILES.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_TILE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_TILE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_TILE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_TILES.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_TILE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_TILE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRACKED_END_STONE_TILE_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, VOID_STONE_BRICK_PILLAR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.VOID_STONE_BRICK_PILLAR_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.VOID_STONE_BRICK_PILLAR_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.VOID_STONE_BRICK_PILLAR_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, PURPUR_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, CHISELED_PURPUR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, CUT_PURPUR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_PURPUR_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_PURPUR_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_PURPUR_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, COAL_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COAL_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COAL_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COAL_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, CHISELED_COAL_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, CHARCOAL_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHARCOAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHARCOAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHARCOAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, FLINT_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FLINT_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FLINT_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FLINT_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RAW_IRON_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RAW_IRON_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.IRON_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.IRON_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, CASTED_IRON.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, CASTED_IRON_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, CASTED_IRON_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.IRON_BAR_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.IRON_BAR_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RAW_GOLD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RAW_GOLD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_GOLD.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_GOLD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_GOLD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIGHT_GOLD_BARS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_BARS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HEAVY_GOLD_BARS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_BAR_DOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_BAR_TRAPDOOR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_CHAIN.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_LAPIS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAPIS_PILLAR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_LAPIS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_LAPIS_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_LAPIS_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_LAPIS_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_LAPIS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_LAPIS_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_LAPIS_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CUT_LAPIS_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.AMETHYST_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.AMETHYST_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.AMETHYST_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, SHINED_AMETHYST.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SHINED_AMETHYST_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SHINED_AMETHYST_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SHINED_AMETHYST_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, AMETHYST_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.AMETHYST_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.AMETHYST_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.AMETHYST_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, AMETHYST_PILLAR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, SCATTERED_AMETHYST.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCATTERED_AMETHYST_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCATTERED_AMETHYST_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCATTERED_AMETHYST_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, ECHO_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ECHO_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ECHO_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ECHO_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, SHINED_ECHO.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SHINED_ECHO_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SHINED_ECHO_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SHINED_ECHO_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, ECHO_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ECHO_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ECHO_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ECHO_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, ECHO_PILLAR.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO, SCATTERED_ECHO.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCATTERED_ECHO_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCATTERED_ECHO_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCATTERED_ECHO_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RAW_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RAW_COPPER_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.EXPOSED_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.EXPOSED_COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WEATHERED_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WEATHERED_COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OXIDIZED_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OXIDIZED_COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_EXPOSED_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_EXPOSED_COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_WEATHERED_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_WEATHERED_COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_OXIDIZED_COPPER_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_OXIDIZED_COPPER_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO, CHISELED_ICE_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_MAGMA_BLOCK.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_BUBBLE_BLOCK.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_OBSIDIAN.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_OBSIDIAN.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_OBSIDIAN_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_OBSIDIAN_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SMOOTH_OBSIDIAN_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SANDED_OBSIDIAN.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SANDED_OBSIDIAN_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SANDED_OBSIDIAN_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SANDED_OBSIDIAN_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OBSIDIAN_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OBSIDIAN_PILLAR.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_SOUL_SOILSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_SOUL_SOILSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_SOUL_SOILSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COBBLED_SOUL_SOILSTONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_SOUL_SOILSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHISELED_POLISHED_SOUL_SOILSTONE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_SOUL_SOILSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_SOUL_SOILSTONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_SOUL_SOILSTONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POLISHED_SOUL_SOILSTONE_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SOUL_SOILSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SOUL_SOILSTONE_BRICK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SOUL_SOILSTONE_BRICK_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SOUL_SOILSTONE_BRICK_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BONE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BONE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BONE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SOLID_CLOUD.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLOUD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLOUD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLOUD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLOUD_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WHITE_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIGHT_GRAY_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIGHT_GRAY_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRAY_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRAY_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BROWN_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BROWN_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ORANGE_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ORANGE_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.YELLOW_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.YELLOW_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIME_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIME_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GREEN_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GREEN_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CYAN_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CYAN_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIGHT_BLUE_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIGHT_BLUE_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PURPLE_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PURPLE_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MAGENTA_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MAGENTA_WOOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PINK_WOOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PINK_WOOL_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GRAY_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GRAY_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GRAY_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GRAY_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLACK_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLACK_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLACK_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLACK_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BROWN_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BROWN_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BROWN_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BROWN_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_RED_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_RED_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_RED_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_RED_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_ORANGE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_ORANGE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_ORANGE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_ORANGE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_YELLOW_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_YELLOW_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_YELLOW_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_YELLOW_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIME_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIME_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIME_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIME_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GREEN_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GREEN_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GREEN_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_GREEN_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_CYAN_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_CYAN_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_CYAN_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_CYAN_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLUE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLUE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLUE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_BLUE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PURPLE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PURPLE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PURPLE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PURPLE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PINK_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PINK_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PINK_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DUEL_CUT_PINK_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GRAY_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GRAY_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GRAY_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GRAY_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLACK_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLACK_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLACK_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLACK_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BROWN_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BROWN_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BROWN_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BROWN_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_RED_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_RED_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_RED_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_RED_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_ORANGE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_ORANGE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_ORANGE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_ORANGE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_YELLOW_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_YELLOW_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_YELLOW_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_YELLOW_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIME_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIME_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIME_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIME_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GREEN_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GREEN_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GREEN_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_GREEN_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_CYAN_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_CYAN_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_CYAN_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_CYAN_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLUE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLUE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLUE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_BLUE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PURPLE_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PURPLE_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PURPLE_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PURPLE_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_MAGENTA_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_MAGENTA_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_MAGENTA_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_MAGENTA_CONCRETE_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PINK_CONCRETE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PINK_CONCRETE_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PINK_CONCRETE_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CHECKERED_PINK_CONCRETE_WALL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GLOWING_GLASS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HARDENED_GLOWING_GLASS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GLOWING_GLASS_PANE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HARDENED_GLOWING_GLASS_PANE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.RED_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ORANGE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.YELLOW_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIME_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GREEN_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CYAN_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LIGHT_BLUE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PURPLE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MAGENTA_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PINK_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_WHITE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_LIGHT_GRAY_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_GRAY_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_BLACK_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_BROWN_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_RED_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_ORANGE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_YELLOW_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_LIME_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_GREEN_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_CYAN_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_LIGHT_BLUE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_BLUE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_PURPLE_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_MAGENTA_LAMP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HANGING_PINK_LAMP.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_GRASS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRASS_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRASS_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRASS_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_PODZOL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PODZOL_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PODZOL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PODZOL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_MYCELIUM.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MYCELIUM_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MYCELIUM_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MYCELIUM_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DIRT_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DIRT_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DIRT_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COARSE_DIRT_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COARSE_DIRT_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COARSE_DIRT_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ROOTED_DIRT_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ROOTED_DIRT_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ROOTED_DIRT_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUD_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUD_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUD_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLAY_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLAY_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLAY_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRAVEL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRAVEL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GRAVEL_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FRAGILE_ICE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACK_ICE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSS_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MOSS_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_CRIMSON_NYLIUM.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_NYLIUM_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_NYLIUM_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_NYLIUM_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.PACKED_WARPED_NYLIUM.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_NYLIUM_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_NYLIUM_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_NYLIUM_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_LEAVES.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHER_WART_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NETHER_WART_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_WART_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_WART_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.TAIGA_DANDELION.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ALPINE_POPPY.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CYAN_ORCHID.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.POPPED_BLUET.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FELICIA_DAISY.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_EYED_DAISY.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_EYE_DAISY.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.LAVENDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FERN_LAVENDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BUTTERCUP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CARAMEL_BUTTERCUP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.NIGHTSHADE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ENDERSHADE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.IRIS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLUE_DELPHINIUM.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ALPINE_SPEEDWELL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ROSE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SILVER_ROSE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MEGA_BROWN_TULIP.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.TUBE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.TUBE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.TUBE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BRAIN_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BRAIN_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BRAIN_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BUBBLE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BUBBLE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BUBBLE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FIRE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FIRE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.FIRE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HORN_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HORN_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HORN_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_TUBE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_TUBE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_TUBE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_BRAIN_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_BRAIN_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_BRAIN_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_BUBBLE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_BUBBLE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_BUBBLE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_FIRE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_FIRE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_FIRE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_HORN_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_HORN_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEAD_HORN_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_TUBE_CORAL_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_TUBE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_TUBE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_TUBE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BRAIN_CORAL_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BRAIN_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BRAIN_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BRAIN_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BUBBLE_CORAL_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BUBBLE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BUBBLE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BUBBLE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_FIRE_CORAL_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_FIRE_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_FIRE_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_FIRE_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_HORN_CORAL_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_HORN_CORAL_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_HORN_CORAL_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_HORN_CORAL_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_TUBE_CORAL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BRAIN_CORAL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_BUBBLE_CORAL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_FIRE_CORAL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HYDRATED_HORN_CORAL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.JACK_O_SOUL_LANTERN.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HAY_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HAY_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HAY_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HONEYCOMB_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HONEYCOMB_SLAB.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.HONEYCOMB_WALL.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCULK_CARPET.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCULK_STAIRS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SCULK_SLAB.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CLOUD_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_LANTERN.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COPPER_LANTERN.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLD_SOUL_LANTERN.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OAK_CRAFTING_TABLE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_CRAFTING_TABLE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_STONECUTTER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_CARTOGRAPHY_TABLE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_SMITHING_TABLE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DEEPSLATE_GRINDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BLACKSTONE_GRINDSTONE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_GRINDSTONE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_FURNACE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_SMOKER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.END_STONE_BLAST_FURNACE.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WOODEN_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.IRON_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.GOLDEN_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.COPPER_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.EXPOSED_COPPER_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WEATHERED_COPPER_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OXIDIZED_COPPER_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_COPPER_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_EXPOSED_COPPER_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_WEATHERED_COPPER_LADDER.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WAXED_OXIDIZED_COPPER_LADDER.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_BARREL.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CRACKED_STONE_TILES.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CUT_GRANITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_GRANITE_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CUT_DIORITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_DIORITE_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CUT_ANDESITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_ANDESITE_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_MOSSY_DEEPSLATE_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_MOSSY_POLISHED_BLACKSTONE_BRICKS.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_POLISHED_BLACKSTONE_TILES.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CRACKED_POLISHED_BLACKSTONE_TILES.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CALCITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_POLISHED_CALCITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CUT_CALCITE.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.INFESTED_CALCITE_BRICKS.asItem());
        ...
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.OAK_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.SPRUCE_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BIRCH_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.JUNGLE_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.ACACIA_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.DARK_OAK_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MANGROVE_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CRIMSON_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.WARPED_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.CACTUS_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.MUSHROOM_NOTE_BLOCK.asItem());
        addToItemGroup(DecoItemGroup.VARAN_DECO,DecoBlocks.BUBBLE_ELEVATOR_BLOCK_BUBBLE.asItem());
    }
