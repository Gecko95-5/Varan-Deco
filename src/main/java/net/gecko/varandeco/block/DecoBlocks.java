...
public class DecoBlocks {
    ...
    public static final Block CHISELED_DRIPSTONE = registerBlock("chiseled_dripstone",
            new Block(FabricBlockSettings.copyOf(Blocks.DRIPSTONE_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block COAL_BRICKS = registerBlock("coal_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.BRICKS).mapColor(MapColor.BLACK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHISELED_COAL_BRICKS = registerBlock("chiseled_coal_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.COAL_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block SHINED_AMETHYST = registerBlock("shined_amethyst",
            new Block(FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK).mapColor(MapColor.PALE_PURPLE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block AMETHYST_BRICKS = registerBlock("amethyst_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.SHINED_AMETHYST).strength(2.0F)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SCATTERED_AMETHYST = registerBlock("scattered_amethyst",
            new GlazedTerracottaBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_AMETHYST)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block AMETHYST_PILLAR = registerBlock("amethyst_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_AMETHYST)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block SHINED_ECHO = registerBlock("shined_echo",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.ECHO_BLOCK).luminance(state -> 3)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block ECHO_BRICKS = registerBlock("echo_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.SHINED_ECHO).strength(2.5F)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SCATTERED_ECHO = registerBlock("scattered_echo",
            new GlazedTerracottaBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_ECHO)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block ECHO_PILLAR = registerBlock("echo_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_ECHO)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CASTED_IRON = registerBlock("casted_iron",
            new Block(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).strength(10.0F, 6.0F)
                    .mapColor(MapColor.DEEPSLATE_GRAY)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CASTED_IRON_SLAB = registerBlock("casted_iron_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CASTED_IRON)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CHISELED_LAPIS = registerBlock("chiseled_lapis",
            new Block(FabricBlockSettings.copyOf(Blocks.LAPIS_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block LAPIS_BRICKS = registerBlock("lapis_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.LAPIS_BLOCK).strength(4)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block LAPIS_PILLAR = registerBlock("lapis_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.LAPIS_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block SMOOTH_LAPIS = registerBlock("smooth_lapis",
            new Block(FabricBlockSettings.copyOf(Blocks.LAPIS_BLOCK).mapColor(MapColor.BLUE)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block MOSSY_DEEPSLATE_BRICKS = registerBlock("mossy_deepslate_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block NETHER_BRICK_PILLAR = registerBlock("nether_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block VOID_STONE_BRICKS = registerBlock("void_stone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE).strength(5.5F, 12.0F)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block VOID_STONE_BRICK_PILLAR = registerBlock("void_stone_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block RED_SANDSTONE_BRICKS = registerBlock("red_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_RED_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);public static final Block WHITE_SANDSTONE = registerBlock("white_sandstone",
    ...
    public static final Block CHISELED_WHITE_SANDSTONE = registerBlock("chiseled_white_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CUT_WHITE_SANDSTONE_BRICKS = registerBlock("cut_white_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE).strength(1.6f)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CHISELED_POLISHED_WHITE_SANDSTONE = registerBlock("chiseled_polished_white_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CHISELED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block POLISHED_WHITE_SANDSTONE = registerBlock("polished_white_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block WHITE_SANDSTONE_BRICKS = registerBlock("white_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CHISELED_BLACK_SANDSTONE = registerBlock("chiseled_black_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CUT_BLACK_SANDSTONE_BRICKS = registerBlock("cut_black_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE).strength(1.6f)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CHISELED_POLISHED_BLACK_SANDSTONE = registerBlock("chiseled_polished_black_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CHISELED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block POLISHED_BLACK_SANDSTONE = registerBlock("polished_black_sandstone",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block BLACK_SANDSTONE_BRICKS = registerBlock("black_sandstone_bricks",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block RED_NETHER_BRICK_PILLAR = registerBlock("red_nether_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(Blocks.RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block BLUE_NETHER_BRICK_PILLAR = registerBlock("blue_nether_brick_pillar",
            new PillarBlock(FabricBlockSettings.copyOf(DecoBlocks.BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block DUEL_CUT_ORANGE_CONCRETE = registerBlock("duel_cut_orange_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_MAGENTA_CONCRETE = registerBlock("duel_cut_magenta_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_LIGHT_BLUE_CONCRETE = registerBlock("duel_cut_light_blue_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_YELLOW_CONCRETE = registerBlock("duel_cut_yellow_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_LIME_CONCRETE = registerBlock("duel_cut_lime_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_PINK_CONCRETE = registerBlock("duel_cut_pink_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_GRAY_CONCRETE = registerBlock("duel_cut_gray_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_LIGHT_GRAY_CONCRETE = registerBlock("duel_cut_light_gray_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_CYAN_CONCRETE = registerBlock("duel_cut_cyan_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_PURPLE_CONCRETE = registerBlock("duel_cut_purple_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_BLUE_CONCRETE = registerBlock("duel_cut_blue_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_BROWN_CONCRETE = registerBlock("duel_cut_brown_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_GREEN_CONCRETE = registerBlock("duel_cut_green_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_RED_CONCRETE = registerBlock("duel_cut_red_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_BLACK_CONCRETE = registerBlock("duel_cut_black_concrete",
            new Block(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block HYDRATED_TUBE_CORAL_BLOCK = registerBlock("hydrated_tube_coral_block",
            new Block(FabricBlockSettings.copyOf(Blocks.TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_BRAIN_CORAL_BLOCK = registerBlock("hydrated_brain_coral_block",
            new Block(FabricBlockSettings.copyOf(Blocks.BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_BUBBLE_CORAL_BLOCK = registerBlock("hydrated_bubble_coral_block",
            new Block(FabricBlockSettings.copyOf(Blocks.BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_FIRE_CORAL_BLOCK = registerBlock("hydrated_fire_coral_block",
            new Block(FabricBlockSettings.copyOf(Blocks.FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_HORN_CORAL_BLOCK = registerBlock("hydrated_horn_coral_block",
            new Block(FabricBlockSettings.copyOf(Blocks.HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block MOSSY_POLISHED_BLACKSTONE_BRICKS = registerBlock("mossy_polished_blackstone_bricks",
            new Block(FabricBlockSettings.copyOf(Blocks.POLISHED_BLACKSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block SAND_SLAB = registerBlock("sand_slab",
            new FallingSlabBlock(14406560,FabricBlockSettings.copyOf(Blocks.SAND)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block RED_SAND_SLAB = registerBlock("red_sand_slab",
            new FallingSlabBlock(11098145,FabricBlockSettings.copyOf(Blocks.RED_SAND)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block GRAVEL_SLAB = registerBlock("gravel_slab",
            new FallingSlabBlock(-8356741,FabricBlockSettings.copyOf(Blocks.GRAVEL)), DecoItemGroup.VARAN_DECO_BUILDING);

    public static final Block COAL_SLAB = registerBlock("coal_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.COAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block AMETHYST_SLAB = registerBlock("amethyst_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block LAPIS_SLAB = registerBlock("lapis_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.LAPIS_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_STONE_BRICK_SLAB = registerBlock("cracked_stone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_DEEPSLATE_BRICK_SLAB = registerBlock("cracked_deepslate_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CRACKED_DEEPSLATE_TILE_SLAB = registerBlock("cracked_deepslate_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_TILES)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_NETHER_BRICK_SLAB = registerBlock("cracked_nether_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block HAY_SLAB = registerBlock("hay_slab",
            new HaySlabBlock(FabricBlockSettings.copyOf(Blocks.HAY_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block NETHER_WART_SLAB = registerBlock("nether_wart_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.NETHER_WART_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block WARPED_WART_SLAB = registerBlock("warped_wart_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.WARPED_WART_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block DEAD_TUBE_CORAL_SLAB = registerBlock("dead_tube_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DEAD_BRAIN_CORAL_SLAB = registerBlock("dead_brain_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DEAD_BUBBLE_CORAL_SLAB = registerBlock("dead_bubble_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DEAD_FIRE_CORAL_SLAB = registerBlock("dead_fire_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DEAD_HORN_CORAL_SLAB = registerBlock("dead_horn_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.DEAD_HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block TUBE_CORAL_SLAB = registerBlock("tube_coral_slab",
            new CoralSlabBlock(DEAD_TUBE_CORAL_SLAB, FabricBlockSettings.copyOf(Blocks.TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block BRAIN_CORAL_SLAB = registerBlock("brain_coral_slab",
            new CoralSlabBlock(DEAD_BRAIN_CORAL_SLAB, FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block BUBBLE_CORAL_SLAB = registerBlock("bubble_coral_slab",
            new CoralSlabBlock(DEAD_BUBBLE_CORAL_SLAB,FabricBlockSettings.copyOf(Blocks.BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block FIRE_CORAL_SLAB = registerBlock("fire_coral_slab",
            new CoralSlabBlock(DEAD_FIRE_CORAL_SLAB,FabricBlockSettings.copyOf(Blocks.FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HORN_CORAL_SLAB = registerBlock("horn_coral_slab",
            new CoralSlabBlock(DEAD_HORN_CORAL_SLAB,FabricBlockSettings.copyOf(Blocks.HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_SLAB = registerBlock("cracked_polished_blackstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block SCULK_SLAB = registerBlock("sculk_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.SCULK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HONEYCOMB_SLAB = registerBlock("honeycomb_slab",
            new SlabBlock(FabricBlockSettings.copyOf(Blocks.HONEYCOMB_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block DRIPSTONE_BRICK_SLAB = registerBlock("dripstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DRIPSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DRIPSTONE_BRICK_PILLAR_SLAB = registerBlock("dripstone_brick_pillar_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DRIPSTONE_BRICK_PILLAR)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block WHITE_SAND_SLAB = registerBlock("white_sand_slab",
            new FallingSlabBlock(0xc0c0c0,FabricBlockSettings.copyOf(DecoBlocks.WHITE_SAND)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block BLACK_SAND_SLAB = registerBlock("black_sand_slab",
            new FallingSlabBlock(0x404040,FabricBlockSettings.copyOf(DecoBlocks.BLACK_SAND)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block COAL_BRICK_SLAB = registerBlock("coal_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.COAL_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHARCOAL_SLAB = registerBlock("charcoal_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHARCOAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block FLINT_SLAB = registerBlock("flint_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.FLINT_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SHINED_AMETHYST_SLAB = registerBlock("shined_amethyst_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_AMETHYST)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block AMETHYST_BRICK_SLAB = registerBlock("amethyst_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.AMETHYST_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SCATTERED_AMETHYST_SLAB = registerBlock("scattered_amethyst_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SCATTERED_AMETHYST)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block ECHO_SLAB = registerBlock("echo_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.ECHO_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SHINED_ECHO_SLAB = registerBlock("shined_echo_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_ECHO)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block ECHO_BRICK_SLAB = registerBlock("echo_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.ECHO_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SCATTERED_ECHO_SLAB = registerBlock("scattered_echo_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SCATTERED_ECHO)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block LAPIS_BRICK_SLAB = registerBlock("lapis_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.LAPIS_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CUT_LAPIS_SLAB = registerBlock("cut_lapis_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_LAPIS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block SMOOTH_LAPIS_SLAB = registerBlock("smooth_lapis_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_LAPIS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_STONE_TILE_SLAB = registerBlock("cracked_stone_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_STONE_TILES)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block MOSSY_DEEPSLATE_BRICK_SLAB = registerBlock("mossy_deepslate_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block MOSSY_END_STONE_BRICK_SLAB = registerBlock("mossy_end_stone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CRACKED_END_STONE_BRICK_SLAB = registerBlock("cracked_end_stone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_END_STONE_TILE_SLAB = registerBlock("cracked_end_stone_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_TILES)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block VOID_STONE_BRICK_PILLAR_SLAB = registerBlock("void_stone_brick_pillar_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICK_PILLAR)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block DUEL_CUT_ORANGE_CONCRETE_SLAB = registerBlock("duel_cut_orange_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_MAGENTA_CONCRETE_SLAB = registerBlock("duel_cut_magenta_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_LIGHT_BLUE_CONCRETE_SLAB = registerBlock("duel_cut_light_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_YELLOW_CONCRETE_SLAB = registerBlock("duel_cut_yellow_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_LIME_CONCRETE_SLAB = registerBlock("duel_cut_lime_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_PINK_CONCRETE_SLAB = registerBlock("duel_cut_pink_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_GRAY_CONCRETE_SLAB = registerBlock("duel_cut_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_LIGHT_GRAY_CONCRETE_SLAB = registerBlock("duel_cut_light_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_CYAN_CONCRETE_SLAB = registerBlock("duel_cut_cyan_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_PURPLE_CONCRETE_SLAB = registerBlock("duel_cut_purple_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_BLUE_CONCRETE_SLAB = registerBlock("duel_cut_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_BROWN_CONCRETE_SLAB = registerBlock("duel_cut_brown_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_GREEN_CONCRETE_SLAB = registerBlock("duel_cut_green_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_RED_CONCRETE_SLAB = registerBlock("duel_cut_red_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block DUEL_CUT_BLACK_CONCRETE_SLAB = registerBlock("duel_cut_black_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_ORANGE_CONCRETE_SLAB = registerBlock("checkered_orange_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_MAGENTA_CONCRETE_SLAB = registerBlock("checkered_magenta_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_LIGHT_BLUE_CONCRETE_SLAB = registerBlock("checkered_light_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_YELLOW_CONCRETE_SLAB = registerBlock("checkered_yellow_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_LIME_CONCRETE_SLAB = registerBlock("checkered_lime_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_PINK_CONCRETE_SLAB = registerBlock("checkered_pink_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_GRAY_CONCRETE_SLAB = registerBlock("checkered_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_LIGHT_GRAY_CONCRETE_SLAB = registerBlock("checkered_light_gray_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_CYAN_CONCRETE_SLAB = registerBlock("checkered_cyan_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_PURPLE_CONCRETE_SLAB = registerBlock("checkered_purple_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_BLUE_CONCRETE_SLAB = registerBlock("checkered_blue_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_BROWN_CONCRETE_SLAB = registerBlock("checkered_brown_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_GREEN_CONCRETE_SLAB = registerBlock("checkered_green_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_RED_CONCRETE_SLAB = registerBlock("checkered_red_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CHECKERED_BLACK_CONCRETE_SLAB = registerBlock("checkered_black_concrete_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block WHITE_SANDSTONE_SLAB = registerBlock("white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CUT_WHITE_SANDSTONE_SLAB = registerBlock("cut_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SMOOTH_WHITE_SANDSTONE_SLAB = registerBlock("smooth_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CUT_WHITE_SANDSTONE_BRICK_SLAB = registerBlock("cut_white_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block COBBLED_WHITE_SANDSTONE_SLAB = registerBlock("cobbled_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block POLISHED_WHITE_SANDSTONE_SLAB = registerBlock("polished_white_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block WHITE_SANDSTONE_BRICK_SLAB = registerBlock("white_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block BLACK_SANDSTONE_SLAB = registerBlock("black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CUT_BLACK_SANDSTONE_SLAB = registerBlock("cut_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block SMOOTH_BLACK_SANDSTONE_SLAB = registerBlock("smooth_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CUT_BLACK_SANDSTONE_BRICK_SLAB = registerBlock("cut_black_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block COBBLED_BLACK_SANDSTONE_SLAB = registerBlock("cobbled_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block POLISHED_BLACK_SANDSTONE_SLAB = registerBlock("polished_black_sandstone_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block BLACK_SANDSTONE_BRICK_SLAB = registerBlock("black_sandstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_SLAB = registerBlock("cracked_red_nether_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_BLUE_NETHER_BRICK_SLAB = registerBlock("cracked_blue_nether_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_TUBE_CORAL_SLAB = registerBlock("hydrated_tube_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_BRAIN_CORAL_SLAB = registerBlock("hydrated_brain_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_BUBBLE_CORAL_SLAB = registerBlock("hydrated_bubble_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_FIRE_CORAL_SLAB = registerBlock("hydrated_fire_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block HYDRATED_HORN_CORAL_SLAB = registerBlock("hydrated_horn_coral_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block MOSSY_POLISHED_BLACKSTONE_BRICK_SLAB = registerBlock("mossy_polished_blackstone_brick_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_SLAB = registerBlock("cracked_polished_blackstone_tile_slab",
            new SlabBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_STAIRS = registerBlock("cracked_polished_blackstone_brick_stairs",
            new StairsBlock(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS.getDefaultState(),FabricBlockSettings.copyOf(
                    Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block WHITE_SAND_STAIRS = registerBlock("white_sand_stairs",
            new FallingStairBlock(0xc0c0c0,DecoBlocks.WHITE_SAND.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.WHITE_SAND)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block BLACK_SAND_STAIRS = registerBlock("black_sand_stairs",
            new FallingStairBlock(0x404040,DecoBlocks.BLACK_SAND.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.BLACK_SAND)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block WHITE_SANDSTONE_STAIRS = registerBlock("white_sandstone_stairs",
            new StairsBlock(DecoBlocks.WHITE_SANDSTONE.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CUT_WHITE_SANDSTONE_STAIRS = registerBlock("cut_white_sandstone_stairs",
            new StairsBlock(DecoBlocks.CUT_WHITE_SANDSTONE.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CUT_WHITE_SANDSTONE_BRICK_STAIRS = registerBlock("cut_white_sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block BLACK_SANDSTONE_STAIRS = registerBlock("black_sandstone_stairs",
            new StairsBlock(DecoBlocks.BLACK_SANDSTONE.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    public static final Block CUT_BLACK_SANDSTONE_STAIRS = registerBlock("cut_black_sandstone_stairs",
            new StairsBlock(DecoBlocks.CUT_BLACK_SANDSTONE.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CUT_BLACK_SANDSTONE_BRICK_STAIRS = registerBlock("cut_black_sandstone_brick_stairs",
            new StairsBlock(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_STAIRS = registerBlock("cracked_red_nether_brick_stairs",
            new StairsBlock(DecoBlocks.CRACKED_RED_NETHER_BRICKS.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_BLUE_NETHER_BRICK_STAIRS = registerBlock("cracked_blue_nether_brick_stairs",
            new StairsBlock(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_STAIRS = registerBlock("cracked_polished_blackstone_tile_stairs",
            new StairsBlock(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES.getDefaultState(),
                    FabricBlockSettings.copyOf(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)), DecoItemGroup.VARAN_DECO_BUILDING);
    ...
    public static final Block SAND_CARPET = registerBlock("sand_carpet",
            new CarpetBlock(FabricBlockSettings.copyOf(Blocks.MOSS_CARPET).mapColor(MapColor.PALE_YELLOW)
                    .sounds(BlockSoundGroup.SAND)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block SCULK_CARPET = registerBlock("sculk_carpet",
            new CarpetBlock(FabricBlockSettings.copyOf(Blocks.MOSS_CARPET).mapColor(MapColor.BLACK)
                    .sounds(BlockSoundGroup.SCULK)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block GOLD_CHAIN = registerBlock("gold_chain",
            new ChainBlock(FabricBlockSettings.copyOf(Blocks.CHAIN)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_NETHER_BRICK_FENCE = registerBlock("cracked_nether_brick_fence",
            new FenceBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE = registerBlock("cracked_red_nether_brick_fence",
            new FenceBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE = registerBlock("cracked_blue_nether_brick_fence",
            new FenceBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block COAL_WALL = registerBlock("coal_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.COAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block AMETHYST_WALL = registerBlock("amethyst_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.AMETHYST_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block LAPIS_WALL = registerBlock("lapis_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.LAPIS_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_STONE_BRICK_WALL = registerBlock("cracked_stone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_DEEPSLATE_BRICK_WALL = registerBlock("cracked_deepslate_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CRACKED_DEEPSLATE_TILE_WALL = registerBlock("cracked_deepslate_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_DEEPSLATE_TILES)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CRACKED_NETHER_BRICK_WALL = registerBlock("cracked_nether_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block DEAD_TUBE_CORAL_WALL = registerBlock("dead_tube_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DEAD_BRAIN_CORAL_WALL = registerBlock("dead_brain_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DEAD_BUBBLE_CORAL_WALL = registerBlock("dead_bubble_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DEAD_FIRE_CORAL_WALL = registerBlock("dead_fire_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DEAD_HORN_CORAL_WALL = registerBlock("dead_horn_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.DEAD_HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block TUBE_CORAL_WALL = registerBlock("tube_coral_wall",
            new CoralWallBlock(DEAD_TUBE_CORAL_WALL, FabricBlockSettings.copyOf(Blocks.TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block BRAIN_CORAL_WALL = registerBlock("brain_coral_wall",
            new CoralWallBlock(DEAD_BRAIN_CORAL_WALL, FabricBlockSettings.copyOf(Blocks.DEAD_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block BUBBLE_CORAL_WALL = registerBlock("bubble_coral_wall",
            new CoralWallBlock(DEAD_BUBBLE_CORAL_WALL,FabricBlockSettings.copyOf(Blocks.BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block FIRE_CORAL_WALL = registerBlock("fire_coral_wall",
            new CoralWallBlock(DEAD_FIRE_CORAL_WALL,FabricBlockSettings.copyOf(Blocks.FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HORN_CORAL_WALL = registerBlock("horn_coral_wall",
            new CoralWallBlock(DEAD_HORN_CORAL_WALL,FabricBlockSettings.copyOf(Blocks.HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_BRICK_WALL = registerBlock("cracked_polished_blackstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HONEYCOMB_WALL = registerBlock("honeycomb_wall",
            new WallBlock(FabricBlockSettings.copyOf(Blocks.HONEYCOMB_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block DRIPSTONE_BRICK_WALL = registerBlock("dripstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DRIPSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DRIPSTONE_BRICK_PILLAR_WALL = registerBlock("dripstone_brick_pillar_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DRIPSTONE_BRICK_PILLAR)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block COAL_BRICK_WALL = registerBlock("coal_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.COAL_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHARCOAL_WALL = registerBlock("charcoal_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHARCOAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block FLINT_WALL = registerBlock("flint_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.FLINT_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block SHINED_AMETHYST_WALL = registerBlock("shined_amethyst_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_AMETHYST)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block AMETHYST_BRICK_WALL = registerBlock("amethyst_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.AMETHYST_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block SCATTERED_AMETHYST_WALL = registerBlock("scattered_amethyst_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SCATTERED_AMETHYST)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block ECHO_WALL = registerBlock("echo_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.ECHO_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block SHINED_ECHO_WALL = registerBlock("shined_echo_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SHINED_ECHO)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block ECHO_BRICK_WALL = registerBlock("echo_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.ECHO_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block SCATTERED_ECHO_WALL = registerBlock("scattered_echo_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SCATTERED_ECHO)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block LAPIS_BRICK_WALL = registerBlock("lapis_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.LAPIS_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CUT_LAPIS_WALL = registerBlock("cut_lapis_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_LAPIS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block SMOOTH_LAPIS_WALL = registerBlock("smooth_lapis_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_LAPIS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_STONE_TILE_WALL = registerBlock("cracked_stone_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_STONE_TILES)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block MOSSY_DEEPSLATE_BRICK_WALL = registerBlock("mossy_deepslate_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_DEEPSLATE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block MOSSY_END_STONE_BRICK_WALL = registerBlock("mossy_end_stone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CRACKED_END_STONE_BRICK_WALL = registerBlock("cracked_end_stone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_END_STONE_TILE_WALL = registerBlock("cracked_end_stone_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_END_STONE_TILES)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block VOID_STONE_BRICK_PILLAR_WALL = registerBlock("void_stone_brick_pillar_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.VOID_STONE_BRICK_PILLAR)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block DUEL_CUT_ORANGE_CONCRETE_WALL = registerBlock("duel_cut_orange_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_MAGENTA_CONCRETE_WALL = registerBlock("duel_cut_magenta_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_LIGHT_BLUE_CONCRETE_WALL = registerBlock("duel_cut_light_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_YELLOW_CONCRETE_WALL = registerBlock("duel_cut_yellow_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_LIME_CONCRETE_WALL = registerBlock("duel_cut_lime_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_PINK_CONCRETE_WALL = registerBlock("duel_cut_pink_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_GRAY_CONCRETE_WALL = registerBlock("duel_cut_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_LIGHT_GRAY_CONCRETE_WALL = registerBlock("duel_cut_light_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_CYAN_CONCRETE_WALL = registerBlock("duel_cut_cyan_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_PURPLE_CONCRETE_WALL = registerBlock("duel_cut_purple_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_BLUE_CONCRETE_WALL = registerBlock("duel_cut_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_BROWN_CONCRETE_WALL = registerBlock("duel_cut_brown_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_GREEN_CONCRETE_WALL = registerBlock("duel_cut_green_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_RED_CONCRETE_WALL = registerBlock("duel_cut_red_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block DUEL_CUT_BLACK_CONCRETE_WALL = registerBlock("duel_cut_black_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.DUEL_CUT_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_ORANGE_CONCRETE_WALL = registerBlock("checkered_orange_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_ORANGE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_MAGENTA_CONCRETE_WALL = registerBlock("checkered_magenta_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_MAGENTA_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_LIGHT_BLUE_CONCRETE_WALL = registerBlock("checkered_light_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_YELLOW_CONCRETE_WALL = registerBlock("checkered_yellow_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_YELLOW_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_LIME_CONCRETE_WALL = registerBlock("checkered_lime_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIME_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_PINK_CONCRETE_WALL = registerBlock("checkered_pink_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PINK_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_GRAY_CONCRETE_WALL = registerBlock("checkered_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_LIGHT_GRAY_CONCRETE_WALL = registerBlock("checkered_light_gray_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_LIGHT_GRAY_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_CYAN_CONCRETE_WALL = registerBlock("checkered_cyan_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_CYAN_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_PURPLE_CONCRETE_WALL = registerBlock("checkered_purple_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_PURPLE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_BLUE_CONCRETE_WALL = registerBlock("checkered_blue_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLUE_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_BROWN_CONCRETE_WALL = registerBlock("checkered_brown_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BROWN_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_GREEN_CONCRETE_WALL = registerBlock("checkered_green_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_GREEN_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_RED_CONCRETE_WALL = registerBlock("checkered_red_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_RED_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CHECKERED_BLACK_CONCRETE_WALL = registerBlock("checkered_black_concrete_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CHECKERED_BLACK_CONCRETE)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block WHITE_SANDSTONE_WALL = registerBlock("white_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CUT_WHITE_SANDSTONE_WALL = registerBlock("cut_white_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block SMOOTH_WHITE_SANDSTONE_WALL = registerBlock("smooth_white_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CUT_WHITE_SANDSTONE_BRICK_WALL = registerBlock("cut_white_sandstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block COBBLED_WHITE_SANDSTONE_WALL = registerBlock("cobbled_white_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block POLISHED_WHITE_SANDSTONE_WALL = registerBlock("polished_white_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_WHITE_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block WHITE_SANDSTONE_BRICK_WALL = registerBlock("white_sandstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.WHITE_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block BLACK_SANDSTONE_WALL = registerBlock("black_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CUT_BLACK_SANDSTONE_WALL = registerBlock("cut_black_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block SMOOTH_BLACK_SANDSTONE_WALL = registerBlock("smooth_black_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.SMOOTH_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block CUT_BLACK_SANDSTONE_BRICK_WALL = registerBlock("cut_black_sandstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block COBBLED_BLACK_SANDSTONE_WALL = registerBlock("cobbled_black_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.COBBLED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block POLISHED_BLACK_SANDSTONE_WALL = registerBlock("polished_black_sandstone_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.POLISHED_BLACK_SANDSTONE)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block BLACK_SANDSTONE_BRICK_WALL = registerBlock("black_sandstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.BLACK_SANDSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_RED_NETHER_BRICK_WALL = registerBlock("cracked_red_nether_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_BLUE_NETHER_BRICK_WALL = registerBlock("cracked_blue_nether_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_TUBE_CORAL_WALL = registerBlock("hydrated_tube_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_TUBE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_BRAIN_CORAL_WALL = registerBlock("hydrated_brain_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_BRAIN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_BUBBLE_CORAL_WALL = registerBlock("hydrated_bubble_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_BUBBLE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_FIRE_CORAL_WALL = registerBlock("hydrated_fire_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_FIRE_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_HORN_CORAL_WALL = registerBlock("hydrated_horn_coral_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.HYDRATED_HORN_CORAL_BLOCK)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block MOSSY_POLISHED_BLACKSTONE_BRICK_WALL = registerBlock("mossy_polished_blackstone_brick_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.MOSSY_POLISHED_BLACKSTONE_BRICKS)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block CRACKED_POLISHED_BLACKSTONE_TILE_WALL = registerBlock("cracked_polished_blackstone_tile_wall",
            new WallBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_POLISHED_BLACKSTONE_TILES)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block HARDENED_GLOWING_GLASS_PANE = registerBlock("hardened_glowing_glass_pane",
            new PaneBlock(FabricBlockSettings.copyOf(DecoBlocks.HARDENED_GLASS_PANE).luminance(state -> 15)
                    .nonOpaque()), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block HYDRATED_TUBE_CORAL = registerBlock("hydrated_tube_coral",
            new DeadCoralBlock(FabricBlockSettings.copyOf(Blocks.TUBE_CORAL)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_BRAIN_CORAL = registerBlock("hydrated_brain_coral",
            new DeadCoralBlock(FabricBlockSettings.copyOf(Blocks.BRAIN_CORAL)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_BUBBLE_CORAL = registerBlock("hydrated_bubble_coral",
            new DeadCoralBlock(FabricBlockSettings.copyOf(Blocks.BUBBLE_CORAL)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_FIRE_CORAL = registerBlock("hydrated_fire_coral",
            new DeadCoralBlock(FabricBlockSettings.copyOf(Blocks.FIRE_CORAL)), DecoItemGroup.VARAN_DECO_DECORATION);
    public static final Block HYDRATED_HORN_CORAL = registerBlock("hydrated_horn_coral",
            new DeadCoralBlock(FabricBlockSettings.copyOf(Blocks.HORN_CORAL)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block GOLD_LANTERN = registerBlock("gold_lantern",
            new LanternBlock(FabricBlockSettings.copyOf(Blocks.LANTERN)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block GOLD_SOUL_LANTERN = registerBlock("gold_soul_lantern",
            new LanternBlock(FabricBlockSettings.copyOf(Blocks.SOUL_LANTERN)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block HANGING_LAMP = registerBlock("hanging_lamp",
            new HangingLampBlock(FabricBlockSettings.of(Material.METAL).sounds(BlockSoundGroup.LANTERN)
                    .luminance(state -> 15)), DecoItemGroup.VARAN_DECO_DECORATION);

    public static final Block HANGING_WHITE_LAMP = registerBlock("hanging_white_lamp",
            new HangingLampBlock(FabricBlockSettings.copyOf(DecoBlocks.HANGING_LAMP)), DecoItemGroup.VARAN_DECO_DECORATION);
    ...
    public static final Block IRON_BAR_DOOR = registerBlock("iron_bar_door",
            new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_REDSTONE);
    ...
    public static final Block GOLD_BAR_DOOR = registerBlock("gold_bar_door",
            new DoorBlock(FabricBlockSettings.copyOf(DecoBlocks.GOLD_DOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_REDSTONE);
    ...
    public static final Block IRON_BAR_TRAPDOOR = registerBlock("iron_bar_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_TRAPDOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_REDSTONE);
    ...
    public static final Block GOLD_BAR_TRAPDOOR = registerBlock("gold_bar_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.copyOf(DecoBlocks.GOLD_TRAPDOOR).nonOpaque()), DecoItemGroup.VARAN_DECO_REDSTONE);
    ...
    public static final Block CRACKED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_nether_brick_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(Blocks.CRACKED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_REDSTONE);
    public static final Block CRACKED_RED_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_red_nether_brick_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_RED_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_REDSTONE);
    public static final Block CRACKED_BLUE_NETHER_BRICK_FENCE_GATE = registerBlock("cracked_blue_nether_brick_fence_gate",
            new FenceGateBlock(FabricBlockSettings.copyOf(DecoBlocks.CRACKED_BLUE_NETHER_BRICKS)), DecoItemGroup.VARAN_DECO_REDSTONE);
