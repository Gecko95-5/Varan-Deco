...
import net.gecko.varandeco.screen.wood.cartographytables.BirchCartographyTableScreenHandler;
...
public class BirchCartographyTableBlock extends Block {
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory(
			(syncId, inventory, player) -> new BirchCartographyTableScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), TITLE
		);
	}
}
