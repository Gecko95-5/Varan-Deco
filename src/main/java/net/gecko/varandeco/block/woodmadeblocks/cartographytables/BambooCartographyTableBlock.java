...
import net.gecko.varandeco.screen.wood.cartographytables.BambooCartographyTableScreenHandler;
...
public class BambooCartographyTableBlock extends NonStationBlock {
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory(
			(syncId, inventory, player) -> new BambooCartographyTableScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), TITLE
		);
	}
}
