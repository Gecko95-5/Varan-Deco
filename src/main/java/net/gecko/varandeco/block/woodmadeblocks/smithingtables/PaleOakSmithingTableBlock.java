...
import net.gecko.varandeco.screen.wood.smithingtables.PaleOakSmithingScreenHandler;
...
public class PaleOakSmithingTableBlock extends NonStationCraftingTableBlock {
	...
	public NamedScreenHandlerFactory createScreenHandlerFactory(BlockState state, World world, BlockPos pos) {
		return new SimpleNamedScreenHandlerFactory(
			(syncId, inventory, player) -> new PaleOakSmithingScreenHandler(syncId, inventory, ScreenHandlerContext.create(world, pos)), SCREEN_TITLE
		);
	}
