...
public class HangingLampBlock extends Block implements Waterloggable {
    public static final BooleanProperty HANGING = Properties.HANGING;
    public static final BooleanProperty WATERLOGGED = Properties.WATERLOGGED;
    protected static final VoxelShape STANDING_SHAPE = VoxelShapes.union(
            Block.createCuboidShape(5.0, 2.0, 5.0, 11.0, 9.0, 11.0), Block.createCuboidShape(6.0, 0.0, 6.0, 10.0, 2.0, 10.0)
    );
    ...
    public HangingLampBlock(AbstractBlock.Settings settings) {
        super(settings);
