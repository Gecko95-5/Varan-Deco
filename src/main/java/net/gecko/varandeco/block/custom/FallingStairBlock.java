...
public class FallingStairBlock extends StairsBlock implements LandingBlock {
    private final int color;
    public FallingStairBlock(int color, BlockState baseBlockState, Settings settings) {
