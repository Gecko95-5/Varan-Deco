...
// Thanks to PedalHat29861 Packed Grass is now has a Colour Base on the Biomes
    private static final Identifier GRASS_BASE_TEXTURE = Identifier.of(VaranDeco.MOD_ID, "block/grass_block_base");
    private static final Model CUBE_ALL_TINTED = new Model(Optional.of(Identifier.of(VaranDeco.MOD_ID, "block/cube_all_tinted")), Optional.empty(), TextureKey.ALL);
    private static final Model SLAB_TINTED = new Model(Optional.of(Identifier.of(VaranDeco.MOD_ID, "block/slab_tinted")), Optional.empty(), TextureKey.BOTTOM, TextureKey.TOP, TextureKey.SIDE);
    private static final Model SLAB_TOP_TINTED = new Model(Optional.of(Identifier.of(VaranDeco.MOD_ID, "block/slab_top_tinted")), Optional.empty(), TextureKey.BOTTOM, TextureKey.TOP, TextureKey.SIDE);
    private static final Model STAIRS_TINTED = new Model(Optional.of(Identifier.of(VaranDeco.MOD_ID, "block/stairs_tinted")), Optional.empty(), TextureKey.BOTTOM, TextureKey.TOP, TextureKey.SIDE);
    private static final Model STAIRS_INNER_TINTED = new Model(Optional.of(Identifier.of(VaranDeco.MOD_ID, "block/stairs_inner_tinted")), Optional.empty(), TextureKey.BOTTOM, TextureKey.TOP, TextureKey.SIDE);
    private static final Model STAIRS_OUTER_TINTED = new Model(Optional.of(Identifier.of(VaranDeco.MOD_ID, "block/stairs_outer_tinted")), Optional.empty(), TextureKey.BOTTOM, TextureKey.TOP, TextureKey.SIDE);
    private static final Model CARPET_TINTED = new Model(Optional.of(Identifier.of(VaranDeco.MOD_ID, "block/carpet_tinted")), Optional.empty(), TextureKey.WOOL);
    //
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
       BlockStateModelGenerator.BlockTexturePool andesitepool =
        ...
        BlockStateModelGenerator.BlockTexturePool smoothWhiteSandstonePool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.SMOOTH_WHITE_SANDSTONE);
        BlockStateModelGenerator.BlockTexturePool cobWhiteSandstonePool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.COBBLED_WHITE_SANDSTONE);
        BlockStateModelGenerator.BlockTexturePool polishedWhiteSandstonePool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.POLISHED_WHITE_SANDSTONE);
        BlockStateModelGenerator.BlockTexturePool whiteSandstoneBricksPool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.WHITE_SANDSTONE_BRICKS);

        blockStateModelGenerator.registerSimpleState(DecoBlocks.WHITE_SANDSTONE);
        blockStateModelGenerator.registerSimpleState(DecoBlocks.CHISELED_WHITE_SANDSTONE);
        blockStateModelGenerator.registerSimpleState(DecoBlocks.CUT_WHITE_SANDSTONE);
        blockStateModelGenerator.registerSimpleState(DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS);
        blockStateModelGenerator.registerSimpleCubeAll(DecoBlocks.CHISELED_POLISHED_WHITE_SANDSTONE);

        BlockStateModelGenerator.BlockTexturePool smoothBlackSandstonePool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.SMOOTH_BLACK_SANDSTONE);
        BlockStateModelGenerator.BlockTexturePool cobBlackSandstonePool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.COBBLED_BLACK_SANDSTONE);
        BlockStateModelGenerator.BlockTexturePool polishedBlackSandstonePool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.POLISHED_BLACK_SANDSTONE);
        BlockStateModelGenerator.BlockTexturePool blackSandstoneBricksPool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.BLACK_SANDSTONE_BRICKS);

        blockStateModelGenerator.registerSimpleState(DecoBlocks.BLACK_SANDSTONE);
        blockStateModelGenerator.registerSimpleState(DecoBlocks.CHISELED_BLACK_SANDSTONE);
        blockStateModelGenerator.registerSimpleState(DecoBlocks.CUT_BLACK_SANDSTONE);
        blockStateModelGenerator.registerSimpleState(DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS);
        blockStateModelGenerator.registerSimpleCubeAll(DecoBlocks.CHISELED_POLISHED_BLACK_SANDSTONE);
        ...
        blockStateModelGenerator.registerWoolAndCarpet(DecoBlocks.WHITE_SAND, DecoBlocks.WHITE_SAND_CARPET);

        BlockStateModelGenerator.BlockTexturePool whiteSandPool =
                blockStateModelGenerator.registerCubeAllModelTexturePool(DecoBlocks.WHITE_SAND_TEMP);

        blockStateModelGenerator.registerWoolAndCarpet(DecoBlocks.BLACK_SAND, DecoBlocks.BLACK_SAND_CARPET);
        ...
        blockStateModelGenerator.registerLantern(DecoBlocks.GOLD_LANTERN);
        blockStateModelGenerator.registerLantern(DecoBlocks.GOLD_SOUL_LANTERN);

        blockStateModelGenerator.registerDoor(DecoBlocks.IRON_BAR_DOOR);
        blockStateModelGenerator.registerDoor(DecoBlocks.GOLD_BAR_DOOR);

        blockStateModelGenerator.registerTrapdoor(DecoBlocks.IRON_BAR_TRAPDOOR);
        blockStateModelGenerator.registerTrapdoor(DecoBlocks.GOLD_BAR_TRAPDOOR);
        ...
        blockStateModelGenerator.registerDoor(DecoBlocks.COPPER_BAR_DOOR);
        blockStateModelGenerator.registerDoor(DecoBlocks.EXPOSED_COPPER_BAR_DOOR);
        blockStateModelGenerator.registerDoor(DecoBlocks.WEATHERED_COPPER_BAR_DOOR);
        blockStateModelGenerator.registerDoor(DecoBlocks.OXIDIZED_COPPER_BAR_DOOR);

        blockStateModelGenerator.registerParentedDoor(DecoBlocks.COPPER_BAR_DOOR, DecoBlocks.WAXED_COPPER_BAR_DOOR);
        blockStateModelGenerator.registerParentedDoor(DecoBlocks.EXPOSED_COPPER_BAR_DOOR, DecoBlocks.WAXED_EXPOSED_COPPER_BAR_DOOR);
        blockStateModelGenerator.registerParentedDoor(DecoBlocks.WEATHERED_COPPER_BAR_DOOR, DecoBlocks.WAXED_WEATHERED_COPPER_BAR_DOOR);
        blockStateModelGenerator.registerParentedDoor(DecoBlocks.OXIDIZED_COPPER_BAR_DOOR, DecoBlocks.WAXED_OXIDIZED_COPPER_BAR_DOOR);

        blockStateModelGenerator.registerTrapdoor(DecoBlocks.COPPER_BAR_TRAPDOOR);
        blockStateModelGenerator.registerTrapdoor(DecoBlocks.EXPOSED_COPPER_BAR_TRAPDOOR);
        blockStateModelGenerator.registerTrapdoor(DecoBlocks.WEATHERED_COPPER_BAR_TRAPDOOR);
        blockStateModelGenerator.registerTrapdoor(DecoBlocks.OXIDIZED_COPPER_BAR_TRAPDOOR);

        blockStateModelGenerator.registerParentedTrapdoor(DecoBlocks.COPPER_BAR_TRAPDOOR, DecoBlocks.WAXED_COPPER_BAR_TRAPDOOR);
        blockStateModelGenerator.registerParentedTrapdoor(DecoBlocks.EXPOSED_COPPER_BAR_TRAPDOOR, DecoBlocks.WAXED_EXPOSED_COPPER_BAR_TRAPDOOR);
        blockStateModelGenerator.registerParentedTrapdoor(DecoBlocks.WEATHERED_COPPER_BAR_TRAPDOOR, DecoBlocks.WAXED_WEATHERED_COPPER_BAR_TRAPDOOR);
        blockStateModelGenerator.registerParentedTrapdoor(DecoBlocks.OXIDIZED_COPPER_BAR_TRAPDOOR, DecoBlocks.WAXED_OXIDIZED_COPPER_BAR_TRAPDOOR);
       ...
       smoothblackstonepool.wall(DecoBlocks.SMOOTH_BLACKSTONE_WALL);
        ...
        tubecoralpool.parented(DecoBlocks.TUBE_CORAL_TEMP,DecoBlocks.HYDRATED_TUBE_CORAL_BLOCK);
        bubblecoralpool.parented(DecoBlocks.BUBBLE_CORAL_TEMP,DecoBlocks.HYDRATED_BUBBLE_CORAL_BLOCK);
        braincoralpool.parented(DecoBlocks.BRAIN_CORAL_TEMP,DecoBlocks.HYDRATED_BRAIN_CORAL_BLOCK);
        firecoralpool.parented(DecoBlocks.FIRE_CORAL_TEMP,DecoBlocks.HYDRATED_FIRE_CORAL_BLOCK);
        horncoralpool.parented(DecoBlocks.HORN_CORAL_TEMP,DecoBlocks.HYDRATED_HORN_CORAL_BLOCK);
