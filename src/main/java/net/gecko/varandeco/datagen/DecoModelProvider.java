...
// Thanks to PedalHat29861 Packed Grass is now has a Colour Base on the Biomes
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        blockStateModelGenerator.registerFlowerPotPlantAndItem(DecoBlocks.TAIGA_DANDELION, DecoBlocks.POTTED_TAIGA_DANDELION,
                BlockStateModelGenerator.CrossType.NOT_TINTED);
        blockStateModelGenerator.registerFlowerPotPlantAndItem(DecoBlocks.FERN_LAVENDER, DecoBlocks.POTTED_FERN_LAVENDER,
                BlockStateModelGenerator.CrossType.NOT_TINTED);
        blockStateModelGenerator.registerFlowerPotPlantAndItem(DecoBlocks.CARAMEL_BUTTERCUP, DecoBlocks.POTTED_CARAMEL_BUTTERCUP,
                BlockStateModelGenerator.CrossType.NOT_TINTED);
        blockStateModelGenerator.registerFlowerPotPlantAndItem(DecoBlocks.SILVER_ROSE, DecoBlocks.POTTED_SILVER_ROSE,
                BlockStateModelGenerator.CrossType.NOT_TINTED);
        blockStateModelGenerator.registerFlowerPotPlantAndItem(DecoBlocks.ALPINE_SPEEDWELL, DecoBlocks.POTTED_ALPINE_SPEEDWELL,
                BlockStateModelGenerator.CrossType.NOT_TINTED);

        blockStateModelGenerator.registerDoubleBlock(DecoBlocks.MEGA_BROWN_TULIP,
                BlockStateModelGenerator.CrossType.NOT_TINTED);

        blockStateModelGenerator.registerDoubleBlock(DecoBlocks.MEGA_GRAY_TULIP,
                BlockStateModelGenerator.CrossType.NOT_TINTED);
        ...
        ironcappool.fenceGate(DecoBlocks.IRON_CAP_FENCE_GATE);bluenetherpool.stairs(DecoBlocks.BLUE_NETHER_BRICK_STAIRS);
       ...
       blockStateModelGenerator.registerCrop(DecoBlocks.WARPED_WART_PLANT, WarpedWartBlock.AGE,0,1,2,3);
        ...
        blockStateModelGenerator.registerGlassAndPane(DecoBlocks.GLOWING_GLASS, DecoBlocks.GLOWING_GLASS_PANE);
        blockStateModelGenerator.registerGlassAndPane(DecoBlocks.HARDENED_GLOWING_GLASS, DecoBlocks.HARDENED_GLOWING_GLASS_PANE);
