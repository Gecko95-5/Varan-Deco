...
public class DecoRecipeGenerator extends FabricRecipeProvider {
  ...
  @Override
    ...
    offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_SANDSTONE_BRICK_SLAB, Items.SANDSTONE,2);
    offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_SANDSTONE_BRICK_SLAB, Items.CUT_SANDSTONE,2);
    ...
    offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_RED_SANDSTONE_BRICK_SLAB, Items.RED_SANDSTONE,2);
    offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_RED_SANDSTONE_BRICK_SLAB, Items.CUT_RED_SANDSTONE,2);
    ...
    createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_CRYSTALLIZED_PRISMARINE_BRICKS,4)
        .pattern(" # ")
        .pattern("#I#")
        .pattern(" # ")
    ...
    createShapeless(RecipeCategory.BUILDING_BLOCKS,DecoBlocks.COBBLED_SOUL_SOILSTONE,4)
    ...
    public void  offerLadderVariantRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible woodInput) {
            ...
            public void offerBasicStairSlabWallRecipes(
                ...
                createStairsRecipe(stair, Ingredient.ofItems(blockInput))
                        ...
                        .offerTo(exporter, (getRecipeName(stair)));
