...
public class DecoRecipeGeneratorTwo extends FabricRecipeProvider {
    ...
    protected RecipeGenerator getRecipeGenerator(RegistryWrapper.WrapperLookup registryLookup, RecipeExporter exporter) {
        ...
        offerChiseledBlockRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_LAPIS, DecoBlocks.LAPIS_SLAB);
        ...
        createShapeless(RecipeCategory.MISC, DecoBlocks.BROWN_BLOCK,2)
                ...
                .offerTo(exporter,("brown_block_from_purple_block"));
        ...
        createShapeless(RecipeCategory.MISC, Items.BROWN_DYE,2)
                ...
                .offerTo(exporter,("brown_dye_from_purple_dye"));
        ...
        createShapeless(RecipeCategory.MISC, DecoBlocks.BROWN_BLOCK,2)
                ...
                .criterion(hasItem(DecoBlocks.ORANGE_BLOCK),
                        conditionsFromItem(DecoBlocks.ORANGE_BLOCK))
                .offerTo(exporter,("brown_block_from_orange_block"));
        ...
        createShapeless(RecipeCategory.MISC, Items.BROWN_DYE,2)
                ...
                .offerTo(exporter,("brown_dye_from_orange_dye"));

        createShaped(RecipeCategory.DECORATIONS, Items.COBWEB)
                .pattern(" / ")
                .pattern("/ /")
                .pattern(" / ")
                .input('/', Items.STRING)
                ...
                .offerTo(exporter, (getRecipeName(Items.COBWEB) + "_recipe_create"));

        createShaped(RecipeCategory.DECORATIONS,DecoBlocks.GLOWING_GLASS,2)
                .pattern(" # ")
                .pattern("#X#")
                .pattern(" # ")
                ...
                .offerTo(exporter,(getRecipeName(DecoBlocks.GLOWING_GLASS)+ "_recipe_create"));

        createShaped(RecipeCategory.DECORATIONS,DecoBlocks.GLOWING_GLASS_PANE,6)
                .pattern(" # ")
                .pattern("#X#")
                .pattern(" # ")
                .input('#', Items.GLOWSTONE_DUST)
                ...
                .criterion(hasItem(Items.GLOWSTONE_DUST),
                        conditionsFromItem(Items.GLOWSTONE_DUST))
                .offerTo(exporter,("glowing_glass_pane_glowstone_dust"));

        createShaped(RecipeCategory.DECORATIONS,DecoBlocks.GLOWING_GLASS_PANE,18)
                .pattern("###")
                .pattern("###")
                .input('#', DecoBlocks.GLOWING_GLASS)
                .group("glowing_glass_pane")
                .criterion(hasItem(DecoBlocks.GLOWING_GLASS),
                        conditionsFromItem(DecoBlocks.GLOWING_GLASS))
                .offerTo(exporter,(getRecipeName(DecoBlocks.GLOWING_GLASS_PANE)+ "_recipe_create"));

        offerHardenedGlassRecipe(exporter,DecoBlocks.HARDENED_GLOWING_GLASS, DecoBlocks.GLOWING_GLASS);

        createShaped(RecipeCategory.DECORATIONS, DecoBlocks.HARDENED_GLOWING_GLASS,2)
                .pattern(" # ")
                .pattern("#X#")
                .pattern(" # ")
                .input('#', Items.GLOWSTONE_DUST)
                ...
                .criterion(hasItem(Items.GLOWSTONE_DUST),
                        conditionsFromItem(Items.GLOWSTONE_DUST))
                .offerTo(exporter,(getRecipeName(DecoBlocks.HARDENED_GLOWING_GLASS)+ "_recipe_create"));

        offerHardenedGlassPaneRecipe(exporter,DecoBlocks.HARDENED_GLOWING_GLASS_PANE, DecoBlocks.GLOWING_GLASS_PANE);

        createShaped(RecipeCategory.DECORATIONS, DecoBlocks.HARDENED_GLOWING_GLASS_PANE,6)
                .pattern(" # ")
                .pattern("#X#")
                .pattern(" # ")
                .input('#', Items.GLOWSTONE_DUST)
                ...
                .criterion(hasItem(Items.GLOWSTONE_DUST),
                        conditionsFromItem(Items.GLOWSTONE_DUST))
                .offerTo(exporter,("hardened_glowing_glass_pane_glowstone_dust"));

        createShaped(RecipeCategory.DECORATIONS, DecoBlocks.HARDENED_GLOWING_GLASS_PANE,18)
                .pattern("###")
                .pattern("###")
                .input('#', DecoBlocks.HARDENED_GLOWING_GLASS)
                .group("hardened_glass_pane")
                .criterion(hasItem(DecoBlocks.HARDENED_GLOWING_GLASS),
                        conditionsFromItem(DecoBlocks.HARDENED_GLOWING_GLASS))
                .offerTo(exporter,(getRecipeName(DecoBlocks.HARDENED_GLOWING_GLASS_PANE)+ "_recipe_create"));

        createShapeless(RecipeCategory.MISC, Items.GRAY_DYE)
                .input(DecoBlocks.TAIGA_DANDELION)
                .group("gray_dye")
                .criterion(hasItem(DecoBlocks.TAIGA_DANDELION),
                        conditionsFromItem(DecoBlocks.TAIGA_DANDELION))
                .offerTo(exporter,("gray_dye_from_taiga_dandelion"));
        createShapeless(RecipeCategory.MISC, Items.GREEN_DYE)
                .input(DecoBlocks.FERN_LAVENDER)
                .group("green_dye")
                .criterion(hasItem(DecoBlocks.FERN_LAVENDER),
                        conditionsFromItem(DecoBlocks.FERN_LAVENDER))
                .offerTo(exporter,("green_dye_from_fern_lavender"));
        createShapeless(RecipeCategory.MISC, Items.BROWN_DYE)
                .input(DecoBlocks.CARAMEL_BUTTERCUP)
                .group("brown_dye")
                .criterion(hasItem(DecoBlocks.CARAMEL_BUTTERCUP),
                        conditionsFromItem(DecoBlocks.CARAMEL_BUTTERCUP))
                .offerTo(exporter,("brown_dye_from_caramel_buttercup"));
        createShapeless(RecipeCategory.MISC, Items.LIGHT_GRAY_DYE)
                .input(DecoBlocks.SILVER_ROSE)
                .group("light_gray_dye")
                .criterion(hasItem(DecoBlocks.SILVER_ROSE),
                        conditionsFromItem(DecoBlocks.SILVER_ROSE))
                .offerTo(exporter,("light_gray_dye_from_silver_rose"));
        createShapeless(RecipeCategory.MISC, Items.PURPLE_DYE)
                .input(DecoBlocks.ALPINE_SPEEDWELL)
                .group("purple_dye")
                .criterion(hasItem(DecoBlocks.ALPINE_SPEEDWELL),
                        conditionsFromItem(DecoBlocks.ALPINE_SPEEDWELL))
                .offerTo(exporter,("purple_dye_from_alpine_speedwell"));

        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.GOLD_CHAIN)
                .pattern("-")
                .pattern("#")
                .pattern("-")
                .input('-', Items.GOLD_INGOT)
                ...
                .criterion(hasItem(Items.GOLD_INGOT),
                        conditionsFromItem(Items.GOLD_INGOT))
                .offerTo(exporter,(getRecipeName(DecoBlocks.GOLD_CHAIN)+ "_recipe_create"));

        offerBasicStairSlabWallRecipes(exporter, Items.COAL_BLOCK, DecoBlocks.COAL_STAIRS,
                DecoBlocks.COAL_SLAB, DecoBlocks.COAL_WALL);

        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COAL_BRICKS)
                .pattern("B#")
                .pattern("#B")
                .input('#', Items.COAL)
                .input('B', Items.BRICK)
                ...
                .offerTo(exporter,(getRecipeName(DecoBlocks.COAL_BRICKS)+ "_recipe_create"));
        ...
        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SAND,4)
                .pattern("P#")
                .pattern("#P")
                .input('#', Items.SAND)
                .input('P', DecoItems.PASSTOL)
                .criterion(hasItem(DecoItems.PASSTOL),
                        conditionsFromItem(DecoItems.PASSTOL))
                .offerTo(exporter,(getRecipeName(DecoBlocks.WHITE_SAND)+ "_recipe_create"));

        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SAND,4)
                .pattern("S#")
                .pattern("#S")
                .input('#', Items.SAND)
                .input('S', DecoItems.SHADDOL)
                .criterion(hasItem(DecoItems.SHADDOL),
                        conditionsFromItem(DecoItems.SHADDOL))
                .offerTo(exporter,(getRecipeName(DecoBlocks.BLACK_SAND)+ "_recipe_create"));
        ...
        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE, DecoBlocks.WHITE_SANDSTONE);
        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE, DecoBlocks.BLACK_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_STAIRS, DecoBlocks.WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_SLAB, DecoBlocks.WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_WALL, DecoBlocks.WHITE_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_STAIRS, DecoBlocks.BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_SLAB, DecoBlocks.BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_WALL, DecoBlocks.BLACK_SANDSTONE);

        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_BRICKS, DecoBlocks.CUT_WHITE_SANDSTONE);
        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_BRICKS, DecoBlocks.CUT_BLACK_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_STAIRS, DecoBlocks.WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_SLAB, DecoBlocks.WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_WALL, DecoBlocks.WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_STAIRS, DecoBlocks.CUT_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_SLAB, DecoBlocks.CUT_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_WHITE_SANDSTONE_BRICK_WALL, DecoBlocks.CUT_WHITE_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_STAIRS, DecoBlocks.BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_SLAB, DecoBlocks.BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_WALL, DecoBlocks.BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_STAIRS, DecoBlocks.CUT_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_SLAB, DecoBlocks.CUT_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CUT_BLACK_SANDSTONE_BRICK_WALL, DecoBlocks.CUT_BLACK_SANDSTONE);
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.WHITE_SANDSTONE), RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SMOOTH_WHITE_SANDSTONE,
                ...
                .offerTo(exporter,(getRecipeName(DecoBlocks.SMOOTH_WHITE_SANDSTONE)+ "_recipe_create"));
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.WHITE_SANDSTONE_STAIRS), RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SMOOTH_WHITE_SANDSTONE_STAIRS,
                ...
                .offerTo(exporter,("smooth_white_sandstone_stairs_from_smelting"));
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.WHITE_SANDSTONE_SLAB), RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SMOOTH_WHITE_SANDSTONE_SLAB,
                ...
                .offerTo(exporter,("smooth_white_sandstone_slab_from_smelting"));
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.WHITE_SANDSTONE_WALL), RecipeCategory.DECORATIONS, DecoBlocks.SMOOTH_WHITE_SANDSTONE_WALL,
                ...
                .offerTo(exporter,("smooth_white_sandstone_wall_from_smelting"));
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.BLACK_SANDSTONE), RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SMOOTH_BLACK_SANDSTONE,
                ...
                .offerTo(exporter,(getRecipeName(DecoBlocks.SMOOTH_BLACK_SANDSTONE)+ "_recipe_create"));
        ...
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.BLACK_SANDSTONE_STAIRS), RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SMOOTH_BLACK_SANDSTONE_STAIRS,
                ...
                .offerTo(exporter,("smooth_black_sandstone_stairs_from_smelting"));
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.BLACK_SANDSTONE_SLAB), RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SMOOTH_BLACK_SANDSTONE_SLAB,
                ...
                .offerTo(exporter,("smooth_black_sandstone_slab_from_smelting"));
        CookingRecipeJsonBuilder.createSmelting(Ingredient.ofItems(DecoBlocks.BLACK_SANDSTONE_WALL), RecipeCategory.DECORATIONS, DecoBlocks.SMOOTH_BLACK_SANDSTONE_WALL,
                ...
                .offerTo(exporter,("smooth_black_sandstone_wall_from_smelting"));

        createShapeless(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_WHITE_SANDSTONE,4)
                .input(DecoBlocks.WHITE_SANDSTONE)
                .criterion(hasItem(DecoBlocks.WHITE_SANDSTONE),
                        conditionsFromItem(DecoBlocks.WHITE_SANDSTONE))
                .offerTo(exporter,(getRecipeName(DecoBlocks.COBBLED_WHITE_SANDSTONE)+ "_recipe_create"));
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_WHITE_SANDSTONE, DecoBlocks.WHITE_SANDSTONE,4);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_WHITE_SANDSTONE_STAIRS, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_WHITE_SANDSTONE_SLAB, DecoBlocks.WHITE_SANDSTONE,8);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_WHITE_SANDSTONE_WALL, DecoBlocks.WHITE_SANDSTONE,4);

        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE, DecoBlocks.COBBLED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE, DecoBlocks.COBBLED_WHITE_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE_STAIRS, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE_STAIRS, DecoBlocks.COBBLED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE_SLAB, DecoBlocks.WHITE_SANDSTONE,8);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE_SLAB, DecoBlocks.COBBLED_WHITE_SANDSTONE,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE_WALL, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_WHITE_SANDSTONE_WALL, DecoBlocks.COBBLED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_POLISHED_WHITE_SANDSTONE, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_POLISHED_WHITE_SANDSTONE, DecoBlocks.COBBLED_WHITE_SANDSTONE);

        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICKS, DecoBlocks.POLISHED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICKS, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICKS, DecoBlocks.COBBLED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICKS, DecoBlocks.POLISHED_WHITE_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_STAIRS, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_STAIRS, DecoBlocks.COBBLED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_STAIRS, DecoBlocks.POLISHED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_SLAB, DecoBlocks.WHITE_SANDSTONE,8);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_SLAB, DecoBlocks.COBBLED_WHITE_SANDSTONE,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_SLAB, DecoBlocks.POLISHED_WHITE_SANDSTONE,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_WALL, DecoBlocks.WHITE_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_WALL, DecoBlocks.COBBLED_WHITE_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.WHITE_SANDSTONE_BRICK_WALL, DecoBlocks.POLISHED_WHITE_SANDSTONE);

        createShapeless(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_BLACK_SANDSTONE,4)
                .input(DecoBlocks.BLACK_SANDSTONE)
                .criterion(hasItem(DecoBlocks.BLACK_SANDSTONE),
                        conditionsFromItem(DecoBlocks.BLACK_SANDSTONE))
                .offerTo(exporter,(getRecipeName(DecoBlocks.COBBLED_BLACK_SANDSTONE)+ "_recipe_create"));
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_BLACK_SANDSTONE, DecoBlocks.BLACK_SANDSTONE,4);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_BLACK_SANDSTONE_STAIRS, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_BLACK_SANDSTONE_SLAB, DecoBlocks.BLACK_SANDSTONE,8);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.COBBLED_BLACK_SANDSTONE_WALL, DecoBlocks.BLACK_SANDSTONE,4);

        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE, DecoBlocks.COBBLED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE, DecoBlocks.COBBLED_BLACK_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE_STAIRS, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE_STAIRS, DecoBlocks.COBBLED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE_SLAB, DecoBlocks.BLACK_SANDSTONE,8);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE_SLAB, DecoBlocks.COBBLED_BLACK_SANDSTONE,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE_WALL, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.POLISHED_BLACK_SANDSTONE_WALL, DecoBlocks.COBBLED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_POLISHED_BLACK_SANDSTONE, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.CHISELED_POLISHED_BLACK_SANDSTONE, DecoBlocks.COBBLED_BLACK_SANDSTONE);

        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICKS, DecoBlocks.POLISHED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICKS, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICKS, DecoBlocks.COBBLED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICKS, DecoBlocks.POLISHED_BLACK_SANDSTONE);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_STAIRS, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_STAIRS, DecoBlocks.COBBLED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_STAIRS, DecoBlocks.POLISHED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_SLAB, DecoBlocks.BLACK_SANDSTONE,8);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_SLAB, DecoBlocks.COBBLED_BLACK_SANDSTONE,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_SLAB, DecoBlocks.POLISHED_BLACK_SANDSTONE,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_WALL, DecoBlocks.BLACK_SANDSTONE,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_WALL, DecoBlocks.COBBLED_BLACK_SANDSTONE);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.BLACK_SANDSTONE_BRICK_WALL, DecoBlocks.POLISHED_BLACK_SANDSTONE);

        createShaped(RecipeCategory.DECORATIONS, DecoBlocks.GOLD_LANTERN)
                .pattern("---")
                .pattern("-#-")
                .pattern("---")
                .input('-', Items.TORCH)
                ...
                .criterion(hasItem(Items.GOLD_NUGGET),
                        conditionsFromItem(Items.GOLD_NUGGET))
                .offerTo(exporter,(getRecipeName(DecoBlocks.GOLD_LANTERN)+ "_recipe_create"));

        createShaped(RecipeCategory.DECORATIONS, DecoBlocks.GOLD_SOUL_LANTERN)
                .pattern("---")
                .pattern("-#-")
                .pattern("---")
                .input('-', Items.SOUL_TORCH)
                ...
                .criterion(hasItem(Items.SOUL_TORCH),
                        conditionsFromItem(Items.SOUL_TORCH))
                .offerTo(exporter,(getRecipeName(DecoBlocks.GOLD_SOUL_LANTERN)+ "_recipe_create"));

        createShaped(RecipeCategory.REDSTONE, DecoBlocks.IRON_BAR_DOOR,3)
                .pattern("#-")
                .pattern("#-")
                .pattern("--")
                ...
                .offerTo(exporter,(getRecipeName(DecoBlocks.IRON_BAR_DOOR)+ "_recipe_create"));

        createShaped(RecipeCategory.REDSTONE, DecoBlocks.GOLD_BAR_DOOR,3)
                .pattern("#-")
                .pattern("#-")
                .pattern("--")
                .input('-', Items.GOLD_INGOT)
                ...
                .criterion(hasItem(DecoBlocks.GOLD_BARS),
                        conditionsFromItem(DecoBlocks.GOLD_BARS))
                .offerTo(exporter,(getRecipeName(DecoBlocks.GOLD_BAR_DOOR)+ "_recipe_create"));

        createShaped(RecipeCategory.REDSTONE, DecoBlocks.IRON_BAR_TRAPDOOR)
                .pattern("#-")
                .pattern("--")
                .input('-', Items.IRON_INGOT)
                .input('#', Items.IRON_BARS)
                .criterion(hasItem(Items.IRON_BARS),
                        conditionsFromItem(Items.IRON_BARS))
                .offerTo(exporter,(getRecipeName(DecoBlocks.IRON_BAR_TRAPDOOR)+ "_recipe_create"));

        createShaped(RecipeCategory.REDSTONE, DecoBlocks.GOLD_BAR_TRAPDOOR)
                .pattern("#-")
                .pattern("--")
                .input('-', Items.GOLD_INGOT)
                .input('#', DecoBlocks.GOLD_BARS)
                .criterion(hasItem(DecoBlocks.GOLD_BARS),
                        conditionsFromItem(DecoBlocks.GOLD_BARS))
                .offerTo(exporter,(getRecipeName(DecoBlocks.GOLD_BAR_TRAPDOOR)+ "_recipe_create"));
        ...
        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SHINED_AMETHYST,2)
                .pattern("#F")
                .pattern("F#")
                .input('F', Items.FLINT)
                .input('#', Items.AMETHYST_BLOCK)
                .criterion(hasItem(Items.AMETHYST_BLOCK),
                        conditionsFromItem(Items.AMETHYST_BLOCK))
                .offerTo(exporter,(getRecipeName(DecoBlocks.SHINED_AMETHYST)+ "_recipe_create"));
        ...
        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SHINED_ECHO,2)
                .pattern("#F")
                .pattern("F#")
                .input('F', Items.FLINT)
                .input('#', DecoBlocks.ECHO_BLOCK)
                .criterion(hasItem(DecoBlocks.ECHO_BLOCK),
                        conditionsFromItem(DecoBlocks.ECHO_BLOCK))
                .offerTo(exporter,(getRecipeName(DecoBlocks.SHINED_ECHO)+ "_recipe_create"));
        ...
        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_AMETHYST,4)
                .pattern("#/")
                .pattern("/#")
                .input('/', Items.AMETHYST_SHARD)
                .input('#', DecoBlocks.SHINED_AMETHYST)
                .criterion(hasItem(DecoBlocks.SHINED_AMETHYST),
                        conditionsFromItem(DecoBlocks.SHINED_AMETHYST))
                .offerTo(exporter,(getRecipeName(DecoBlocks.SCATTERED_AMETHYST)+ "_recipe_create"));
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_AMETHYST, DecoBlocks.SHINED_AMETHYST,2);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_AMETHYST_STAIRS, DecoBlocks.SHINED_AMETHYST,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_AMETHYST_SLAB, DecoBlocks.SHINED_AMETHYST,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_AMETHYST_WALL, DecoBlocks.SHINED_AMETHYST,2);

        createShaped(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_ECHO,4)
                .pattern("#/")
                .pattern("/#")
                .input('/', Items.ECHO_SHARD)
                .input('#', DecoBlocks.SHINED_ECHO)
                .criterion(hasItem(DecoBlocks.SHINED_ECHO),
                        conditionsFromItem(DecoBlocks.SHINED_ECHO))
                .offerTo(exporter,(getRecipeName(DecoBlocks.SCATTERED_ECHO)+ "_recipe_create"));
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_ECHO, DecoBlocks.SHINED_ECHO,2);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_ECHO_STAIRS, DecoBlocks.SHINED_ECHO,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_ECHO_SLAB, DecoBlocks.SHINED_ECHO,4);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.SCATTERED_ECHO_WALL, DecoBlocks.SHINED_ECHO,2);

        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.AMETHYST_BRICKS, DecoBlocks.SHINED_AMETHYST);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.AMETHYST_BRICKS, DecoBlocks.SHINED_AMETHYST);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.AMETHYST_BRICK_STAIRS, DecoBlocks.SHINED_AMETHYST);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.AMETHYST_BRICK_SLAB, DecoBlocks.SHINED_AMETHYST,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.AMETHYST_BRICK_WALL, DecoBlocks.SHINED_AMETHYST);

        offerPolishedStoneRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.ECHO_BRICKS, DecoBlocks.SHINED_ECHO);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.ECHO_BRICKS, DecoBlocks.SHINED_ECHO);
        ...
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.ECHO_BRICK_STAIRS, DecoBlocks.SHINED_ECHO);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.ECHO_BRICK_SLAB, DecoBlocks.SHINED_ECHO,2);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.ECHO_BRICK_WALL, DecoBlocks.SHINED_ECHO);

        offerPillarBlockRecipe(exporter, DecoBlocks.AMETHYST_PILLAR, DecoBlocks.SHINED_AMETHYST_SLAB);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.AMETHYST_PILLAR, DecoBlocks.SHINED_AMETHYST);

        offerPillarBlockRecipe(exporter, DecoBlocks.ECHO_PILLAR, DecoBlocks.SHINED_ECHO_SLAB);
        offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, DecoBlocks.ECHO_PILLAR, DecoBlocks.SHINED_ECHO);

        createShaped(RecipeCategory.REDSTONE, DecoBlocks.COPPER_BAR_DOOR,3)
                .pattern("#-")
                .pattern("#-")
                .pattern("--")
                ...
                .offerTo(exporter,(getRecipeName(DecoBlocks.COPPER_BAR_DOOR)+ "_recipe_create"));

        createShaped(RecipeCategory.REDSTONE, DecoBlocks.COPPER_BAR_TRAPDOOR)
                .pattern("#-")
                .pattern("--")
                .input('-', Items.COPPER_INGOT)
                .input('#', DecoBlocks.COPPER_BARS)
                .criterion(hasItem(DecoBlocks.COPPER_BARS),
                        conditionsFromItem(DecoBlocks.COPPER_BARS))
                .offerTo(exporter,(getRecipeName(DecoBlocks.COPPER_BAR_TRAPDOOR)+ "_recipe_create"));

        createShapeless(RecipeCategory.MISC, Items.GRAY_DYE,2)
                 .input(DecoBlocks.MEGA_GRAY_TULIP)
                 .group("gray_dye")
                 .criterion(hasItem(DecoBlocks.MEGA_GRAY_TULIP),
                        conditionsFromItem(DecoBlocks.MEGA_GRAY_TULIP))
                 .offerTo(exporter, ("gray_dye_from_mega_gray_tulip"));

                createShapeless(RecipeCategory.MISC, Items.CYAN_DYE)
                        .input(DecoBlocks.SEA_WILDFLOWERS)
                        .group("cyan_dye")
                        .criterion(hasItem(DecoBlocks.SEA_WILDFLOWERS),
                                conditionsFromItem(DecoBlocks.SEA_WILDFLOWERS))
                        .offerTo(exporter, getRecipeName(Items.CYAN_DYE) + "_from_wildflower");
                createShapeless(RecipeCategory.MISC, Items.BLACK_DYE)
                        .input(DecoBlocks.MONOCHROME_WILDFLOWERS)
                        .group("black_dye")
    ...
    public void offerNoteBlockVariantRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible woodInput) {
        ...
        public void offerTwoByTwoRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible input) {
    ...
    public void offerHydratingRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible coralInput) {
        createShapeless(RecipeCategory.BUILDING_BLOCKS,output)
            ...
            public void offerBasicStairSlabWallRecipes(
                    RecipeExporter exporter,
                ...
                createStairsRecipe(stair, Ingredient.ofItems(blockInput))
                        ...
                        .offerTo(exporter,(getRecipeName(stair)+ "_recipe_create"));
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, stair, blockInput);

                offerSlabRecipe(RecipeCategory.BUILDING_BLOCKS, slab, blockInput);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, slab, blockInput,2);

                offerWallRecipe(RecipeCategory.DECORATIONS,wall, blockInput);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, wall, blockInput);
            }
            public void offerChiseledStairSlabWallRecipes(
                    RecipeExporter exporter,
                    ItemConvertible blockInput,
                    ItemConvertible stair,
                    ItemConvertible slab,
                ...
                offerChiseledBlockRecipe(RecipeCategory.BUILDING_BLOCKS, chiseledBlock, slab);
                offerStonecuttingRecipe(RecipeCategory.BUILDING_BLOCKS, chiseledBlock, blockInput);
            }
            public void offerNonStonecutterStairSlabWallRecipes(
                    RecipeExporter exporter,
                    ItemConvertible blockInput,
                    ItemConvertible stair,
                    ItemConvertible slab,
            ...
            public void offerStairSlabCarpetRecipes(
                    RecipeExporter exporter,
                    ItemConvertible blockInput,
                    ItemConvertible stair,
                    ItemConvertible slab,
                ...
                offerSlabRecipe(RecipeCategory.DECORATIONS, slab, blockInput);

                offerCarpetRecipe(carpet, blockInput);
            }
            public void offerHangingLampRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible input) {
                createShaped(RecipeCategory.DECORATIONS,output,8)
                        .pattern("###")
                        .pattern("#X#")
                        .pattern("###")
            ...
            public void offerHangingColouredLampRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible paneInput) {
                createShaped(RecipeCategory.DECORATIONS,output)
                        .input('#', paneInput)
                        ...
                        .criterion(hasItem(DecoBlocks.HANGING_LAMP),
                                conditionsFromItem(DecoBlocks.HANGING_LAMP))
                        .offerTo(exporter, convertBetween(output, paneInput));
            }
            public void offerPillarBlockRecipe(RecipeExporter exporter, ItemConvertible output, ItemConvertible input) {
                createShaped(RecipeCategory.BUILDING_BLOCKS, output)
                        .input('#', input)
                        .pattern("#")
                        .pattern("#")
