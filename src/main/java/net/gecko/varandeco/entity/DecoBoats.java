...
public class DecoBoats {
    ...
    public static final Identifier MUSHROOM_BOAT_ID = new Identifier(VaranDeco.MOD_ID,"mushroom_boat");
    public static final Identifier MUSHROOM_CHEST_BOAT_ID = new Identifier(VaranDeco.MOD_ID,"mushroom_chest_boat");
    ...
    public static final Identifier SPRUCE_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"spruce_raft");
    public static final Identifier SPRUCE_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"spruce_chest_raft");
    public static final Identifier BIRCH_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"birch_raft");
    public static final Identifier BIRCH_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"birch_chest_raft");
    public static final Identifier JUNGLE_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"jungle_raft");
    public static final Identifier JUNGLE_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"jungle_chest_raft");
    public static final Identifier ACACIA_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"acacia_raft");
    public static final Identifier ACACIA_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"acacia_chest_raft");
    public static final Identifier DARK_OAK_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"dark_oak_raft");
    public static final Identifier DARK_OAK_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"dark_oak_chest_raft");
    public static final Identifier MANGROVE_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"mangrove_raft");
    public static final Identifier MANGROVE_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"mangrove_chest_raft");
    public static final Identifier CHERRY_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"cherry_raft");
    public static final Identifier CHERRY_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"cherry_chest_raft");
    public static final Identifier CRIMSON_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"crimson_raft");
    public static final Identifier CRIMSON_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"crimson_chest_raft");
    public static final Identifier WARPED_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"warped_raft");
    public static final Identifier WARPED_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"warped_chest_raft");
    public static final Identifier CACTUS_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"cactus_raft");
    public static final Identifier CACTUS_CHEST_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"cactus_chest_raft");
    public static final Identifier MUSHROOM_RAFT_ID = new Identifier(VaranDeco.MOD_ID,"mushroom_raft");
