...
register(context,DECO_SILVER_ROSE_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
            DecoConfiguredFeatures.DECO_SILVER_ROSE), RarityFilterPlacementModifier.of(16),
                SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());register(context,DECO_ENDER_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
...
register(context, DECO_DESERT_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
            ...
            PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());register(context,DECO_DEEP_BUBBLE_ORE_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(DecoConfiguredFeatures.DECO_BUBBLE_ORE),
        OrePlacement.modifiersWithCount(5,
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(VaranDeco.MOD_ID, name));
    }
