...
public class DecoPlacedFeatures {
    ...
    public static final RegistryKey<PlacedFeature> DECO_PALE_MEGA_TULIP_PLACED = registerKey("deco_pale_mega_tulip_placed");
    ...
    public static final RegistryKey<PlacedFeature> DECO_TAIGA_WILDFLOWER_PLACED = registerKey("deco_taiga_wildflower_placed");
    public static final RegistryKey<PlacedFeature> DECO_JUNGLE_WILDFLOWER_PLACED = registerKey("deco_jungle_wildflower_placed");
...
register(context,DECO_TAIGA_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
        ...
        register(context,DECO_WINDSWEPT_FOREST_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
                ...
                RarityFilterPlacementModifier.of(16), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());register(context,DECO_RIVER_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
...
register(context,DECO_ROOFED_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
        ...
        register(context,DECO_PALE_MEGA_TULIP_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
                DecoConfiguredFeatures.DECO_PALE_MEGA_TULIP), RarityFilterPlacementModifier.of(16),
                SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());
...
register(context, DECO_MESA_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
        ...
        register(context, DECO_TAIGA_WILDFLOWER_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
                        DecoConfiguredFeatures.DECO_TAIGA_WILDFLOWER_KEY),CountPlacementModifier.of(3), RarityFilterPlacementModifier.of(2), SquarePlacementModifier.of(),
                PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());

        register(context, DECO_JUNGLE_WILDFLOWER_PLACED, configuredFeatureRegistryEntryLookup.getOrThrow(
                        DecoConfiguredFeatures.DECO_JUNGLE_WILDFLOWER_KEY),NoiseThresholdCountPlacementModifier.of
                        (-0.8, 5, 10), SquarePlacementModifier.of(),
                PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of());
