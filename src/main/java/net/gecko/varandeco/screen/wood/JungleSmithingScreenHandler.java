...
public class JungleSmithingScreenHandler extends ForgingScreenHandler {
	...
	public JungleSmithingScreenHandler(int syncId, PlayerInventory playerInventory) {
		this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
	}

	public JungleSmithingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
		this(syncId, playerInventory, context, playerInventory.player.getWorld());
	}

	private JungleSmithingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context, World world) {
	...
	protected boolean canUse(BlockState state) {
		return state.isOf(DecoBlocks.JUNGLE_SMITHING_TABLE);
	}
