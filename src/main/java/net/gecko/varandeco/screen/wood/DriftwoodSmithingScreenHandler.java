...
public class DriftwoodSmithingScreenHandler extends ForgingScreenHandler {
	...
	public DriftwoodSmithingScreenHandler(int syncId, PlayerInventory playerInventory) {
	...
	protected boolean canUse(BlockState state) {
		return state.isOf(DecoBlocks.DRIFTWOOD_SMITHING_TABLE);
	}
