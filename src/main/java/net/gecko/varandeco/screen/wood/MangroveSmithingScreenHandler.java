...
public class MangroveSmithingScreenHandler extends ForgingScreenHandler {
	...
	public MangroveSmithingScreenHandler(int syncId, PlayerInventory playerInventory) {
		this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
	}

	public MangroveSmithingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
		this(syncId, playerInventory, context, playerInventory.player.getWorld());
	}

	private MangroveSmithingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context, World world) {
	...
	protected boolean canUse(BlockState state) {
		return state.isOf(DecoBlocks.MANGROVE_SMITHING_TABLE);
	}
