...
public class DriftwoodCraftingScreenHandler extends AbstractCraftingScreenHandler {
    ...
    public DriftwoodCraftingScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public DriftwoodCraftingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
    ...
    public boolean canUse(PlayerEntity player) {
        return canUse(this.context, player, DecoBlocks.DRIFTWOOD_CRAFTING_TABLE);
    }
