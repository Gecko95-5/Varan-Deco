...
public class SpruceSmithingScreenHandler extends ForgingScreenHandler {
	...
	public SpruceSmithingScreenHandler(int syncId, PlayerInventory playerInventory) {
	...
	protected boolean canUse(BlockState state) {
		return state.isOf(DecoBlocks.SPRUCE_SMITHING_TABLE);
	}
