...
public class PaleOakCraftingScreenHandler extends AbstractCraftingScreenHandler {
    ...
    public PaleOakCraftingScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public PaleOakCraftingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
