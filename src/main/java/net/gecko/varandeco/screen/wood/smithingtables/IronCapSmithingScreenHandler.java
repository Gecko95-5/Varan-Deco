...
public class IronCapSmithingScreenHandler extends ForgingScreenHandler {
    ...
    public IronCapSmithingScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public IronCapSmithingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        this(syncId, playerInventory, context, playerInventory.player.getWorld());
    }

    private IronCapSmithingScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context, World world) {
    ...
    protected boolean canUse(BlockState state) {
        return state.isOf(DecoBlocks.IRON_CAP_SMITHING_TABLE);
    }
