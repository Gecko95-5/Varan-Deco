...
public class PaleOakSmithingScreenHandler extends ForgingScreenHandler {
	...
	public PaleOakSmithingScreenHandler(int syncId, PlayerInventory playerInventory) {
	...
	protected boolean canUse(BlockState state) {
		return state.isOf(DecoBlocks.PALE_OAK_SMITHING_TABLE);
	}
