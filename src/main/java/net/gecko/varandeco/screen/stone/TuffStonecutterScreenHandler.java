...
public class TuffStonecutterScreenHandler extends ScreenHandler {
	...
	public final Inventory input = new SimpleInventory(1) {
		...
		public void markDirty() {
			super.markDirty();
			TuffStonecutterScreenHandler.this.onContentChanged(this);
			TuffStonecutterScreenHandler.this.contentsChangedListener.run();
		}
	};
	final CraftingResultInventory output = new CraftingResultInventory();

	public TuffStonecutterScreenHandler(int syncId, PlayerInventory playerInventory) {
		this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
	}

	public TuffStonecutterScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
		...
		this.outputSlot = this.addSlot(new Slot(this.output, 1, 143, 33) {
			...
			public void onTakeItem(PlayerEntity player, ItemStack stack) {
				...
				if (!itemStack.isEmpty()) {
					TuffStonecutterScreenHandler.this.populateResult();
				}
			...
			private List<ItemStack> getInputStacks() {
				return List.of(TuffStonecutterScreenHandler.this.inputSlot.getStack());
			}
		});
	...
	public boolean canUse(PlayerEntity player) {
		return canUse(this.context, player, DecoBlocks.TUFF_STONECUTTER);
	}
